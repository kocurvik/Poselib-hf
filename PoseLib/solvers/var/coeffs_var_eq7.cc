...
MatrixXd var_eq7(double a0, double a1, double a2, double a3, double a4,
...
//   Matrix<long double, Dynamic, Dynamic> sols(1, 28);
  sols << b1 * pow(b3, 2) * pow(d0, 3) - 4 * pow(b0, 2) * b3 * pow(d1, 3) -
              pow(b0, 3) * d1 * pow(d3, 2) + 4 * pow(b1, 3) * pow(d0, 2) * d3 -
      ...
      a1 * pow(b3, 2) * pow(d0, 3) - 4 * a3 * pow(b0, 2) * pow(d1, 3) -
          pow(b0, 3) * c1 * pow(d3, 2) + 4 * pow(b1, 3) * c3 * pow(d0, 2) -
          8 * a0 * b0 * b3 * pow(d1, 3) + 2 * a3 * b1 * b3 * pow(d0, 3) +
          8 * pow(b1, 3) * c0 * d0 * d3 - 2 * pow(b0, 3) * c3 * d1 * d3 -
          3 * a0 * pow(b0, 2) * d1 * pow(d3, 2) -
          a0 * pow(b3, 2) * pow(d0, 2) * d1 +
          a1 * pow(b0, 2) * d0 * pow(d3, 2) -
          b0 * pow(b3, 2) * c1 * pow(d0, 2) +
          ...
          16 * a1 * b0 * b1 * d0 * d1 * d3 + 16 * b0 * b1 * b3 * c1 * d0 * d1 +
          4 * a0 * b0 * b3 * d0 * d1 * d3 - 4 * b0 * b1 * b3 * c0 * d0 * d3,
      pow(a3, 2) * b1 * pow(d0, 3) - 4 * pow(a0, 2) * b3 * pow(d1, 3) -
          pow(b0, 3) * pow(c3, 2) * d1 + 4 * pow(b1, 3) * pow(c0, 2) * d3 -
          8 * a0 * a3 * b0 * pow(d1, 3) + 2 * a1 * a3 * b3 * pow(d0, 3) +
          8 * pow(b1, 3) * c0 * c3 * d0 - 2 * pow(b0, 3) * c1 * c3 * d3 -
          3 * a0 * pow(b0, 2) * c1 * pow(d3, 2) -
          a0 * pow(b3, 2) * c1 * pow(d0, 2) +
          a1 * pow(b0, 2) * c0 * pow(d3, 2) +
          ...
          16 * a0 * a1 * b1 * d0 * d1 * d3 + 16 * a0 * b0 * b1 * c1 * d1 * d3 +
          16 * a0 * b1 * b3 * c1 * d0 * d1 - 16 * a1 * b0 * b1 * c0 * d1 * d3 -
          16 * a1 * b0 * b1 * c1 * d0 * d3 - 16 * a1 * b0 * b1 * c3 * d0 * d1 +
          16 * a1 * b0 * b3 * c1 * d0 * d1 - 16 * a1 * b1 * b3 * c0 * d0 * d1 +
          16 * a3 * b0 * b1 * c1 * d0 * d1 + 16 * b0 * b1 * b3 * c0 * c1 * d1 +
          4 * a0 * a3 * b0 * d0 * d1 * d3 + 4 * a0 * b0 * b1 * c3 * d0 * d3 +
          4 * a0 * b0 * b3 * c0 * d1 * d3 + 4 * a0 * b0 * b3 * c1 * d0 * d3 +
          4 * a0 * b0 * b3 * c3 * d0 * d1 - 4 * a0 * b1 * b3 * c0 * d0 * d3 -
          4 * a1 * b0 * b3 * c0 * d0 * d3 - 4 * a3 * b0 * b1 * c0 * d0 * d3 -
          4 * a3 * b0 * b3 * c0 * d0 * d1 - 4 * b0 * b1 * b3 * c0 * c3 * d0,
      a1 * pow(a3, 2) * pow(d0, 3) - 4 * pow(a0, 2) * a3 * pow(d1, 3) +
          ...
          a0 * pow(b3, 2) * pow(c0, 2) * d1 +
          a1 * pow(b0, 2) * pow(c3, 2) * d0 +
          ...
          4 * a0 * a3 * b3 * c0 * d0 * d1 + 4 * a0 * b0 * b1 * c0 * c3 * d3 +
          4 * a0 * b0 * b3 * c0 * c1 * d3 + 4 * a0 * b0 * b3 * c0 * c3 * d1 +
          4 * a0 * b0 * b3 * c1 * c3 * d0 - 4 * a0 * b1 * b3 * c0 * c3 * d0 -
          4 * a1 * a3 * b0 * c0 * d0 * d3 - 4 * a1 * b0 * b3 * c0 * c3 * d0 -
          4 * a3 * b0 * b1 * c0 * c3 * d0 - 4 * a3 * b0 * b3 * c0 * c1 * d0,
      a1 * pow(b3, 2) * pow(c0, 3) - 4 * a3 * pow(b0, 2) * pow(c1, 3) -
          pow(a0, 3) * c1 * pow(d3, 2) + 4 * pow(a1, 3) * c3 * pow(d0, 2) -
          8 * a0 * b0 * b3 * pow(c1, 3) + 2 * a3 * b1 * b3 * pow(c0, 3) +
          8 * pow(a1, 3) * c0 * d0 * d3 - 2 * pow(a0, 3) * c3 * d1 * d3 -
          a0 * pow(a3, 2) * c1 * pow(d0, 2) -
          ...
          16 * a0 * a1 * a3 * c1 * d0 * d1 + 16 * a0 * a1 * b0 * c1 * c3 * d1 -
          16 * a0 * a1 * b1 * c0 * c1 * d3 - 16 * a0 * a1 * b1 * c0 * c3 * d1 -
          16 * a0 * a1 * b1 * c1 * c3 * d0 + 16 * a0 * a1 * b3 * c0 * c1 * d1 +
          16 * a0 * a3 * b1 * c0 * c1 * d1 + 16 * a1 * a3 * b0 * c0 * c1 * d1 -
          16 * a1 * a3 * b1 * c0 * c1 * d0 - 16 * a1 * b0 * b1 * c0 * c1 * c3 -
          4 * a0 * a1 * a3 * c0 * d0 * d3 + 4 * a0 * a1 * b0 * c0 * c3 * d3 -
          4 * a0 * a1 * b3 * c0 * c3 * d0 + 4 * a0 * a3 * b0 * c0 * c1 * d3 +
          4 * a0 * a3 * b0 * c0 * c3 * d1 + 4 * a0 * a3 * b0 * c1 * c3 * d0 -
          4 * a0 * a3 * b1 * c0 * c3 * d0 - 4 * a0 * a3 * b3 * c0 * c1 * d0 +
          4 * a0 * b0 * b3 * c0 * c1 * c3 - 4 * a1 * a3 * b0 * c0 * c3 * d0,
      pow(a3, 2) * b1 * pow(c0, 3) - 4 * pow(a0, 2) * b3 * pow(c1, 3) -
          pow(a0, 3) * pow(c3, 2) * d1 + 4 * pow(a1, 3) * pow(c0, 2) * d3 -
          8 * a0 * a3 * b0 * pow(c1, 3) + 2 * a1 * a3 * b3 * pow(c0, 3) +
          8 * pow(a1, 3) * c0 * c3 * d0 - 2 * pow(a0, 3) * c1 * c3 * d3 -
          a0 * pow(a3, 2) * pow(c0, 2) * d1 +
          ...
          16 * a0 * a1 * a3 * c0 * c1 * d1 - 16 * a0 * a1 * b1 * c0 * c1 * c3 -
          4 * a0 * a1 * a3 * c0 * c3 * d0 + 4 * a0 * a3 * b0 * c0 * c1 * c3,
      ...
      4 * pow(b0, 2) * b5 * pow(d1, 3) - 4 * b1 * pow(b4, 2) * pow(d0, 3) -
          16 * pow(b2, 2) * b3 * pow(d1, 3) + 4 * pow(b0, 3) * d1 * pow(d4, 2) -
          4 * pow(b1, 3) * pow(d0, 2) * d5 + 16 * pow(b1, 3) * pow(d2, 2) * d3 +
          8 * b0 * b3 * b5 * pow(d1, 3) - 2 * b1 * b3 * b5 * pow(d0, 3) +
          4 * b2 * b3 * b4 * pow(d0, 3) + 2 * pow(b0, 3) * d1 * d3 * d5 -
          4 * pow(b0, 3) * d2 * d3 * d4 - 8 * pow(b1, 3) * d0 * d3 * d5 +
          ...
          16 * b0 * b1 * b2 * d0 * d1 * d4 - 8 * b0 * b1 * b2 * d0 * d2 * d3 -
          16 * b0 * b1 * b4 * d0 * d1 * d2 + 8 * b0 * b2 * b3 * d0 * d1 * d2 +
          16 * b0 * b1 * b3 * d1 * d2 * d4 + 16 * b0 * b1 * b4 * d1 * d2 * d3 -
          16 * b1 * b2 * b3 * d0 * d1 * d4 - 16 * b1 * b2 * b4 * d0 * d1 * d3 +
          4 * b0 * b1 * b3 * d0 * d3 * d5 - 8 * b0 * b1 * b4 * d0 * d3 * d4 +
          8 * b0 * b3 * b4 * d0 * d1 * d4 - 4 * b0 * b3 * b5 * d0 * d1 * d3,
      4 * a5 * pow(b0, 2) * pow(d1, 3) - 16 * a3 * pow(b2, 2) * pow(d1, 3) -
          4 * a1 * pow(b4, 2) * pow(d0, 3) + 4 * pow(b0, 3) * c1 * pow(d4, 2) +
          16 * pow(b1, 3) * c3 * pow(d2, 2) - 4 * pow(b1, 3) * c5 * pow(d0, 2) +
          8 * a0 * b0 * b5 * pow(d1, 3) - 32 * a2 * b2 * b3 * pow(d1, 3) +
          8 * a0 * b3 * b5 * pow(d1, 3) - 2 * a1 * b3 * b5 * pow(d0, 3) +
          4 * a2 * b3 * b4 * pow(d0, 3) + 8 * a3 * b0 * b5 * pow(d1, 3) -
          2 * a3 * b1 * b5 * pow(d0, 3) + 4 * a3 * b2 * b4 * pow(d0, 3) -
          8 * a4 * b1 * b4 * pow(d0, 3) + 4 * a4 * b2 * b3 * pow(d0, 3) +
          8 * a5 * b0 * b3 * pow(d1, 3) - 2 * a5 * b1 * b3 * pow(d0, 3) -
          8 * pow(b1, 3) * c0 * d0 * d5 + 32 * pow(b1, 3) * c2 * d2 * d3 +
          ...
          16 * a4 * b0 * b1 * d0 * d1 * d2 + 16 * b0 * b1 * b2 * c0 * d1 * d4 -
          8 * b0 * b1 * b2 * c0 * d2 * d3 + 16 * b0 * b1 * b2 * c1 * d0 * d4 -
          8 * b0 * b1 * b2 * c2 * d0 * d3 - 8 * b0 * b1 * b2 * c3 * d0 * d2 +
          16 * b0 * b1 * b2 * c4 * d0 * d1 - 16 * b0 * b1 * b4 * c0 * d1 * d2 -
          16 * b0 * b1 * b4 * c1 * d0 * d2 - 16 * b0 * b1 * b4 * c2 * d0 * d1 -
          16 * b0 * b1 * b5 * c1 * d0 * d1 + 8 * b0 * b2 * b3 * c0 * d1 * d2 +
          8 * b0 * b2 * b3 * c1 * d0 * d2 + 8 * b0 * b2 * b3 * c2 * d0 * d1 -
          4 * a0 * b0 * b1 * d0 * d3 * d5 + 8 * a0 * b0 * b2 * d0 * d3 * d4 -
          4 * a0 * b0 * b3 * d0 * d1 * d5 + 8 * a0 * b0 * b3 * d0 * d2 * d4 -
          16 * a0 * b0 * b4 * d0 * d1 * d4 + 8 * a0 * b0 * b4 * d0 * d2 * d3 -
          4 * a0 * b0 * b5 * d0 * d1 * d3 + 4 * b0 * b1 * b3 * c0 * d0 * d5 +
          16 * b0 * b1 * b4 * c0 * d0 * d4 + 4 * b0 * b1 * b5 * c0 * d0 * d3 -
          8 * b0 * b2 * b3 * c0 * d0 * d4 - 8 * b0 * b2 * b4 * c0 * d0 * d3 -
          8 * b0 * b3 * b4 * c0 * d0 * d2 + 4 * b0 * b3 * b5 * c0 * d0 * d1 -
          64 * a1 * b1 * b2 * d1 * d2 * d3 + 64 * b1 * b2 * b3 * c1 * d1 * d2 +
          ...
          16 * a4 * b1 * b2 * d0 * d1 * d3 + 16 * b0 * b1 * b2 * c3 * d2 * d3 -
          16 * b0 * b1 * b3 * c1 * d1 * d5 + 16 * b0 * b1 * b3 * c1 * d2 * d4 +
          16 * b0 * b1 * b3 * c2 * d1 * d4 - 16 * b0 * b1 * b3 * c2 * d2 * d3 +
          16 * b0 * b1 * b3 * c4 * d1 * d2 + 16 * b0 * b1 * b4 * c1 * d2 * d3 +
          16 * b0 * b1 * b4 * c2 * d1 * d3 + 16 * b0 * b1 * b4 * c3 * d1 * d2 -
          16 * b0 * b1 * b5 * c1 * d1 * d3 - 32 * b0 * b3 * b4 * c1 * d1 * d2 -
          16 * b1 * b2 * b3 * c0 * d1 * d4 - 16 * b1 * b2 * b3 * c1 * d0 * d4 -
          16 * b1 * b2 * b3 * c4 * d0 * d1 - 16 * b1 * b2 * b4 * c0 * d1 * d3 -
          16 * b1 * b2 * b4 * c1 * d0 * d3 - 16 * b1 * b2 * b4 * c3 * d0 * d1 -
          16 * b1 * b3 * b5 * c1 * d0 * d1 + 32 * b2 * b3 * b4 * c1 * d0 * d1 -
          4 * a0 * b0 * b3 * d1 * d3 * d5 + 8 * a0 * b0 * b3 * d2 * d3 * d4 +
          4 * a0 * b1 * b3 * d0 * d3 * d5 - 8 * a0 * b1 * b4 * d0 * d3 * d4 +
          8 * a0 * b3 * b4 * d0 * d1 * d4 - 4 * a0 * b3 * b5 * d0 * d1 * d3 +
          4 * a1 * b0 * b3 * d0 * d3 * d5 - 8 * a1 * b0 * b4 * d0 * d3 * d4 +
          4 * a3 * b0 * b1 * d0 * d3 * d5 + 4 * a3 * b0 * b3 * d0 * d1 * d5 -
          8 * a3 * b0 * b3 * d0 * d2 * d4 + 8 * a3 * b0 * b4 * d0 * d1 * d4 -
          4 * a3 * b0 * b5 * d0 * d1 * d3 - 8 * a4 * b0 * b1 * d0 * d3 * d4 +
          8 * a4 * b0 * b3 * d0 * d1 * d4 - 4 * a5 * b0 * b3 * d0 * d1 * d3 +
          4 * b0 * b1 * b3 * c0 * d3 * d5 + 4 * b0 * b1 * b3 * c3 * d0 * d5 +
          4 * b0 * b1 * b3 * c5 * d0 * d3 - 8 * b0 * b1 * b4 * c0 * d3 * d4 -
          8 * b0 * b1 * b4 * c3 * d0 * d4 - 8 * b0 * b1 * b4 * c4 * d0 * d3 -
          4 * b0 * b1 * b5 * c3 * d0 * d3 + 8 * b0 * b2 * b4 * c3 * d0 * d3 +
          8 * b0 * b3 * b4 * c0 * d1 * d4 + 8 * b0 * b3 * b4 * c1 * d0 * d4 +
          8 * b0 * b3 * b4 * c4 * d0 * d1 - 4 * b0 * b3 * b5 * c0 * d1 * d3 -
          4 * b0 * b3 * b5 * c1 * d0 * d3 - 4 * b0 * b3 * b5 * c3 * d0 * d1 +
          4 * b1 * b3 * b5 * c0 * d0 * d3 - 8 * b2 * b3 * b4 * c0 * d0 * d3,
      4 * pow(a0, 2) * b5 * pow(d1, 3) - 4 * pow(a4, 2) * b1 * pow(d0, 3) -
          16 * pow(a2, 2) * b3 * pow(d1, 3) + 4 * pow(b0, 3) * pow(c4, 2) * d1 -
          4 * pow(b1, 3) * pow(c0, 2) * d5 + 16 * pow(b1, 3) * pow(c2, 2) * d3 +
          8 * a0 * a5 * b0 * pow(d1, 3) - 32 * a2 * a3 * b2 * pow(d1, 3) +
          8 * a0 * a3 * b5 * pow(d1, 3) + 8 * a0 * a5 * b3 * pow(d1, 3) -
          2 * a1 * a3 * b5 * pow(d0, 3) - 8 * a1 * a4 * b4 * pow(d0, 3) -
          2 * a1 * a5 * b3 * pow(d0, 3) + 4 * a2 * a3 * b4 * pow(d0, 3) +
          4 * a2 * a4 * b3 * pow(d0, 3) + 4 * a3 * a4 * b2 * pow(d0, 3) +
          8 * a3 * a5 * b0 * pow(d1, 3) - 2 * a3 * a5 * b1 * pow(d0, 3) -
          8 * pow(b1, 3) * c0 * c5 * d0 + 32 * pow(b1, 3) * c2 * c3 * d2 +
          ...
          16 * a0 * a4 * b1 * d0 * d1 * d2 - 16 * a0 * b0 * b1 * c1 * d1 * d5 +
          16 * a0 * b0 * b1 * c2 * d2 * d3 - 32 * a0 * b0 * b2 * c1 * d1 * d4 -
          16 * a0 * b0 * b3 * c2 * d1 * d2 + 32 * a0 * b0 * b4 * c1 * d1 * d2 +
          16 * a0 * b1 * b2 * c0 * d1 * d4 - 8 * a0 * b1 * b2 * c0 * d2 * d3 +
          16 * a0 * b1 * b2 * c1 * d0 * d4 - 8 * a0 * b1 * b2 * c2 * d0 * d3 -
          8 * a0 * b1 * b2 * c3 * d0 * d2 + 16 * a0 * b1 * b2 * c4 * d0 * d1 -
          16 * a0 * b1 * b4 * c0 * d1 * d2 - 16 * a0 * b1 * b4 * c1 * d0 * d2 -
          16 * a0 * b1 * b4 * c2 * d0 * d1 - 16 * a0 * b1 * b5 * c1 * d0 * d1 +
          8 * a0 * b2 * b3 * c0 * d1 * d2 + 8 * a0 * b2 * b3 * c1 * d0 * d2 +
          8 * a0 * b2 * b3 * c2 * d0 * d1 + 16 * a1 * a2 * b0 * d0 * d1 * d4 -
          ...
          8 * a2 * a3 * b0 * d0 * d1 * d2 + 16 * a2 * b0 * b1 * c0 * d1 * d4 -
          8 * a2 * b0 * b1 * c0 * d2 * d3 + 16 * a2 * b0 * b1 * c1 * d0 * d4 -
          8 * a2 * b0 * b1 * c2 * d0 * d3 - 8 * a2 * b0 * b1 * c3 * d0 * d2 +
          16 * a2 * b0 * b1 * c4 * d0 * d1 + 8 * a2 * b0 * b3 * c0 * d1 * d2 +
          8 * a2 * b0 * b3 * c1 * d0 * d2 + 8 * a2 * b0 * b3 * c2 * d0 * d1 +
          16 * a2 * b1 * b2 * c0 * d0 * d3 - 16 * a2 * b2 * b3 * c0 * d0 * d1 +
          8 * a3 * b0 * b2 * c0 * d1 * d2 + 8 * a3 * b0 * b2 * c1 * d0 * d2 +
          8 * a3 * b0 * b2 * c2 * d0 * d1 - 16 * a4 * b0 * b1 * c0 * d1 * d2 -
          16 * a4 * b0 * b1 * c1 * d0 * d2 - 16 * a4 * b0 * b1 * c2 * d0 * d1 -
          16 * a5 * b0 * b1 * c1 * d0 * d1 + 16 * b0 * b1 * b2 * c0 * c1 * d4 -
          8 * b0 * b1 * b2 * c0 * c2 * d3 - 8 * b0 * b1 * b2 * c0 * c3 * d2 +
          16 * b0 * b1 * b2 * c0 * c4 * d1 + 16 * b0 * b1 * b2 * c1 * c4 * d0 -
          8 * b0 * b1 * b2 * c2 * c3 * d0 - 16 * b0 * b1 * b4 * c0 * c1 * d2 -
          16 * b0 * b1 * b4 * c0 * c2 * d1 - 16 * b0 * b1 * b4 * c1 * c2 * d0 -
          16 * b0 * b1 * b5 * c0 * c1 * d1 + 8 * b0 * b2 * b3 * c0 * c1 * d2 +
          8 * b0 * b2 * b3 * c0 * c2 * d1 + 8 * b0 * b2 * b3 * c1 * c2 * d0 -
          4 * a0 * a1 * b0 * d0 * d3 * d5 + 8 * a0 * a2 * b0 * d0 * d3 * d4 -
          4 * a0 * a3 * b0 * d0 * d1 * d5 + 8 * a0 * a3 * b0 * d0 * d2 * d4 -
          16 * a0 * a4 * b0 * d0 * d1 * d4 + 8 * a0 * a4 * b0 * d0 * d2 * d3 -
          4 * a0 * a5 * b0 * d0 * d1 * d3 - 4 * a0 * b0 * b1 * c0 * d3 * d5 -
          4 * a0 * b0 * b1 * c3 * d0 * d5 - 16 * a0 * b0 * b1 * c4 * d0 * d4 -
          4 * a0 * b0 * b1 * c5 * d0 * d3 + 8 * a0 * b0 * b2 * c0 * d3 * d4 +
          8 * a0 * b0 * b2 * c3 * d0 * d4 + 8 * a0 * b0 * b2 * c4 * d0 * d3 -
          4 * a0 * b0 * b3 * c0 * d1 * d5 + 8 * a0 * b0 * b3 * c0 * d2 * d4 -
          4 * a0 * b0 * b3 * c1 * d0 * d5 + 8 * a0 * b0 * b3 * c2 * d0 * d4 +
          8 * a0 * b0 * b3 * c4 * d0 * d2 - 4 * a0 * b0 * b3 * c5 * d0 * d1 -
          16 * a0 * b0 * b4 * c0 * d1 * d4 + 8 * a0 * b0 * b4 * c0 * d2 * d3 -
          16 * a0 * b0 * b4 * c1 * d0 * d4 + 8 * a0 * b0 * b4 * c2 * d0 * d3 +
          8 * a0 * b0 * b4 * c3 * d0 * d2 - 16 * a0 * b0 * b4 * c4 * d0 * d1 -
          4 * a0 * b0 * b5 * c0 * d1 * d3 - 4 * a0 * b0 * b5 * c1 * d0 * d3 -
          4 * a0 * b0 * b5 * c3 * d0 * d1 + 4 * a0 * b1 * b3 * c0 * d0 * d5 +
          16 * a0 * b1 * b4 * c0 * d0 * d4 + 4 * a0 * b1 * b5 * c0 * d0 * d3 -
          8 * a0 * b2 * b3 * c0 * d0 * d4 - 8 * a0 * b2 * b4 * c0 * d0 * d3 -
          8 * a0 * b3 * b4 * c0 * d0 * d2 + 4 * a0 * b3 * b5 * c0 * d0 * d1 +
          4 * a1 * b0 * b3 * c0 * d0 * d5 + 16 * a1 * b0 * b4 * c0 * d0 * d4 +
          4 * a1 * b0 * b5 * c0 * d0 * d3 - 8 * a2 * b0 * b3 * c0 * d0 * d4 -
          8 * a2 * b0 * b4 * c0 * d0 * d3 + 4 * a3 * b0 * b1 * c0 * d0 * d5 -
          8 * a3 * b0 * b2 * c0 * d0 * d4 - 8 * a3 * b0 * b4 * c0 * d0 * d2 +
          4 * a3 * b0 * b5 * c0 * d0 * d1 + 16 * a4 * b0 * b1 * c0 * d0 * d4 -
          8 * a4 * b0 * b2 * c0 * d0 * d3 - 8 * a4 * b0 * b3 * c0 * d0 * d2 +
          16 * a4 * b0 * b4 * c0 * d0 * d1 + 4 * a5 * b0 * b1 * c0 * d0 * d3 +
          4 * a5 * b0 * b3 * c0 * d0 * d1 + 4 * b0 * b1 * b3 * c0 * c5 * d0 +
          16 * b0 * b1 * b4 * c0 * c4 * d0 + 4 * b0 * b1 * b5 * c0 * c3 * d0 -
          8 * b0 * b2 * b3 * c0 * c4 * d0 - 8 * b0 * b2 * b4 * c0 * c3 * d0 -
          8 * b0 * b3 * b4 * c0 * c2 * d0 + 4 * b0 * b3 * b5 * c0 * c1 * d0 -
          64 * a1 * a2 * b1 * d1 * d2 * d3 - 64 * a1 * b1 * b2 * c1 * d2 * d3 -
          64 * a1 * b1 * b2 * c2 * d1 * d3 - 64 * a1 * b1 * b2 * c3 * d1 * d2 -
          64 * a1 * b1 * b3 * c2 * d1 * d2 + 64 * a1 * b2 * b3 * c1 * d1 * d2 +
          64 * a2 * b1 * b2 * c1 * d1 * d3 + 64 * a2 * b1 * b3 * c1 * d1 * d2 +
          64 * a3 * b1 * b2 * c1 * d1 * d2 + 64 * b1 * b2 * b3 * c1 * c2 * d1 +
          16 * a0 * a1 * b1 * d1 * d3 * d5 - 32 * a0 * a1 * b1 * d2 * d3 * d4 +
          16 * a0 * a1 * b3 * d1 * d2 * d4 + 16 * a0 * a1 * b4 * d1 * d2 * d3 +
          16 * a0 * a3 * b1 * d1 * d2 * d4 + 16 * a0 * a4 * b1 * d1 * d2 * d3 +
          16 * a0 * b1 * b2 * c3 * d2 * d3 - 16 * a0 * b1 * b3 * c1 * d1 * d5 +
          16 * a0 * b1 * b3 * c1 * d2 * d4 + 16 * a0 * b1 * b3 * c2 * d1 * d4 -
          16 * a0 * b1 * b3 * c2 * d2 * d3 + 16 * a0 * b1 * b3 * c4 * d1 * d2 +
          16 * a0 * b1 * b4 * c1 * d2 * d3 + 16 * a0 * b1 * b4 * c2 * d1 * d3 +
          16 * a0 * b1 * b4 * c3 * d1 * d2 - 16 * a0 * b1 * b5 * c1 * d1 * d3 -
          32 * a0 * b3 * b4 * c1 * d1 * d2 + 32 * a1 * a2 * b1 * d0 * d3 * d4 -
          16 * a1 * a2 * b3 * d0 * d1 * d4 - 16 * a1 * a2 * b4 * d0 * d1 * d3 +
          16 * a1 * a3 * b0 * d1 * d2 * d4 + 16 * a1 * a3 * b1 * d0 * d1 * d5 -
          16 * a1 * a3 * b2 * d0 * d1 * d4 + 16 * a1 * a4 * b0 * d1 * d2 * d3 -
          ...
          16 * a1 * b0 * b4 * c3 * d1 * d2 - 16 * a1 * b0 * b5 * c1 * d1 * d3 +
          32 * a1 * b1 * b2 * c0 * d3 * d4 + 32 * a1 * b1 * b2 * c3 * d0 * d4 +
          32 * a1 * b1 * b2 * c4 * d0 * d3 + 16 * a1 * b1 * b3 * c0 * d1 * d5 +
          16 * a1 * b1 * b3 * c1 * d0 * d5 + 16 * a1 * b1 * b3 * c5 * d0 * d1 +
          16 * a1 * b1 * b5 * c0 * d1 * d3 + 16 * a1 * b1 * b5 * c1 * d0 * d3 +
          16 * a1 * b1 * b5 * c3 * d0 * d1 - 16 * a1 * b2 * b3 * c0 * d1 * d4 -
          16 * a1 * b2 * b3 * c1 * d0 * d4 - 16 * a1 * b2 * b3 * c4 * d0 * d1 -
          16 * a1 * b2 * b4 * c0 * d1 * d3 - 16 * a1 * b2 * b4 * c1 * d0 * d3 -
          16 * a1 * b2 * b4 * c3 * d0 * d1 - 16 * a1 * b3 * b5 * c1 * d0 * d1 -
          16 * a2 * a3 * b1 * d0 * d1 * d4 + 16 * a2 * a3 * b2 * d0 * d1 * d3 -
          16 * a2 * a3 * b3 * d0 * d1 * d2 - 16 * a2 * a4 * b1 * d0 * d1 * d3 +
          16 * a2 * b0 * b1 * c3 * d2 * d3 - 16 * a2 * b0 * b2 * c3 * d1 * d3 -
          16 * a2 * b1 * b2 * c3 * d0 * d3 - 16 * a2 * b1 * b3 * c0 * d1 * d4 -
          16 * a2 * b1 * b3 * c1 * d0 * d4 - 16 * a2 * b1 * b3 * c4 * d0 * d1 -
          16 * a2 * b1 * b4 * c0 * d1 * d3 - 16 * a2 * b1 * b4 * c1 * d0 * d3 -
          16 * a2 * b1 * b4 * c3 * d0 * d1 + 16 * a2 * b2 * b3 * c0 * d1 * d3 +
          16 * a2 * b2 * b3 * c1 * d0 * d3 + 16 * a2 * b2 * b3 * c3 * d0 * d1 +
          32 * a2 * b3 * b4 * c1 * d0 * d1 - 16 * a3 * b0 * b1 * c1 * d1 * d5 +
          16 * a3 * b0 * b1 * c1 * d2 * d4 + 16 * a3 * b0 * b1 * c2 * d1 * d4 -
          16 * a3 * b0 * b1 * c2 * d2 * d3 + 16 * a3 * b0 * b1 * c4 * d1 * d2 +
          16 * a3 * b0 * b3 * c2 * d1 * d2 - 32 * a3 * b0 * b4 * c1 * d1 * d2 -
          16 * a3 * b1 * b2 * c0 * d1 * d4 - 16 * a3 * b1 * b2 * c1 * d0 * d4 -
          16 * a3 * b1 * b2 * c4 * d0 * d1 + 16 * a3 * b1 * b3 * c2 * d0 * d2 -
          16 * a3 * b1 * b5 * c1 * d0 * d1 - 16 * a3 * b2 * b3 * c0 * d1 * d2 -
          16 * a3 * b2 * b3 * c1 * d0 * d2 - 16 * a3 * b2 * b3 * c2 * d0 * d1 +
          32 * a3 * b2 * b4 * c1 * d0 * d1 + 16 * a4 * b0 * b1 * c1 * d2 * d3 +
          16 * a4 * b0 * b1 * c2 * d1 * d3 + 16 * a4 * b0 * b1 * c3 * d1 * d2 -
          32 * a4 * b0 * b3 * c1 * d1 * d2 - 16 * a4 * b1 * b2 * c0 * d1 * d3 -
          16 * a4 * b1 * b2 * c1 * d0 * d3 - 16 * a4 * b1 * b2 * c3 * d0 * d1 +
          32 * a4 * b2 * b3 * c1 * d0 * d1 - 16 * a5 * b0 * b1 * c1 * d1 * d3 -
          16 * a5 * b1 * b3 * c1 * d0 * d1 + 16 * b0 * b1 * b2 * c2 * c3 * d3 +
          16 * b0 * b1 * b3 * c1 * c2 * d4 + 16 * b0 * b1 * b3 * c1 * c4 * d2 -
          16 * b0 * b1 * b3 * c1 * c5 * d1 - 16 * b0 * b1 * b3 * c2 * c3 * d2 +
          16 * b0 * b1 * b3 * c2 * c4 * d1 + 16 * b0 * b1 * b4 * c1 * c2 * d3 +
          16 * b0 * b1 * b4 * c1 * c3 * d2 + 16 * b0 * b1 * b4 * c2 * c3 * d1 -
          16 * b0 * b1 * b5 * c1 * c3 * d1 - 32 * b0 * b3 * b4 * c1 * c2 * d1 -
          16 * b1 * b2 * b3 * c0 * c1 * d4 - 16 * b1 * b2 * b3 * c0 * c4 * d1 -
          16 * b1 * b2 * b3 * c1 * c4 * d0 - 16 * b1 * b2 * b4 * c0 * c1 * d3 -
          16 * b1 * b2 * b4 * c0 * c3 * d1 - 16 * b1 * b2 * b4 * c1 * c3 * d0 -
          16 * b1 * b3 * b5 * c0 * c1 * d1 + 32 * b2 * b3 * b4 * c0 * c1 * d1 +
          4 * a0 * a1 * b3 * d0 * d3 * d5 - 8 * a0 * a1 * b4 * d0 * d3 * d4 -
          4 * a0 * a3 * b0 * d1 * d3 * d5 + 8 * a0 * a3 * b0 * d2 * d3 * d4 +
          4 * a0 * a3 * b1 * d0 * d3 * d5 + 4 * a0 * a3 * b3 * d0 * d1 * d5 -
          8 * a0 * a3 * b3 * d0 * d2 * d4 + 8 * a0 * a3 * b4 * d0 * d1 * d4 -
          4 * a0 * a3 * b5 * d0 * d1 * d3 - 8 * a0 * a4 * b1 * d0 * d3 * d4 +
          8 * a0 * a4 * b3 * d0 * d1 * d4 - 4 * a0 * a5 * b3 * d0 * d1 * d3 -
          ...
          4 * b0 * b1 * b3 * c0 * c3 * d5 + 4 * b0 * b1 * b3 * c0 * c5 * d3 +
          4 * b0 * b1 * b3 * c3 * c5 * d0 - 8 * b0 * b1 * b4 * c0 * c3 * d4 -
          8 * b0 * b1 * b4 * c0 * c4 * d3 - 8 * b0 * b1 * b4 * c3 * c4 * d0 -
          4 * b0 * b1 * b5 * c0 * c3 * d3 + 8 * b0 * b2 * b4 * c0 * c3 * d3 +
          8 * b0 * b3 * b4 * c0 * c1 * d4 + 8 * b0 * b3 * b4 * c0 * c4 * d1 +
          8 * b0 * b3 * b4 * c1 * c4 * d0 - 4 * b0 * b3 * b5 * c0 * c1 * d3 -
          4 * b0 * b3 * b5 * c0 * c3 * d1 - 4 * b0 * b3 * b5 * c1 * c3 * d0 +
          4 * b1 * b3 * b5 * c0 * c3 * d0 - 8 * b2 * b3 * b4 * c0 * c3 * d0,
      4 * pow(a0, 2) * a5 * pow(d1, 3) - 4 * a1 * pow(a4, 2) * pow(d0, 3) -
          16 * pow(a2, 2) * a3 * pow(d1, 3) - 4 * b1 * pow(b4, 2) * pow(c0, 3) +
          4 * pow(b0, 2) * b5 * pow(c1, 3) - 16 * pow(b2, 2) * b3 * pow(c1, 3) +
          4 * pow(b0, 3) * c1 * pow(c4, 2) - 4 * pow(b1, 3) * pow(c0, 2) * c5 +
          16 * pow(b1, 3) * pow(c2, 2) * c3 + 4 * pow(a0, 3) * d1 * pow(d4, 2) -
          4 * pow(a1, 3) * pow(d0, 2) * d5 + 16 * pow(a1, 3) * pow(d2, 2) * d3 +
          8 * a0 * a3 * a5 * pow(d1, 3) - 2 * a1 * a3 * a5 * pow(d0, 3) +
          4 * a2 * a3 * a4 * pow(d0, 3) + 8 * b0 * b3 * b5 * pow(c1, 3) -
          2 * b1 * b3 * b5 * pow(c0, 3) + 4 * b2 * b3 * b4 * pow(c0, 3) +
          2 * pow(b0, 3) * c1 * c3 * c5 - 4 * pow(b0, 3) * c2 * c3 * c4 -
          8 * pow(b1, 3) * c0 * c3 * c5 + 2 * pow(a0, 3) * d1 * d3 * d5 -
          4 * pow(a0, 3) * d2 * d3 * d4 - 8 * pow(a1, 3) * d0 * d3 * d5 +
          ...
          16 * a0 * a1 * a4 * d0 * d1 * d2 - 16 * a0 * a1 * b0 * c1 * d1 * d5 +
          16 * a0 * a1 * b0 * c2 * d2 * d3 + 16 * a0 * a1 * b1 * c0 * d1 * d5 +
          16 * a0 * a1 * b1 * c1 * d0 * d5 + 16 * a0 * a1 * b1 * c5 * d0 * d1 +
          16 * a0 * a1 * b2 * c0 * d1 * d4 - 8 * a0 * a1 * b2 * c0 * d2 * d3 +
          16 * a0 * a1 * b2 * c1 * d0 * d4 - 8 * a0 * a1 * b2 * c2 * d0 * d3 -
          8 * a0 * a1 * b2 * c3 * d0 * d2 + 16 * a0 * a1 * b2 * c4 * d0 * d1 -
          16 * a0 * a1 * b4 * c0 * d1 * d2 - 16 * a0 * a1 * b4 * c1 * d0 * d2 -
          16 * a0 * a1 * b4 * c2 * d0 * d1 - 16 * a0 * a1 * b5 * c1 * d0 * d1 +
          8 * a0 * a2 * a3 * d0 * d1 * d2 - 32 * a0 * a2 * b0 * c1 * d1 * d4 +
          ...
          4 * a0 * a5 * b3 * c0 * d0 * d1 - 4 * a0 * b0 * b1 * c0 * c3 * d5 -
          16 * a0 * b0 * b1 * c0 * c4 * d4 - 4 * a0 * b0 * b1 * c0 * c5 * d3 -
          4 * a0 * b0 * b1 * c3 * c5 * d0 + 8 * a0 * b0 * b2 * c0 * c3 * d4 +
          8 * a0 * b0 * b2 * c0 * c4 * d3 + 8 * a0 * b0 * b2 * c3 * c4 * d0 -
          4 * a0 * b0 * b3 * c0 * c1 * d5 + 8 * a0 * b0 * b3 * c0 * c2 * d4 +
          8 * a0 * b0 * b3 * c0 * c4 * d2 - 4 * a0 * b0 * b3 * c0 * c5 * d1 -
          4 * a0 * b0 * b3 * c1 * c5 * d0 + 8 * a0 * b0 * b3 * c2 * c4 * d0 -
          16 * a0 * b0 * b4 * c0 * c1 * d4 + 8 * a0 * b0 * b4 * c0 * c2 * d3 +
          8 * a0 * b0 * b4 * c0 * c3 * d2 - 16 * a0 * b0 * b4 * c0 * c4 * d1 -
          16 * a0 * b0 * b4 * c1 * c4 * d0 + 8 * a0 * b0 * b4 * c2 * c3 * d0 -
          4 * a0 * b0 * b5 * c0 * c1 * d3 - 4 * a0 * b0 * b5 * c0 * c3 * d1 -
          4 * a0 * b0 * b5 * c1 * c3 * d0 + 4 * a0 * b1 * b3 * c0 * c5 * d0 +
          16 * a0 * b1 * b4 * c0 * c4 * d0 + 4 * a0 * b1 * b5 * c0 * c3 * d0 -
          8 * a0 * b2 * b3 * c0 * c4 * d0 - 8 * a0 * b2 * b4 * c0 * c3 * d0 -
          8 * a0 * b3 * b4 * c0 * c2 * d0 + 4 * a0 * b3 * b5 * c0 * c1 * d0 +
          4 * a1 * a3 * b0 * c0 * d0 * d5 + 16 * a1 * a4 * b0 * c0 * d0 * d4 +
          4 * a1 * a5 * b0 * c0 * d0 * d3 + 4 * a1 * b0 * b3 * c0 * c5 * d0 +
          ...
          64 * a1 * a2 * b1 * c1 * d2 * d3 - 64 * a1 * a2 * b1 * c2 * d1 * d3 -
          64 * a1 * a2 * b1 * c3 * d1 * d2 + 64 * a1 * a2 * b2 * c1 * d1 * d3 +
          64 * a1 * a2 * b3 * c1 * d1 * d2 - 64 * a1 * a3 * b1 * c2 * d1 * d2 +
          64 * a1 * a3 * b2 * c1 * d1 * d2 - 64 * a1 * b1 * b2 * c1 * c2 * d3 -
          64 * a1 * b1 * b2 * c1 * c3 * d2 - 64 * a1 * b1 * b2 * c2 * c3 * d1 -
          64 * a1 * b1 * b3 * c1 * c2 * d2 + 64 * a1 * b2 * b3 * c1 * c2 * d1 +
          64 * a2 * a3 * b1 * c1 * d1 * d2 + 64 * a2 * b1 * b2 * c1 * c3 * d1 +
          64 * a2 * b1 * b3 * c1 * c2 * d1 + 64 * a3 * b1 * b2 * c1 * c2 * d1 +
          16 * a0 * a1 * a3 * d1 * d2 * d4 + 16 * a0 * a1 * a4 * d1 * d2 * d3 +
          16 * a0 * a1 * b1 * c1 * d3 * d5 - 32 * a0 * a1 * b1 * c2 * d3 * d4 +
          16 * a0 * a1 * b1 * c3 * d1 * d5 - 32 * a0 * a1 * b1 * c3 * d2 * d4 -
          32 * a0 * a1 * b1 * c4 * d2 * d3 + 16 * a0 * a1 * b1 * c5 * d1 * d3 +
          16 * a0 * a1 * b2 * c3 * d2 * d3 - 16 * a0 * a1 * b3 * c1 * d1 * d5 +
          16 * a0 * a1 * b3 * c1 * d2 * d4 + 16 * a0 * a1 * b3 * c2 * d1 * d4 -
          16 * a0 * a1 * b3 * c2 * d2 * d3 + 16 * a0 * a1 * b3 * c4 * d1 * d2 +
          16 * a0 * a1 * b4 * c1 * d2 * d3 + 16 * a0 * a1 * b4 * c2 * d1 * d3 +
          16 * a0 * a1 * b4 * c3 * d1 * d2 - 16 * a0 * a1 * b5 * c1 * d1 * d3 +
          16 * a0 * a2 * b1 * c3 * d2 * d3 - 16 * a0 * a2 * b2 * c3 * d1 * d3 -
          16 * a0 * a3 * b1 * c1 * d1 * d5 + 16 * a0 * a3 * b1 * c1 * d2 * d4 +
          16 * a0 * a3 * b1 * c2 * d1 * d4 - 16 * a0 * a3 * b1 * c2 * d2 * d3 +
          16 * a0 * a3 * b1 * c4 * d1 * d2 + 16 * a0 * a3 * b3 * c2 * d1 * d2 -
          32 * a0 * a3 * b4 * c1 * d1 * d2 + 16 * a0 * a4 * b1 * c1 * d2 * d3 +
          16 * a0 * a4 * b1 * c2 * d1 * d3 + 16 * a0 * a4 * b1 * c3 * d1 * d2 -
          32 * a0 * a4 * b3 * c1 * d1 * d2 - 16 * a0 * a5 * b1 * c1 * d1 * d3 +
          16 * a0 * b1 * b2 * c2 * c3 * d3 + 16 * a0 * b1 * b3 * c1 * c2 * d4 +
          16 * a0 * b1 * b3 * c1 * c4 * d2 - 16 * a0 * b1 * b3 * c1 * c5 * d1 -
          16 * a0 * b1 * b3 * c2 * c3 * d2 + 16 * a0 * b1 * b3 * c2 * c4 * d1 +
          16 * a0 * b1 * b4 * c1 * c2 * d3 + 16 * a0 * b1 * b4 * c1 * c3 * d2 +
          16 * a0 * b1 * b4 * c2 * c3 * d1 - 16 * a0 * b1 * b5 * c1 * c3 * d1 -
          32 * a0 * b3 * b4 * c1 * c2 * d1 - 16 * a1 * a2 * a3 * d0 * d1 * d4 -
          16 * a1 * a2 * a4 * d0 * d1 * d3 + 16 * a1 * a2 * b0 * c3 * d2 * d3 +
          32 * a1 * a2 * b1 * c0 * d3 * d4 + 32 * a1 * a2 * b1 * c3 * d0 * d4 +
          32 * a1 * a2 * b1 * c4 * d0 * d3 - 16 * a1 * a2 * b2 * c3 * d0 * d3 -
          16 * a1 * a2 * b3 * c0 * d1 * d4 - 16 * a1 * a2 * b3 * c1 * d0 * d4 -
          ...
          16 * a1 * a3 * b0 * c2 * d1 * d4 - 16 * a1 * a3 * b0 * c2 * d2 * d3 +
          16 * a1 * a3 * b0 * c4 * d1 * d2 + 16 * a1 * a3 * b1 * c0 * d1 * d5 +
          16 * a1 * a3 * b1 * c1 * d0 * d5 + 16 * a1 * a3 * b1 * c5 * d0 * d1 -
          16 * a1 * a3 * b2 * c0 * d1 * d4 - 16 * a1 * a3 * b2 * c1 * d0 * d4 -
          16 * a1 * a3 * b2 * c4 * d0 * d1 + 16 * a1 * a3 * b3 * c2 * d0 * d2 -
          16 * a1 * a3 * b5 * c1 * d0 * d1 + 16 * a1 * a4 * b0 * c1 * d2 * d3 +
          16 * a1 * a4 * b0 * c2 * d1 * d3 + 16 * a1 * a4 * b0 * c3 * d1 * d2 -
          16 * a1 * a4 * b2 * c0 * d1 * d3 - 16 * a1 * a4 * b2 * c1 * d0 * d3 -
          16 * a1 * a4 * b2 * c3 * d0 * d1 - 16 * a1 * a5 * b0 * c1 * d1 * d3 +
          ...
          32 * a1 * b1 * b2 * c0 * c3 * d4 + 32 * a1 * b1 * b2 * c0 * c4 * d3 +
          32 * a1 * b1 * b2 * c3 * c4 * d0 + 16 * a1 * b1 * b3 * c0 * c1 * d5 +
          ...
          16 * a2 * a4 * b1 * c3 * d0 * d1 + 32 * a2 * a4 * b3 * c1 * d0 * d1 +
          16 * a2 * b0 * b1 * c2 * c3 * d3 - 16 * a2 * b0 * b2 * c1 * c3 * d3 -
          ...
          16 * a2 * b1 * b4 * c1 * c3 * d0 + 16 * a2 * b2 * b3 * c0 * c1 * d3 +
          16 * a2 * b2 * b3 * c0 * c3 * d1 + 16 * a2 * b2 * b3 * c1 * c3 * d0 +
          32 * a2 * b3 * b4 * c0 * c1 * d1 - 32 * a3 * a4 * b0 * c1 * d1 * d2 +
          32 * a3 * a4 * b2 * c1 * d0 * d1 - 16 * a3 * a5 * b1 * c1 * d0 * d1 +
          ...
          16 * a4 * b0 * b1 * c2 * c3 * d1 - 32 * a4 * b0 * b3 * c1 * c2 * d1 -
          ...
          8 * a0 * a2 * b4 * c3 * d0 * d3 + 8 * a0 * a3 * a4 * d0 * d1 * d4 -
          ...
          8 * a1 * b0 * b4 * c0 * c3 * d4 - 8 * a1 * b0 * b4 * c0 * c4 * d3 -
          8 * a1 * b0 * b4 * c3 * c4 * d0 - 4 * a1 * b0 * b5 * c0 * c3 * d3 +
          4 * a1 * b3 * b5 * c0 * c3 * d0 + 8 * a2 * a3 * b3 * c0 * d0 * d4 -
          8 * a2 * a3 * b4 * c0 * d0 * d3 + 8 * a2 * a4 * b0 * c3 * d0 * d3 -
          8 * a2 * a4 * b3 * c0 * d0 * d3 + 8 * a2 * b0 * b4 * c0 * c3 * d3 -
          8 * a2 * b3 * b4 * c0 * c3 * d0 + 8 * a3 * a4 * b0 * c0 * d1 * d4 +
      ...
      4 * a5 * pow(b0, 2) * pow(c1, 3) - 16 * a3 * pow(b2, 2) * pow(c1, 3) -
          4 * a1 * pow(b4, 2) * pow(c0, 3) + 4 * pow(a0, 3) * c1 * pow(d4, 2) +
          16 * pow(a1, 3) * c3 * pow(d2, 2) - 4 * pow(a1, 3) * c5 * pow(d0, 2) +
          8 * a0 * b0 * b5 * pow(c1, 3) - 32 * a2 * b2 * b3 * pow(c1, 3) +
          8 * a0 * b3 * b5 * pow(c1, 3) - 2 * a1 * b3 * b5 * pow(c0, 3) +
          4 * a2 * b3 * b4 * pow(c0, 3) + 8 * a3 * b0 * b5 * pow(c1, 3) -
          2 * a3 * b1 * b5 * pow(c0, 3) + 4 * a3 * b2 * b4 * pow(c0, 3) -
          8 * a4 * b1 * b4 * pow(c0, 3) + 4 * a4 * b2 * b3 * pow(c0, 3) +
          8 * a5 * b0 * b3 * pow(c1, 3) - 2 * a5 * b1 * b3 * pow(c0, 3) -
          8 * pow(a1, 3) * c0 * d0 * d5 + 32 * pow(a1, 3) * c2 * d2 * d3 +
          ...
          16 * a0 * a1 * b5 * c0 * c1 * d1 + 8 * a0 * a2 * a3 * c0 * d1 * d2 +
          8 * a0 * a2 * a3 * c1 * d0 * d2 + 8 * a0 * a2 * a3 * c2 * d0 * d1 -
          32 * a0 * a2 * b0 * c1 * c4 * d1 + 16 * a0 * a2 * b1 * c0 * c1 * d4 -
          8 * a0 * a2 * b1 * c0 * c2 * d3 - 8 * a0 * a2 * b1 * c0 * c3 * d2 +
          16 * a0 * a2 * b1 * c0 * c4 * d1 + 16 * a0 * a2 * b1 * c1 * c4 * d0 -
          8 * a0 * a2 * b1 * c2 * c3 * d0 + 8 * a0 * a2 * b3 * c0 * c1 * d2 +
          8 * a0 * a2 * b3 * c0 * c2 * d1 + 8 * a0 * a2 * b3 * c1 * c2 * d0 -
          16 * a0 * a3 * b0 * c1 * c2 * d2 + 8 * a0 * a3 * b2 * c0 * c1 * d2 +
          8 * a0 * a3 * b2 * c0 * c2 * d1 + 8 * a0 * a3 * b2 * c1 * c2 * d0 +
          32 * a0 * a4 * b0 * c1 * c2 * d1 - 16 * a0 * a4 * b1 * c0 * c1 * d2 -
          16 * a0 * a4 * b1 * c0 * c2 * d1 - 16 * a0 * a4 * b1 * c1 * c2 * d0 -
          16 * a0 * a5 * b1 * c0 * c1 * d1 + 16 * a0 * b1 * b2 * c0 * c1 * c4 -
          8 * a0 * b1 * b2 * c0 * c2 * c3 - 16 * a0 * b1 * b4 * c0 * c1 * c2 +
          8 * a0 * b2 * b3 * c0 * c1 * c2 + 16 * a1 * a2 * b0 * c0 * c1 * d4 -
          8 * a1 * a2 * b0 * c0 * c2 * d3 - 8 * a1 * a2 * b0 * c0 * c3 * d2 +
          16 * a1 * a2 * b0 * c0 * c4 * d1 + 16 * a1 * a2 * b0 * c1 * c4 * d0 -
          8 * a1 * a2 * b0 * c2 * c3 * d0 - 32 * a1 * a2 * b1 * c0 * c4 * d0 +
          16 * a1 * a2 * b2 * c0 * c3 * d0 - 16 * a1 * a4 * b0 * c0 * c1 * d2 -
          16 * a1 * a4 * b0 * c0 * c2 * d1 - 16 * a1 * a4 * b0 * c1 * c2 * d0 +
          32 * a1 * a4 * b1 * c0 * c2 * d0 - 16 * a1 * a5 * b0 * c0 * c1 * d1 +
          16 * a1 * a5 * b1 * c0 * c1 * d0 + 16 * a1 * b0 * b1 * c0 * c1 * c5 +
          16 * a1 * b0 * b2 * c0 * c1 * c4 - 8 * a1 * b0 * b2 * c0 * c2 * c3 -
          16 * a1 * b0 * b4 * c0 * c1 * c2 + 8 * a2 * a3 * b0 * c0 * c1 * d2 +
          8 * a2 * a3 * b0 * c0 * c2 * d1 + 8 * a2 * a3 * b0 * c1 * c2 * d0 -
          16 * a2 * a3 * b2 * c0 * c1 * d0 + 16 * a2 * b0 * b1 * c0 * c1 * c4 -
          8 * a2 * b0 * b1 * c0 * c2 * c3 + 8 * a2 * b0 * b3 * c0 * c1 * c2 +
          8 * a3 * b0 * b2 * c0 * c1 * c2 - 16 * a4 * b0 * b1 * c0 * c1 * c2 +
          4 * a0 * a1 * a3 * c0 * d0 * d5 + 16 * a0 * a1 * a4 * c0 * d0 * d4 +
          4 * a0 * a1 * a5 * c0 * d0 * d3 - 4 * a0 * a1 * b0 * c0 * c3 * d5 -
          16 * a0 * a1 * b0 * c0 * c4 * d4 - 4 * a0 * a1 * b0 * c0 * c5 * d3 -
          4 * a0 * a1 * b0 * c3 * c5 * d0 + 4 * a0 * a1 * b3 * c0 * c5 * d0 +
          16 * a0 * a1 * b4 * c0 * c4 * d0 + 4 * a0 * a1 * b5 * c0 * c3 * d0 -
          8 * a0 * a2 * a3 * c0 * d0 * d4 - 8 * a0 * a2 * a4 * c0 * d0 * d3 +
          8 * a0 * a2 * b0 * c0 * c3 * d4 + 8 * a0 * a2 * b0 * c0 * c4 * d3 +
          8 * a0 * a2 * b0 * c3 * c4 * d0 - 8 * a0 * a2 * b3 * c0 * c4 * d0 -
          8 * a0 * a2 * b4 * c0 * c3 * d0 - 8 * a0 * a3 * a4 * c0 * d0 * d2 +
          4 * a0 * a3 * a5 * c0 * d0 * d1 - 4 * a0 * a3 * b0 * c0 * c1 * d5 +
          8 * a0 * a3 * b0 * c0 * c2 * d4 + 8 * a0 * a3 * b0 * c0 * c4 * d2 -
          4 * a0 * a3 * b0 * c0 * c5 * d1 - 4 * a0 * a3 * b0 * c1 * c5 * d0 +
          8 * a0 * a3 * b0 * c2 * c4 * d0 + 4 * a0 * a3 * b1 * c0 * c5 * d0 -
          8 * a0 * a3 * b2 * c0 * c4 * d0 - 8 * a0 * a3 * b4 * c0 * c2 * d0 +
          4 * a0 * a3 * b5 * c0 * c1 * d0 - 16 * a0 * a4 * b0 * c0 * c1 * d4 +
          8 * a0 * a4 * b0 * c0 * c2 * d3 + 8 * a0 * a4 * b0 * c0 * c3 * d2 -
          16 * a0 * a4 * b0 * c0 * c4 * d1 - 16 * a0 * a4 * b0 * c1 * c4 * d0 +
          8 * a0 * a4 * b0 * c2 * c3 * d0 + 16 * a0 * a4 * b1 * c0 * c4 * d0 -
          8 * a0 * a4 * b2 * c0 * c3 * d0 - 8 * a0 * a4 * b3 * c0 * c2 * d0 +
          16 * a0 * a4 * b4 * c0 * c1 * d0 - 4 * a0 * a5 * b0 * c0 * c1 * d3 -
          4 * a0 * a5 * b0 * c0 * c3 * d1 - 4 * a0 * a5 * b0 * c1 * c3 * d0 +
          4 * a0 * a5 * b1 * c0 * c3 * d0 + 4 * a0 * a5 * b3 * c0 * c1 * d0 -
          4 * a0 * b0 * b1 * c0 * c3 * c5 + 8 * a0 * b0 * b2 * c0 * c3 * c4 -
          4 * a0 * b0 * b3 * c0 * c1 * c5 + 8 * a0 * b0 * b3 * c0 * c2 * c4 -
          16 * a0 * b0 * b4 * c0 * c1 * c4 + 8 * a0 * b0 * b4 * c0 * c2 * c3 -
          4 * a0 * b0 * b5 * c0 * c1 * c3 + 4 * a1 * a3 * b0 * c0 * c5 * d0 +
          16 * a1 * a4 * b0 * c0 * c4 * d0 + 4 * a1 * a5 * b0 * c0 * c3 * d0 -
          8 * a2 * a3 * b0 * c0 * c4 * d0 - 8 * a2 * a4 * b0 * c0 * c3 * d0 -
          8 * a3 * a4 * b0 * c0 * c2 * d0 + 4 * a3 * a5 * b0 * c0 * c1 * d0 +
          64 * a1 * a2 * a3 * c1 * d1 * d2 - 64 * a1 * a2 * b1 * c1 * c2 * d3 -
          64 * a1 * a2 * b1 * c1 * c3 * d2 - 64 * a1 * a2 * b1 * c2 * c3 * d1 +
          64 * a1 * a2 * b2 * c1 * c3 * d1 + 64 * a1 * a2 * b3 * c1 * c2 * d1 -
          64 * a1 * a3 * b1 * c1 * c2 * d2 + 64 * a1 * a3 * b2 * c1 * c2 * d1 -
          64 * a1 * b1 * b2 * c1 * c2 * c3 + 64 * a2 * a3 * b1 * c1 * c2 * d1 +
          ...
          16 * a0 * a1 * a4 * c3 * d1 * d2 - 16 * a0 * a1 * a5 * c1 * d1 * d3 +
          16 * a0 * a1 * b1 * c1 * c3 * d5 + 16 * a0 * a1 * b1 * c1 * c5 * d3 -
          32 * a0 * a1 * b1 * c2 * c3 * d4 - 32 * a0 * a1 * b1 * c2 * c4 * d3 -
          32 * a0 * a1 * b1 * c3 * c4 * d2 + 16 * a0 * a1 * b1 * c3 * c5 * d1 +
          16 * a0 * a1 * b2 * c2 * c3 * d3 + 16 * a0 * a1 * b3 * c1 * c2 * d4 +
          16 * a0 * a1 * b3 * c1 * c4 * d2 - 16 * a0 * a1 * b3 * c1 * c5 * d1 -
          16 * a0 * a1 * b3 * c2 * c3 * d2 + 16 * a0 * a1 * b3 * c2 * c4 * d1 +
          16 * a0 * a1 * b4 * c1 * c2 * d3 + 16 * a0 * a1 * b4 * c1 * c3 * d2 +
          16 * a0 * a1 * b4 * c2 * c3 * d1 - 16 * a0 * a1 * b5 * c1 * c3 * d1 +
          16 * a0 * a2 * b1 * c2 * c3 * d3 - 16 * a0 * a2 * b2 * c1 * c3 * d3 -
          32 * a0 * a3 * a4 * c1 * d1 * d2 + 16 * a0 * a3 * b1 * c1 * c2 * d4 +
          ...
          16 * a0 * a4 * b1 * c2 * c3 * d1 - 32 * a0 * a4 * b3 * c1 * c2 * d1 -
          16 * a0 * a5 * b1 * c1 * c3 * d1 + 16 * a0 * b1 * b3 * c1 * c2 * c4 +
          16 * a0 * b1 * b4 * c1 * c2 * c3 - 16 * a1 * a2 * a3 * c0 * d1 * d4 -
          16 * a1 * a2 * a3 * c1 * d0 * d4 - 16 * a1 * a2 * a3 * c4 * d0 * d1 -
          16 * a1 * a2 * a4 * c0 * d1 * d3 - 16 * a1 * a2 * a4 * c1 * d0 * d3 -
          16 * a1 * a2 * a4 * c3 * d0 * d1 + 16 * a1 * a2 * b0 * c2 * c3 * d3 +
          32 * a1 * a2 * b1 * c0 * c3 * d4 + 32 * a1 * a2 * b1 * c0 * c4 * d3 +
          32 * a1 * a2 * b1 * c3 * c4 * d0 - 16 * a1 * a2 * b2 * c0 * c3 * d3 -
          16 * a1 * a2 * b3 * c0 * c1 * d4 - 16 * a1 * a2 * b3 * c0 * c4 * d1 -
          16 * a1 * a2 * b3 * c1 * c4 * d0 - 16 * a1 * a2 * b4 * c0 * c1 * d3 -
          ...
          16 * a1 * a5 * b3 * c0 * c1 * d1 + 16 * a1 * b0 * b1 * c1 * c3 * c5 -
          32 * a1 * b0 * b1 * c2 * c3 * c4 + 16 * a1 * b0 * b3 * c1 * c2 * c4 +
          16 * a1 * b0 * b4 * c1 * c2 * c3 + 32 * a1 * b1 * b2 * c0 * c3 * c4 +
          16 * a1 * b1 * b3 * c0 * c1 * c5 + 16 * a1 * b1 * b5 * c0 * c1 * c3 -
          16 * a1 * b2 * b3 * c0 * c1 * c4 - 16 * a1 * b2 * b4 * c0 * c1 * c3 +
          32 * a2 * a3 * a4 * c1 * d0 * d1 - 16 * a2 * a3 * b1 * c0 * c1 * d4 -
          16 * a2 * a3 * b1 * c0 * c4 * d1 - 16 * a2 * a3 * b1 * c1 * c4 * d0 +
          16 * a2 * a3 * b2 * c0 * c1 * d3 + 16 * a2 * a3 * b2 * c0 * c3 * d1 +
          16 * a2 * a3 * b2 * c1 * c3 * d0 - 16 * a2 * a3 * b3 * c0 * c1 * d2 -
          16 * a2 * a3 * b3 * c0 * c2 * d1 - 16 * a2 * a3 * b3 * c1 * c2 * d0 +
          32 * a2 * a3 * b4 * c0 * c1 * d1 - 16 * a2 * a4 * b1 * c0 * c1 * d3 -
          16 * a2 * a4 * b1 * c0 * c3 * d1 - 16 * a2 * a4 * b1 * c1 * c3 * d0 +
          32 * a2 * a4 * b3 * c0 * c1 * d1 - 16 * a2 * b1 * b3 * c0 * c1 * c4 -
          16 * a2 * b1 * b4 * c0 * c1 * c3 + 16 * a2 * b2 * b3 * c0 * c1 * c3 -
          32 * a3 * a4 * b0 * c1 * c2 * d1 + 32 * a3 * a4 * b2 * c0 * c1 * d1 -
          16 * a3 * a5 * b1 * c0 * c1 * d1 + 16 * a3 * b0 * b1 * c1 * c2 * c4 -
          16 * a3 * b1 * b2 * c0 * c1 * c4 - 16 * a3 * b2 * b3 * c0 * c1 * c2 +
          16 * a4 * b0 * b1 * c1 * c2 * c3 - 16 * a4 * b1 * b2 * c0 * c1 * c3 +
          4 * a0 * a1 * a3 * c0 * d3 * d5 + 4 * a0 * a1 * a3 * c3 * d0 * d5 +
          4 * a0 * a1 * a3 * c5 * d0 * d3 - 8 * a0 * a1 * a4 * c0 * d3 * d4 -
          8 * a0 * a1 * a4 * c3 * d0 * d4 - 8 * a0 * a1 * a4 * c4 * d0 * d3 -
          4 * a0 * a1 * a5 * c3 * d0 * d3 + 16 * a0 * a1 * b0 * c3 * c4 * d4 -
          4 * a0 * a1 * b0 * c3 * c5 * d3 + 4 * a0 * a1 * b3 * c0 * c3 * d5 +
          4 * a0 * a1 * b3 * c0 * c5 * d3 + 4 * a0 * a1 * b3 * c3 * c5 * d0 -
          8 * a0 * a1 * b4 * c0 * c3 * d4 - 8 * a0 * a1 * b4 * c0 * c4 * d3 -
          8 * a0 * a1 * b4 * c3 * c4 * d0 - 4 * a0 * a1 * b5 * c0 * c3 * d3 +
          8 * a0 * a2 * a4 * c3 * d0 * d3 - 8 * a0 * a2 * b0 * c3 * c4 * d3 +
          8 * a0 * a2 * b4 * c0 * c3 * d3 + 8 * a0 * a3 * a4 * c0 * d1 * d4 +
          8 * a0 * a3 * a4 * c1 * d0 * d4 + 8 * a0 * a3 * a4 * c4 * d0 * d1 -
          4 * a0 * a3 * a5 * c0 * d1 * d3 - 4 * a0 * a3 * a5 * c1 * d0 * d3 -
          4 * a0 * a3 * a5 * c3 * d0 * d1 - 4 * a0 * a3 * b0 * c1 * c3 * d5 -
          ...
          4 * a0 * b1 * b3 * c0 * c3 * c5 - 8 * a0 * b1 * b4 * c0 * c3 * c4 +
          8 * a0 * b3 * b4 * c0 * c1 * c4 - 4 * a0 * b3 * b5 * c0 * c1 * c3 +
          4 * a1 * a3 * a5 * c0 * d0 * d3 + 4 * a1 * a3 * b0 * c0 * c3 * d5 +
          4 * a1 * a3 * b0 * c0 * c5 * d3 + 4 * a1 * a3 * b0 * c3 * c5 * d0 -
          12 * a1 * a3 * b3 * c0 * c5 * d0 + 4 * a1 * a3 * b5 * c0 * c3 * d0 -
          8 * a1 * a4 * b0 * c0 * c3 * d4 - 8 * a1 * a4 * b0 * c0 * c4 * d3 -
          8 * a1 * a4 * b0 * c3 * c4 * d0 + 16 * a1 * a4 * b4 * c0 * c3 * d0 -
          4 * a1 * a5 * b0 * c0 * c3 * d3 + 4 * a1 * a5 * b3 * c0 * c3 * d0 +
          4 * a1 * b0 * b3 * c0 * c3 * c5 - 8 * a1 * b0 * b4 * c0 * c3 * c4 -
          8 * a2 * a3 * a4 * c0 * d0 * d3 + 8 * a2 * a3 * b3 * c0 * c4 * d0 -
          8 * a2 * a3 * b4 * c0 * c3 * d0 + 8 * a2 * a4 * b0 * c0 * c3 * d3 -
          8 * a2 * a4 * b3 * c0 * c3 * d0 + 8 * a3 * a4 * b0 * c0 * c1 * d4 +
          ...
          8 * a3 * b0 * b3 * c0 * c2 * c4 + 8 * a3 * b0 * b4 * c0 * c1 * c4 -
          4 * a3 * b0 * b5 * c0 * c1 * c3 - 8 * a4 * b0 * b1 * c0 * c3 * c4 +
          8 * a4 * b0 * b3 * c0 * c1 * c4 - 4 * a5 * b0 * b3 * c0 * c1 * c3,
      4 * pow(a0, 2) * b5 * pow(c1, 3) - 4 * pow(a4, 2) * b1 * pow(c0, 3) -
          16 * pow(a2, 2) * b3 * pow(c1, 3) + 4 * pow(a0, 3) * pow(c4, 2) * d1 -
          4 * pow(a1, 3) * pow(c0, 2) * d5 + 16 * pow(a1, 3) * pow(c2, 2) * d3 +
          8 * a0 * a5 * b0 * pow(c1, 3) - 32 * a2 * a3 * b2 * pow(c1, 3) +
          8 * a0 * a3 * b5 * pow(c1, 3) + 8 * a0 * a5 * b3 * pow(c1, 3) -
          2 * a1 * a3 * b5 * pow(c0, 3) - 8 * a1 * a4 * b4 * pow(c0, 3) -
          2 * a1 * a5 * b3 * pow(c0, 3) + 4 * a2 * a3 * b4 * pow(c0, 3) +
          4 * a2 * a4 * b3 * pow(c0, 3) + 4 * a3 * a4 * b2 * pow(c0, 3) +
          8 * a3 * a5 * b0 * pow(c1, 3) - 2 * a3 * a5 * b1 * pow(c0, 3) -
          8 * pow(a1, 3) * c0 * c5 * d0 + 32 * pow(a1, 3) * c2 * c3 * d2 +
          ...
          8 * a0 * a2 * a3 * c1 * c2 * d0 + 16 * a0 * a2 * b1 * c0 * c1 * c4 -
          8 * a0 * a2 * b1 * c0 * c2 * c3 + 8 * a0 * a2 * b3 * c0 * c1 * c2 +
          8 * a0 * a3 * b2 * c0 * c1 * c2 - 16 * a0 * a4 * b1 * c0 * c1 * c2 +
          16 * a1 * a2 * b0 * c0 * c1 * c4 - 8 * a1 * a2 * b0 * c0 * c2 * c3 -
          16 * a1 * a4 * b0 * c0 * c1 * c2 + 8 * a2 * a3 * b0 * c0 * c1 * c2 +
          4 * a0 * a1 * a3 * c0 * c5 * d0 + 16 * a0 * a1 * a4 * c0 * c4 * d0 +
          4 * a0 * a1 * a5 * c0 * c3 * d0 - 4 * a0 * a1 * b0 * c0 * c3 * c5 -
          8 * a0 * a2 * a3 * c0 * c4 * d0 - 8 * a0 * a2 * a4 * c0 * c3 * d0 +
          8 * a0 * a2 * b0 * c0 * c3 * c4 - 8 * a0 * a3 * a4 * c0 * c2 * d0 +
          4 * a0 * a3 * a5 * c0 * c1 * d0 - 4 * a0 * a3 * b0 * c0 * c1 * c5 +
          8 * a0 * a3 * b0 * c0 * c2 * c4 - 16 * a0 * a4 * b0 * c0 * c1 * c4 +
          8 * a0 * a4 * b0 * c0 * c2 * c3 - 4 * a0 * a5 * b0 * c0 * c1 * c3 +
          64 * a1 * a2 * a3 * c1 * c2 * d1 - 64 * a1 * a2 * b1 * c1 * c2 * c3 +
          ...
          16 * a0 * a1 * a4 * c2 * c3 * d1 - 16 * a0 * a1 * a5 * c1 * c3 * d1 +
          16 * a0 * a1 * b1 * c1 * c3 * c5 - 32 * a0 * a1 * b1 * c2 * c3 * c4 +
          16 * a0 * a1 * b3 * c1 * c2 * c4 + 16 * a0 * a1 * b4 * c1 * c2 * c3 -
          32 * a0 * a3 * a4 * c1 * c2 * d1 + 16 * a0 * a3 * b1 * c1 * c2 * c4 +
          ...
          16 * a1 * a2 * a4 * c1 * c3 * d0 + 32 * a1 * a2 * b1 * c0 * c3 * c4 -
          16 * a1 * a2 * b3 * c0 * c1 * c4 - 16 * a1 * a2 * b4 * c0 * c1 * c3 -
          16 * a1 * a3 * a5 * c0 * c1 * d1 + 16 * a1 * a3 * b0 * c1 * c2 * c4 +
          16 * a1 * a3 * b1 * c0 * c1 * c5 - 16 * a1 * a3 * b2 * c0 * c1 * c4 +
          16 * a1 * a4 * b0 * c1 * c2 * c3 - 16 * a1 * a4 * b2 * c0 * c1 * c3 +
          16 * a1 * a5 * b1 * c0 * c1 * c3 + 32 * a2 * a3 * a4 * c0 * c1 * d1 -
          16 * a2 * a3 * b1 * c0 * c1 * c4 + 16 * a2 * a3 * b2 * c0 * c1 * c3 -
          16 * a2 * a3 * b3 * c0 * c1 * c2 - 16 * a2 * a4 * b1 * c0 * c1 * c3 +
          4 * a0 * a1 * a3 * c0 * c3 * d5 + 4 * a0 * a1 * a3 * c0 * c5 * d3 +
          4 * a0 * a1 * a3 * c3 * c5 * d0 - 8 * a0 * a1 * a4 * c0 * c3 * d4 -
          8 * a0 * a1 * a4 * c0 * c4 * d3 - 8 * a0 * a1 * a4 * c3 * c4 * d0 -
          4 * a0 * a1 * a5 * c0 * c3 * d3 + 4 * a0 * a1 * b3 * c0 * c3 * c5 -
          8 * a0 * a1 * b4 * c0 * c3 * c4 + 8 * a0 * a2 * a4 * c0 * c3 * d3 +
          8 * a0 * a3 * a4 * c0 * c1 * d4 + 8 * a0 * a3 * a4 * c0 * c4 * d1 +
          8 * a0 * a3 * a4 * c1 * c4 * d0 - 4 * a0 * a3 * a5 * c0 * c1 * d3 -
          4 * a0 * a3 * a5 * c0 * c3 * d1 - 4 * a0 * a3 * a5 * c1 * c3 * d0 -
          4 * a0 * a3 * b0 * c1 * c3 * c5 + 8 * a0 * a3 * b0 * c2 * c3 * c4 +
          4 * a0 * a3 * b1 * c0 * c3 * c5 + 4 * a0 * a3 * b3 * c0 * c1 * c5 -
          8 * a0 * a3 * b3 * c0 * c2 * c4 + 8 * a0 * a3 * b4 * c0 * c1 * c4 -
          4 * a0 * a3 * b5 * c0 * c1 * c3 - 8 * a0 * a4 * b1 * c0 * c3 * c4 +
          8 * a0 * a4 * b3 * c0 * c1 * c4 - 4 * a0 * a5 * b3 * c0 * c1 * c3 +
          4 * a1 * a3 * a5 * c0 * c3 * d0 + 4 * a1 * a3 * b0 * c0 * c3 * c5 -
          8 * a1 * a4 * b0 * c0 * c3 * c4 - 8 * a2 * a3 * a4 * c0 * c3 * d0 +
          8 * a3 * a4 * b0 * c0 * c1 * c4 - 4 * a3 * a5 * b0 * c0 * c1 * c3,
      4 * pow(a0, 2) * a5 * pow(c1, 3) - 4 * a1 * pow(a4, 2) * pow(c0, 3) -
          16 * pow(a2, 2) * a3 * pow(c1, 3) + 4 * pow(a0, 3) * c1 * pow(c4, 2) -
          4 * pow(a1, 3) * pow(c0, 2) * c5 + 16 * pow(a1, 3) * pow(c2, 2) * c3 +
          8 * a0 * a3 * a5 * pow(c1, 3) - 2 * a1 * a3 * a5 * pow(c0, 3) +
          4 * a2 * a3 * a4 * pow(c0, 3) + 2 * pow(a0, 3) * c1 * c3 * c5 -
          4 * pow(a0, 3) * c2 * c3 * c4 - 8 * pow(a1, 3) * c0 * c3 * c5 +
      ...
      b1 * pow(b5, 2) * pow(d0, 3) - 8 * b0 * pow(b5, 2) * pow(d1, 3) +
          8 * pow(b0, 2) * b4 * pow(d2, 3) + 32 * pow(b1, 2) * b4 * pow(d2, 3) +
          16 * pow(b2, 2) * b5 * pow(d1, 3) - 4 * b3 * pow(b5, 2) * pow(d1, 3) +
          8 * pow(b3, 2) * b4 * pow(d2, 3) - pow(b0, 3) * d1 * pow(d5, 2) +
          8 * pow(b1, 3) * d0 * pow(d5, 2) - 8 * pow(b2, 3) * pow(d0, 2) * d4 -
          32 * pow(b2, 3) * pow(d1, 2) * d4 -
          16 * pow(b1, 3) * pow(d2, 2) * d5 + 4 * pow(b1, 3) * d3 * pow(d5, 2) -
          8 * pow(b2, 3) * pow(d3, 2) * d4 - 16 * b0 * b3 * b4 * pow(d2, 3) -
          4 * b2 * b4 * b5 * pow(d0, 3) + 16 * pow(b2, 3) * d0 * d3 * d4 +
          4 * pow(b0, 3) * d2 * d4 * d5 - b0 * pow(b5, 2) * pow(d0, 2) * d1 +
          ...
          8 * b0 * b1 * b2 * d0 * d2 * d5 - 8 * b0 * b2 * b5 * d0 * d1 * d2 -
          16 * b0 * b1 * b2 * d1 * d4 * d5 - 8 * b0 * b1 * b2 * d2 * d3 * d5 -
          16 * b0 * b1 * b5 * d1 * d2 * d4 - 8 * b0 * b2 * b3 * d1 * d2 * d5 -
          32 * b0 * b2 * b4 * d1 * d2 * d4 + 16 * b1 * b2 * b4 * d0 * d1 * d5 +
          32 * b1 * b2 * b4 * d0 * d2 * d4 + 8 * b1 * b2 * b5 * d0 * d2 * d3 +
          16 * b1 * b4 * b5 * d0 * d1 * d2 + 8 * b2 * b3 * b5 * d0 * d1 * d2 -
          8 * b0 * b1 * b4 * d0 * d4 * d5 + 8 * b0 * b2 * b3 * d0 * d4 * d5 -
          8 * b0 * b2 * b5 * d0 * d3 * d4 + 8 * b0 * b3 * b4 * d0 * d2 * d5 +
          8 * b0 * b4 * b5 * d0 * d1 * d4 - 8 * b0 * b4 * b5 * d0 * d2 * d3 +
          16 * b1 * b2 * b3 * d1 * d4 * d5 + 16 * b1 * b2 * b4 * d1 * d3 * d5 -
          32 * b1 * b2 * b4 * d2 * d3 * d4 - 16 * b1 * b3 * b5 * d1 * d2 * d4 -
          16 * b1 * b4 * b5 * d1 * d2 * d3 + 32 * b2 * b3 * b4 * d1 * d2 * d4 +
          8 * b0 * b1 * b4 * d3 * d4 * d5 - 8 * b0 * b3 * b4 * d1 * d4 * d5 +
          4 * b0 * b3 * b5 * d1 * d3 * d5 - 8 * b0 * b3 * b5 * d2 * d3 * d4 -
          4 * b1 * b3 * b5 * d0 * d3 * d5 + 8 * b1 * b4 * b5 * d0 * d3 * d4 +
          8 * b2 * b3 * b4 * d0 * d3 * d5 - 8 * b3 * b4 * b5 * d0 * d1 * d4,
      a1 * pow(b5, 2) * pow(d0, 3) - 8 * a0 * pow(b5, 2) * pow(d1, 3) +
          8 * a4 * pow(b0, 2) * pow(d2, 3) + 32 * a4 * pow(b1, 2) * pow(d2, 3) +
          16 * a5 * pow(b2, 2) * pow(d1, 3) - 4 * a3 * pow(b5, 2) * pow(d1, 3) +
          8 * a4 * pow(b3, 2) * pow(d2, 3) - pow(b0, 3) * c1 * pow(d5, 2) +
          8 * pow(b1, 3) * c0 * pow(d5, 2) - 8 * pow(b2, 3) * c4 * pow(d0, 2) -
          32 * pow(b2, 3) * c4 * pow(d1, 2) -
          16 * pow(b1, 3) * c5 * pow(d2, 2) + 4 * pow(b1, 3) * c3 * pow(d5, 2) -
          8 * pow(b2, 3) * c4 * pow(d3, 2) + 16 * a0 * b0 * b4 * pow(d2, 3) +
          64 * a1 * b1 * b4 * pow(d2, 3) - 16 * a0 * b3 * b4 * pow(d2, 3) -
          16 * a3 * b0 * b4 * pow(d2, 3) - 16 * a4 * b0 * b3 * pow(d2, 3) +
          32 * a2 * b2 * b5 * pow(d1, 3) - 4 * a2 * b4 * b5 * pow(d0, 3) -
          4 * a4 * b2 * b5 * pow(d0, 3) - 16 * a5 * b0 * b5 * pow(d1, 3) +
          2 * a5 * b1 * b5 * pow(d0, 3) - 4 * a5 * b2 * b4 * pow(d0, 3) +
          16 * a3 * b3 * b4 * pow(d2, 3) - 8 * a5 * b3 * b5 * pow(d1, 3) -
          16 * pow(b2, 3) * c0 * d0 * d4 - 64 * pow(b2, 3) * c1 * d1 * d4 +
          16 * pow(b2, 3) * c0 * d3 * d4 + 16 * pow(b2, 3) * c3 * d0 * d4 +
          16 * pow(b2, 3) * c4 * d0 * d3 - 32 * pow(b1, 3) * c2 * d2 * d5 +
          4 * pow(b0, 3) * c2 * d4 * d5 + 4 * pow(b0, 3) * c4 * d2 * d5 -
          2 * pow(b0, 3) * c5 * d1 * d5 + 4 * pow(b0, 3) * c5 * d2 * d4 +
          16 * pow(b1, 3) * c5 * d0 * d5 - 16 * pow(b2, 3) * c3 * d3 * d4 +
          8 * pow(b1, 3) * c5 * d3 * d5 -
          ...
          8 * pow(b1, 2) * b5 * c5 * d1 * d3 + 8 * a0 * b1 * b2 * d0 * d2 * d5 -
          8 * a0 * b2 * b5 * d0 * d1 * d2 + 8 * a1 * b0 * b2 * d0 * d2 * d5 +
          ...
          8 * b0 * b2 * b5 * c2 * d0 * d1 - 8 * a0 * b0 * b2 * d0 * d4 * d5 -
          8 * a0 * b0 * b4 * d0 * d2 * d5 + 4 * a0 * b0 * b5 * d0 * d1 * d5 -
          8 * a0 * b0 * b5 * d0 * d2 * d4 - 4 * b0 * b1 * b5 * c0 * d0 * d5 +
          8 * b0 * b2 * b4 * c0 * d0 * d5 + 8 * b0 * b2 * b5 * c0 * d0 * d4 +
          8 * b0 * b4 * b5 * c0 * d0 * d2 + 64 * a1 * b1 * b2 * d1 * d2 * d5 +
          128 * a2 * b1 * b2 * d1 * d2 * d4 -
          128 * b1 * b2 * b4 * c2 * d1 * d2 - 64 * b1 * b2 * b5 * c1 * d1 * d2 -
          16 * a0 * b1 * b2 * d1 * d4 * d5 - 8 * a0 * b1 * b2 * d2 * d3 * d5 -
          16 * a0 * b1 * b5 * d1 * d2 * d4 - 8 * a0 * b2 * b3 * d1 * d2 * d5 -
          32 * a0 * b2 * b4 * d1 * d2 * d4 + 32 * a1 * b0 * b1 * d2 * d4 * d5 -
          16 * a1 * b0 * b2 * d1 * d4 * d5 - 8 * a1 * b0 * b2 * d2 * d3 * d5 -
          16 * a1 * b0 * b5 * d1 * d2 * d4 - 32 * a1 * b1 * b4 * d0 * d2 * d5 -
          32 * a1 * b1 * b5 * d0 * d1 * d5 + 16 * a1 * b2 * b4 * d0 * d1 * d5 +
          32 * a1 * b2 * b4 * d0 * d2 * d4 + 8 * a1 * b2 * b5 * d0 * d2 * d3 +
          16 * a1 * b4 * b5 * d0 * d1 * d2 - 16 * a2 * b0 * b1 * d1 * d4 * d5 -
          8 * a2 * b0 * b1 * d2 * d3 * d5 + 16 * a2 * b0 * b2 * d1 * d3 * d5 -
          32 * a2 * b0 * b2 * d2 * d3 * d4 - 8 * a2 * b0 * b3 * d1 * d2 * d5 -
          32 * a2 * b0 * b4 * d1 * d2 * d4 + 16 * a2 * b1 * b4 * d0 * d1 * d5 +
          32 * a2 * b1 * b4 * d0 * d2 * d4 + 8 * a2 * b1 * b5 * d0 * d2 * d3 -
          32 * a2 * b2 * b3 * d0 * d2 * d4 - 32 * a2 * b2 * b4 * d0 * d2 * d3 -
          16 * a2 * b2 * b5 * d0 * d1 * d3 + 8 * a2 * b3 * b5 * d0 * d1 * d2 -
          8 * a3 * b0 * b2 * d1 * d2 * d5 + 8 * a3 * b2 * b5 * d0 * d1 * d2 -
          32 * a4 * b0 * b2 * d1 * d2 * d4 + 16 * a4 * b1 * b2 * d0 * d1 * d5 +
          32 * a4 * b1 * b2 * d0 * d2 * d4 + 16 * a4 * b1 * b5 * d0 * d1 * d2 -
          16 * a5 * b0 * b1 * d1 * d2 * d4 + 8 * a5 * b1 * b2 * d0 * d2 * d3 +
          16 * a5 * b1 * b4 * d0 * d1 * d2 + 8 * a5 * b2 * b3 * d0 * d1 * d2 -
          16 * b0 * b1 * b2 * c1 * d4 * d5 - 8 * b0 * b1 * b2 * c2 * d3 * d5 -
          8 * b0 * b1 * b2 * c3 * d2 * d5 - 16 * b0 * b1 * b2 * c4 * d1 * d5 -
          16 * b0 * b1 * b2 * c5 * d1 * d4 - 8 * b0 * b1 * b2 * c5 * d2 * d3 +
          16 * b0 * b1 * b3 * c2 * d2 * d5 + 32 * b0 * b1 * b5 * c1 * d1 * d5 -
          16 * b0 * b1 * b5 * c1 * d2 * d4 - 16 * b0 * b1 * b5 * c2 * d1 * d4 -
          16 * b0 * b1 * b5 * c4 * d1 * d2 - 8 * b0 * b2 * b3 * c1 * d2 * d5 -
          8 * b0 * b2 * b3 * c2 * d1 * d5 + 32 * b0 * b2 * b3 * c2 * d2 * d4 -
          8 * b0 * b2 * b3 * c5 * d1 * d2 - 32 * b0 * b2 * b4 * c1 * d2 * d4 -
          32 * b0 * b2 * b4 * c2 * d1 * d4 + 32 * b0 * b2 * b4 * c2 * d2 * d3 -
          ...
          8 * b1 * b2 * b5 * c0 * d2 * d3 + 8 * b1 * b2 * b5 * c2 * d0 * d3 +
          8 * b1 * b2 * b5 * c3 * d0 * d2 - 16 * b1 * b3 * b5 * c2 * d0 * d2 +
          16 * b1 * b4 * b5 * c0 * d1 * d2 + 16 * b1 * b4 * b5 * c1 * d0 * d2 +
          16 * b1 * b4 * b5 * c2 * d0 * d1 + 32 * b2 * b3 * b4 * c2 * d0 * d2 +
          8 * b2 * b3 * b5 * c0 * d1 * d2 + 8 * b2 * b3 * b5 * c1 * d0 * d2 +
          8 * b2 * b3 * b5 * c2 * d0 * d1 - 32 * b2 * b4 * b5 * c1 * d0 * d1 -
          16 * a0 * b0 * b3 * d2 * d4 * d5 + 16 * a0 * b0 * b4 * d1 * d4 * d5 -
          8 * a0 * b0 * b5 * d1 * d3 * d5 + 16 * a0 * b0 * b5 * d2 * d3 * d4 -
          8 * a0 * b1 * b4 * d0 * d4 * d5 + 8 * a0 * b2 * b3 * d0 * d4 * d5 -
          8 * a0 * b2 * b5 * d0 * d3 * d4 + 8 * a0 * b3 * b4 * d0 * d2 * d5 +
          8 * a0 * b4 * b5 * d0 * d1 * d4 - 8 * a0 * b4 * b5 * d0 * d2 * d3 -
          8 * a1 * b0 * b4 * d0 * d4 * d5 + 8 * a2 * b0 * b3 * d0 * d4 * d5 -
          8 * a2 * b0 * b5 * d0 * d3 * d4 + 8 * a3 * b0 * b2 * d0 * d4 * d5 +
          8 * a3 * b0 * b4 * d0 * d2 * d5 - 8 * a4 * b0 * b1 * d0 * d4 * d5 +
          8 * a4 * b0 * b3 * d0 * d2 * d5 - 16 * a4 * b0 * b4 * d0 * d1 * d5 +
          8 * a4 * b0 * b5 * d0 * d1 * d4 - 8 * a4 * b0 * b5 * d0 * d2 * d3 -
          8 * a5 * b0 * b2 * d0 * d3 * d4 + 8 * a5 * b0 * b4 * d0 * d1 * d4 -
          8 * a5 * b0 * b4 * d0 * d2 * d3 + 8 * a5 * b0 * b5 * d0 * d1 * d3 -
          8 * b0 * b1 * b3 * c5 * d0 * d5 - 8 * b0 * b1 * b4 * c0 * d4 * d5 -
          8 * b0 * b1 * b4 * c4 * d0 * d5 - 8 * b0 * b1 * b4 * c5 * d0 * d4 +
          16 * b0 * b1 * b5 * c4 * d0 * d4 + 8 * b0 * b2 * b3 * c0 * d4 * d5 +
          8 * b0 * b2 * b3 * c4 * d0 * d5 + 8 * b0 * b2 * b3 * c5 * d0 * d4 -
          8 * b0 * b2 * b5 * c0 * d3 * d4 - 8 * b0 * b2 * b5 * c3 * d0 * d4 -
          8 * b0 * b2 * b5 * c4 * d0 * d3 + 8 * b0 * b3 * b4 * c0 * d2 * d5 +
          8 * b0 * b3 * b4 * c2 * d0 * d5 + 8 * b0 * b3 * b4 * c5 * d0 * d2 +
          8 * b0 * b4 * b5 * c0 * d1 * d4 - 8 * b0 * b4 * b5 * c0 * d2 * d3 +
          8 * b0 * b4 * b5 * c1 * d0 * d4 - 8 * b0 * b4 * b5 * c2 * d0 * d3 -
          8 * b0 * b4 * b5 * c3 * d0 * d2 + 8 * b0 * b4 * b5 * c4 * d0 * d1 +
          8 * b1 * b3 * b5 * c0 * d0 * d5 - 16 * b1 * b4 * b5 * c0 * d0 * d4 -
          16 * b2 * b3 * b4 * c0 * d0 * d5 + 16 * b2 * b4 * b5 * c0 * d0 * d3 -
          ...
          16 * b1 * b2 * b3 * c1 * d4 * d5 + 16 * b1 * b2 * b3 * c4 * d1 * d5 +
          16 * b1 * b2 * b3 * c5 * d1 * d4 + 16 * b1 * b2 * b4 * c1 * d3 * d5 -
          32 * b1 * b2 * b4 * c2 * d3 * d4 + 16 * b1 * b2 * b4 * c3 * d1 * d5 -
          32 * b1 * b2 * b4 * c3 * d2 * d4 - 32 * b1 * b2 * b4 * c4 * d2 * d3 +
          16 * b1 * b2 * b4 * c5 * d1 * d3 - 16 * b1 * b2 * b5 * c3 * d2 * d3 +
          16 * b1 * b3 * b5 * c1 * d1 * d5 - 16 * b1 * b3 * b5 * c1 * d2 * d4 -
          16 * b1 * b3 * b5 * c2 * d1 * d4 + 16 * b1 * b3 * b5 * c2 * d2 * d3 -
          16 * b1 * b3 * b5 * c4 * d1 * d2 - 16 * b1 * b4 * b5 * c1 * d2 * d3 -
          16 * b1 * b4 * b5 * c2 * d1 * d3 - 16 * b1 * b4 * b5 * c3 * d1 * d2 -
          32 * b2 * b3 * b4 * c1 * d1 * d5 + 32 * b2 * b3 * b4 * c1 * d2 * d4 +
          32 * b2 * b3 * b4 * c2 * d1 * d4 - 32 * b2 * b3 * b4 * c2 * d2 * d3 +
          32 * b2 * b3 * b4 * c4 * d1 * d2 + 32 * b3 * b4 * b5 * c1 * d1 * d2 +
      ...
      8 * pow(a0, 2) * b4 * pow(d2, 3) - 8 * pow(a5, 2) * b0 * pow(d1, 3) +
          pow(a5, 2) * b1 * pow(d0, 3) + 32 * pow(a1, 2) * b4 * pow(d2, 3) +
          16 * pow(a2, 2) * b5 * pow(d1, 3) + 8 * pow(a3, 2) * b4 * pow(d2, 3) -
          4 * pow(a5, 2) * b3 * pow(d1, 3) - pow(b0, 3) * pow(c5, 2) * d1 +
          8 * pow(b1, 3) * pow(c5, 2) * d0 - 8 * pow(b2, 3) * pow(c0, 2) * d4 -
          32 * pow(b2, 3) * pow(c1, 2) * d4 -
          16 * pow(b1, 3) * pow(c2, 2) * d5 + 4 * pow(b1, 3) * pow(c5, 2) * d3 -
          8 * pow(b2, 3) * pow(c3, 2) * d4 + 16 * a0 * a4 * b0 * pow(d2, 3) +
          64 * a1 * a4 * b1 * pow(d2, 3) - 16 * a0 * a3 * b4 * pow(d2, 3) -
          16 * a0 * a4 * b3 * pow(d2, 3) - 16 * a3 * a4 * b0 * pow(d2, 3) +
          32 * a2 * a5 * b2 * pow(d1, 3) - 16 * a0 * a5 * b5 * pow(d1, 3) +
          2 * a1 * a5 * b5 * pow(d0, 3) - 4 * a2 * a4 * b5 * pow(d0, 3) -
          4 * a2 * a5 * b4 * pow(d0, 3) - 4 * a4 * a5 * b2 * pow(d0, 3) +
          16 * a3 * a4 * b3 * pow(d2, 3) - 8 * a3 * a5 * b5 * pow(d1, 3) -
          16 * pow(b2, 3) * c0 * c4 * d0 - 64 * pow(b2, 3) * c1 * c4 * d1 +
          16 * pow(b2, 3) * c0 * c3 * d4 + 16 * pow(b2, 3) * c0 * c4 * d3 +
          16 * pow(b2, 3) * c3 * c4 * d0 - 32 * pow(b1, 3) * c2 * c5 * d2 -
          2 * pow(b0, 3) * c1 * c5 * d5 + 4 * pow(b0, 3) * c2 * c4 * d5 +
          4 * pow(b0, 3) * c2 * c5 * d4 + 4 * pow(b0, 3) * c4 * c5 * d2 +
          16 * pow(b1, 3) * c0 * c5 * d5 - 16 * pow(b2, 3) * c3 * c4 * d3 +
          8 * pow(b1, 3) * c3 * c5 * d5 -
          ...
          8 * a0 * a5 * b2 * d0 * d1 * d2 - 16 * a0 * b0 * b1 * c2 * d2 * d5 -
          32 * a0 * b0 * b2 * c2 * d2 * d4 + 16 * a0 * b0 * b5 * c2 * d1 * d2 +
          8 * a0 * b1 * b2 * c0 * d2 * d5 + 8 * a0 * b1 * b2 * c2 * d0 * d5 +
          8 * a0 * b1 * b2 * c5 * d0 * d2 - 32 * a0 * b2 * b4 * c2 * d0 * d2 -
          8 * a0 * b2 * b5 * c0 * d1 * d2 - 8 * a0 * b2 * b5 * c1 * d0 * d2 -
          8 * a0 * b2 * b5 * c2 * d0 * d1 + 8 * a1 * a2 * b0 * d0 * d2 * d5 +
          8 * a1 * b0 * b2 * c0 * d2 * d5 + 8 * a1 * b0 * b2 * c2 * d0 * d5 +
          8 * a1 * b0 * b2 * c5 * d0 * d2 - 8 * a2 * a5 * b0 * d0 * d1 * d2 +
          ...
          16 * a2 * b1 * b2 * c0 * d0 * d5 + 32 * a2 * b2 * b4 * c0 * d0 * d2 +
          16 * a2 * b2 * b5 * c0 * d0 * d1 - 32 * a4 * b0 * b2 * c2 * d0 * d2 -
          8 * a5 * b0 * b2 * c0 * d1 * d2 - 8 * a5 * b0 * b2 * c1 * d0 * d2 -
          8 * a5 * b0 * b2 * c2 * d0 * d1 + 8 * b0 * b1 * b2 * c0 * c2 * d5 +
          8 * b0 * b1 * b2 * c0 * c5 * d2 + 8 * b0 * b1 * b2 * c2 * c5 * d0 -
          32 * b0 * b2 * b4 * c0 * c2 * d2 - 8 * b0 * b2 * b5 * c0 * c1 * d2 -
          8 * b0 * b2 * b5 * c0 * c2 * d1 - 8 * b0 * b2 * b5 * c1 * c2 * d0 -
          8 * a0 * a2 * b0 * d0 * d4 * d5 - 8 * a0 * a4 * b0 * d0 * d2 * d5 +
          ...
          4 * a0 * b0 * b5 * c5 * d0 * d1 - 4 * a0 * b1 * b5 * c0 * d0 * d5 +
          8 * a0 * b2 * b4 * c0 * d0 * d5 + 8 * a0 * b2 * b5 * c0 * d0 * d4 +
          8 * a0 * b4 * b5 * c0 * d0 * d2 - 4 * a1 * b0 * b5 * c0 * d0 * d5 +
          8 * a2 * b0 * b4 * c0 * d0 * d5 + 8 * a2 * b0 * b5 * c0 * d0 * d4 +
          8 * a4 * b0 * b2 * c0 * d0 * d5 + 8 * a4 * b0 * b5 * c0 * d0 * d2 -
          4 * a5 * b0 * b1 * c0 * d0 * d5 + 8 * a5 * b0 * b2 * c0 * d0 * d4 +
          8 * a5 * b0 * b4 * c0 * d0 * d2 - 4 * a5 * b0 * b5 * c0 * d0 * d1 -
          4 * b0 * b1 * b5 * c0 * c5 * d0 + 8 * b0 * b2 * b4 * c0 * c5 * d0 +
          8 * b0 * b2 * b5 * c0 * c4 * d0 + 8 * b0 * b4 * b5 * c0 * c2 * d0 +
          64 * a1 * a2 * b1 * d1 * d2 * d5 + 128 * a1 * a2 * b2 * d1 * d2 * d4 +
          64 * a1 * b1 * b2 * c1 * d2 * d5 + 64 * a1 * b1 * b2 * c2 * d1 * d5 -
          128 * a1 * b1 * b2 * c2 * d2 * d4 + 64 * a1 * b1 * b2 * c5 * d1 * d2 +
          64 * a1 * b1 * b5 * c2 * d1 * d2 - 128 * a1 * b2 * b4 * c2 * d1 * d2 -
          64 * a1 * b2 * b5 * c1 * d1 * d2 - 64 * a2 * b1 * b2 * c1 * d1 * d5 +
          128 * a2 * b1 * b2 * c1 * d2 * d4 +
          128 * a2 * b1 * b2 * c2 * d1 * d4 +
          128 * a2 * b1 * b2 * c4 * d1 * d2 -
          128 * a2 * b1 * b4 * c2 * d1 * d2 - 64 * a2 * b1 * b5 * c1 * d1 * d2 +
          128 * a2 * b2 * b4 * c1 * d1 * d2 -
          128 * a4 * b1 * b2 * c2 * d1 * d2 - 64 * a5 * b1 * b2 * c1 * d1 * d2 -
          128 * b1 * b2 * b4 * c1 * c2 * d2 - 64 * b1 * b2 * b5 * c1 * c2 * d1 +
          32 * a0 * a1 * b1 * d2 * d4 * d5 - 16 * a0 * a1 * b2 * d1 * d4 * d5 -
          8 * a0 * a1 * b2 * d2 * d3 * d5 - 16 * a0 * a1 * b5 * d1 * d2 * d4 -
          16 * a0 * a2 * b1 * d1 * d4 * d5 - 8 * a0 * a2 * b1 * d2 * d3 * d5 +
          16 * a0 * a2 * b2 * d1 * d3 * d5 - 32 * a0 * a2 * b2 * d2 * d3 * d4 -
          8 * a0 * a2 * b3 * d1 * d2 * d5 - 32 * a0 * a2 * b4 * d1 * d2 * d4 -
          8 * a0 * a3 * b2 * d1 * d2 * d5 - 32 * a0 * a4 * b2 * d1 * d2 * d4 -
          16 * a0 * a5 * b1 * d1 * d2 * d4 - 16 * a0 * b1 * b2 * c1 * d4 * d5 -
          8 * a0 * b1 * b2 * c2 * d3 * d5 - 8 * a0 * b1 * b2 * c3 * d2 * d5 -
          16 * a0 * b1 * b2 * c4 * d1 * d5 - 16 * a0 * b1 * b2 * c5 * d1 * d4 -
          8 * a0 * b1 * b2 * c5 * d2 * d3 + 16 * a0 * b1 * b3 * c2 * d2 * d5 +
          32 * a0 * b1 * b5 * c1 * d1 * d5 - 16 * a0 * b1 * b5 * c1 * d2 * d4 -
          16 * a0 * b1 * b5 * c2 * d1 * d4 - 16 * a0 * b1 * b5 * c4 * d1 * d2 -
          8 * a0 * b2 * b3 * c1 * d2 * d5 - 8 * a0 * b2 * b3 * c2 * d1 * d5 +
          32 * a0 * b2 * b3 * c2 * d2 * d4 - 8 * a0 * b2 * b3 * c5 * d1 * d2 -
          32 * a0 * b2 * b4 * c1 * d2 * d4 - 32 * a0 * b2 * b4 * c2 * d1 * d4 +
          32 * a0 * b2 * b4 * c2 * d2 * d3 - 32 * a0 * b2 * b4 * c4 * d1 * d2 +
          32 * a0 * b2 * b5 * c1 * d1 * d4 - 16 * a1 * a2 * b0 * d1 * d4 * d5 -
          8 * a1 * a2 * b0 * d2 * d3 * d5 + 16 * a1 * a2 * b4 * d0 * d1 * d5 +
          32 * a1 * a2 * b4 * d0 * d2 * d4 + 8 * a1 * a2 * b5 * d0 * d2 * d3 -
          32 * a1 * a4 * b1 * d0 * d2 * d5 + 16 * a1 * a4 * b2 * d0 * d1 * d5 +
          32 * a1 * a4 * b2 * d0 * d2 * d4 + 16 * a1 * a4 * b5 * d0 * d1 * d2 -
          16 * a1 * a5 * b0 * d1 * d2 * d4 - 32 * a1 * a5 * b1 * d0 * d1 * d5 +
          8 * a1 * a5 * b2 * d0 * d2 * d3 + 16 * a1 * a5 * b4 * d0 * d1 * d2 +
          ...
          8 * a2 * a3 * b0 * d1 * d2 * d5 - 32 * a2 * a3 * b2 * d0 * d2 * d4 +
          8 * a2 * a3 * b5 * d0 * d1 * d2 - 32 * a2 * a4 * b0 * d1 * d2 * d4 +
          16 * a2 * a4 * b1 * d0 * d1 * d5 + 32 * a2 * a4 * b1 * d0 * d2 * d4 -
          32 * a2 * a4 * b2 * d0 * d2 * d3 + 8 * a2 * a5 * b1 * d0 * d2 * d3 -
          16 * a2 * a5 * b2 * d0 * d1 * d3 + 8 * a2 * a5 * b3 * d0 * d1 * d2 -
          ...
          8 * a3 * a5 * b2 * d0 * d1 * d2 + 16 * a3 * b0 * b1 * c2 * d2 * d5 -
          8 * a3 * b0 * b2 * c1 * d2 * d5 - 8 * a3 * b0 * b2 * c2 * d1 * d5 +
          32 * a3 * b0 * b2 * c2 * d2 * d4 - 8 * a3 * b0 * b2 * c5 * d1 * d2 -
          16 * a3 * b1 * b5 * c2 * d0 * d2 + 32 * a3 * b2 * b4 * c2 * d0 * d2 +
          8 * a3 * b2 * b5 * c0 * d1 * d2 + 8 * a3 * b2 * b5 * c1 * d0 * d2 +
          8 * a3 * b2 * b5 * c2 * d0 * d1 + 16 * a4 * a5 * b1 * d0 * d1 * d2 -
          ...
          16 * b0 * b1 * b2 * c1 * c4 * d5 - 16 * b0 * b1 * b2 * c1 * c5 * d4 -
          8 * b0 * b1 * b2 * c2 * c3 * d5 - 8 * b0 * b1 * b2 * c2 * c5 * d3 -
          8 * b0 * b1 * b2 * c3 * c5 * d2 - 16 * b0 * b1 * b2 * c4 * c5 * d1 +
          16 * b0 * b1 * b3 * c2 * c5 * d2 - 16 * b0 * b1 * b5 * c1 * c2 * d4 -
          16 * b0 * b1 * b5 * c1 * c4 * d2 + 32 * b0 * b1 * b5 * c1 * c5 * d1 -
          16 * b0 * b1 * b5 * c2 * c4 * d1 - 8 * b0 * b2 * b3 * c1 * c2 * d5 -
          8 * b0 * b2 * b3 * c1 * c5 * d2 + 32 * b0 * b2 * b3 * c2 * c4 * d2 -
          8 * b0 * b2 * b3 * c2 * c5 * d1 - 32 * b0 * b2 * b4 * c1 * c2 * d4 -
          32 * b0 * b2 * b4 * c1 * c4 * d2 + 32 * b0 * b2 * b4 * c2 * c3 * d2 -
          32 * b0 * b2 * b4 * c2 * c4 * d1 + 32 * b0 * b2 * b5 * c1 * c4 * d1 +
          ...
          16 * b1 * b4 * b5 * c0 * c1 * d2 + 16 * b1 * b4 * b5 * c0 * c2 * d1 +
          16 * b1 * b4 * b5 * c1 * c2 * d0 + 32 * b2 * b3 * b4 * c0 * c2 * d2 +
          8 * b2 * b3 * b5 * c0 * c1 * d2 + 8 * b2 * b3 * b5 * c0 * c2 * d1 +
          8 * b2 * b3 * b5 * c1 * c2 * d0 - 32 * b2 * b4 * b5 * c0 * c1 * d1 -
          8 * a0 * a1 * b4 * d0 * d4 * d5 + 8 * a0 * a2 * b3 * d0 * d4 * d5 -
          8 * a0 * a2 * b5 * d0 * d3 * d4 - 16 * a0 * a3 * b0 * d2 * d4 * d5 +
          8 * a0 * a3 * b2 * d0 * d4 * d5 + 8 * a0 * a3 * b4 * d0 * d2 * d5 +
          16 * a0 * a4 * b0 * d1 * d4 * d5 - 8 * a0 * a4 * b1 * d0 * d4 * d5 +
          8 * a0 * a4 * b3 * d0 * d2 * d5 - 16 * a0 * a4 * b4 * d0 * d1 * d5 +
          8 * a0 * a4 * b5 * d0 * d1 * d4 - 8 * a0 * a4 * b5 * d0 * d2 * d3 -
          8 * a0 * a5 * b0 * d1 * d3 * d5 + 16 * a0 * a5 * b0 * d2 * d3 * d4 -
          8 * a0 * a5 * b2 * d0 * d3 * d4 + 8 * a0 * a5 * b4 * d0 * d1 * d4 -
          8 * a0 * a5 * b4 * d0 * d2 * d3 + 8 * a0 * a5 * b5 * d0 * d1 * d3 +
          ...
          8 * a0 * b4 * b5 * c4 * d0 * d1 - 8 * a1 * a4 * b0 * d0 * d4 * d5 -
          8 * a1 * b0 * b3 * c5 * d0 * d5 - 8 * a1 * b0 * b4 * c0 * d4 * d5 -
          8 * a1 * b0 * b4 * c4 * d0 * d5 - 8 * a1 * b0 * b4 * c5 * d0 * d4 +
          16 * a1 * b0 * b5 * c4 * d0 * d4 + 8 * a1 * b3 * b5 * c0 * d0 * d5 -
          16 * a1 * b4 * b5 * c0 * d0 * d4 + 8 * a2 * a3 * b0 * d0 * d4 * d5 -
          8 * a2 * a5 * b0 * d0 * d3 * d4 + 8 * a2 * b0 * b3 * c0 * d4 * d5 +
          8 * a2 * b0 * b3 * c4 * d0 * d5 + 8 * a2 * b0 * b3 * c5 * d0 * d4 -
          8 * a2 * b0 * b5 * c0 * d3 * d4 - 8 * a2 * b0 * b5 * c3 * d0 * d4 -
          8 * a2 * b0 * b5 * c4 * d0 * d3 - 16 * a2 * b3 * b4 * c0 * d0 * d5 +
          16 * a2 * b4 * b5 * c0 * d0 * d3 + 8 * a3 * a4 * b0 * d0 * d2 * d5 -
          ...
          16 * a3 * b2 * b4 * c0 * d0 * d5 + 8 * a4 * a5 * b0 * d0 * d1 * d4 -
          8 * a4 * a5 * b0 * d0 * d2 * d3 - 8 * a4 * b0 * b1 * c0 * d4 * d5 -
          ...
          8 * b0 * b1 * b3 * c0 * c5 * d5 - 8 * b0 * b1 * b4 * c0 * c4 * d5 -
          8 * b0 * b1 * b4 * c0 * c5 * d4 - 8 * b0 * b1 * b4 * c4 * c5 * d0 +
          16 * b0 * b1 * b5 * c0 * c4 * d4 + 8 * b0 * b2 * b3 * c0 * c4 * d5 +
          8 * b0 * b2 * b3 * c0 * c5 * d4 + 8 * b0 * b2 * b3 * c4 * c5 * d0 -
          8 * b0 * b2 * b5 * c0 * c3 * d4 - 8 * b0 * b2 * b5 * c0 * c4 * d3 -
          8 * b0 * b2 * b5 * c3 * c4 * d0 + 8 * b0 * b3 * b4 * c0 * c2 * d5 +
          8 * b0 * b3 * b4 * c0 * c5 * d2 + 8 * b0 * b3 * b4 * c2 * c5 * d0 +
          8 * b0 * b4 * b5 * c0 * c1 * d4 - 8 * b0 * b4 * b5 * c0 * c2 * d3 -
          8 * b0 * b4 * b5 * c0 * c3 * d2 + 8 * b0 * b4 * b5 * c0 * c4 * d1 +
          8 * b0 * b4 * b5 * c1 * c4 * d0 - 8 * b0 * b4 * b5 * c2 * c3 * d0 +
          8 * b1 * b3 * b5 * c0 * c5 * d0 - 16 * b1 * b4 * b5 * c0 * c4 * d0 -
          16 * b2 * b3 * b4 * c0 * c5 * d0 + 16 * b2 * b4 * b5 * c0 * c3 * d0 -
          ...
          16 * a1 * a5 * b4 * d1 * d2 * d3 - 32 * a1 * b1 * b2 * c3 * d4 * d5 -
          ...
          16 * a1 * b4 * b5 * c3 * d1 * d2 + 16 * a2 * a3 * b1 * d1 * d4 * d5 -
          ...
          32 * a2 * a4 * b3 * d1 * d2 * d4 + 16 * a2 * b1 * b2 * c3 * d3 * d5 +
          64 * a2 * b1 * b2 * c4 * d3 * d4 + 16 * a2 * b1 * b3 * c1 * d4 * d5 +
          16 * a2 * b1 * b3 * c4 * d1 * d5 + 16 * a2 * b1 * b3 * c5 * d1 * d4 +
          ...
          16 * a2 * b1 * b5 * c3 * d2 * d3 - 16 * a2 * b2 * b3 * c1 * d3 * d5 +
          32 * a2 * b2 * b3 * c2 * d3 * d4 - 16 * a2 * b2 * b3 * c3 * d1 * d5 +
          32 * a2 * b2 * b3 * c3 * d2 * d4 - 64 * a2 * b2 * b3 * c4 * d1 * d4 +
          32 * a2 * b2 * b3 * c4 * d2 * d3 - 16 * a2 * b2 * b3 * c5 * d1 * d3 +
          32 * a2 * b2 * b4 * c3 * d2 * d3 + 16 * a2 * b2 * b5 * c3 * d1 * d3 -
          32 * a2 * b3 * b4 * c1 * d1 * d5 + 32 * a2 * b3 * b4 * c1 * d2 * d4 +
          32 * a2 * b3 * b4 * c2 * d1 * d4 - 32 * a2 * b3 * b4 * c2 * d2 * d3 +
          32 * a2 * b3 * b4 * c4 * d1 * d2 + 32 * a3 * a4 * b2 * d1 * d2 * d4 -
          16 * a3 * a5 * b1 * d1 * d2 * d4 + 16 * a3 * b1 * b2 * c1 * d4 * d5 +
          ...
          32 * a3 * b4 * b5 * c1 * d1 * d2 - 16 * a4 * a5 * b1 * d1 * d2 * d3 +
          ...
          32 * a4 * b2 * b3 * c4 * d1 * d2 - 64 * a4 * b3 * b4 * c2 * d1 * d2 +
          32 * a4 * b3 * b5 * c1 * d1 * d2 - 16 * a5 * b1 * b2 * c3 * d2 * d3 +
          ...
          16 * a5 * b1 * b5 * c1 * d1 * d3 + 32 * a5 * b3 * b4 * c1 * d1 * d2 +
          16 * b1 * b2 * b3 * c1 * c4 * d5 + 16 * b1 * b2 * b3 * c1 * c5 * d4 +
          16 * b1 * b2 * b3 * c4 * c5 * d1 + 16 * b1 * b2 * b4 * c1 * c3 * d5 +
          16 * b1 * b2 * b4 * c1 * c5 * d3 - 32 * b1 * b2 * b4 * c2 * c3 * d4 -
          32 * b1 * b2 * b4 * c2 * c4 * d3 - 32 * b1 * b2 * b4 * c3 * c4 * d2 +
          16 * b1 * b2 * b4 * c3 * c5 * d1 - 16 * b1 * b2 * b5 * c2 * c3 * d3 -
          16 * b1 * b3 * b5 * c1 * c2 * d4 - 16 * b1 * b3 * b5 * c1 * c4 * d2 +
          16 * b1 * b3 * b5 * c1 * c5 * d1 + 16 * b1 * b3 * b5 * c2 * c3 * d2 -
          16 * b1 * b3 * b5 * c2 * c4 * d1 - 16 * b1 * b4 * b5 * c1 * c2 * d3 -
          16 * b1 * b4 * b5 * c1 * c3 * d2 - 16 * b1 * b4 * b5 * c2 * c3 * d1 +
          32 * b2 * b3 * b4 * c1 * c2 * d4 + 32 * b2 * b3 * b4 * c1 * c4 * d2 -
          32 * b2 * b3 * b4 * c1 * c5 * d1 - 32 * b2 * b3 * b4 * c2 * c3 * d2 +
          32 * b2 * b3 * b4 * c2 * c4 * d1 + 32 * b3 * b4 * b5 * c1 * c2 * d1 +
          ...
          8 * a0 * a5 * b3 * d2 * d3 * d4 - 4 * a0 * b1 * b3 * c5 * d3 * d5 +
          8 * a0 * b1 * b4 * c3 * d4 * d5 + 8 * a0 * b1 * b4 * c4 * d3 * d5 +
          8 * a0 * b1 * b4 * c5 * d3 * d4 + 4 * a0 * b1 * b5 * c3 * d3 * d5 -
          16 * a0 * b1 * b5 * c4 * d3 * d4 - 8 * a0 * b2 * b4 * c3 * d3 * d5 +
          8 * a0 * b2 * b5 * c3 * d3 * d4 - 8 * a0 * b3 * b4 * c1 * d4 * d5 -
          8 * a0 * b3 * b4 * c4 * d1 * d5 - 8 * a0 * b3 * b4 * c5 * d1 * d4 +
          4 * a0 * b3 * b5 * c1 * d3 * d5 - 8 * a0 * b3 * b5 * c2 * d3 * d4 +
          4 * a0 * b3 * b5 * c3 * d1 * d5 - 8 * a0 * b3 * b5 * c3 * d2 * d4 +
          16 * a0 * b3 * b5 * c4 * d1 * d4 - 8 * a0 * b3 * b5 * c4 * d2 * d3 +
          4 * a0 * b3 * b5 * c5 * d1 * d3 + 8 * a0 * b4 * b5 * c3 * d2 * d3 -
          4 * a1 * a3 * b5 * d0 * d3 * d5 + 8 * a1 * a4 * b0 * d3 * d4 * d5 -
          16 * a1 * a4 * b4 * d0 * d3 * d5 + 8 * a1 * a4 * b5 * d0 * d3 * d4 -
          4 * a1 * a5 * b3 * d0 * d3 * d5 + 8 * a1 * a5 * b4 * d0 * d3 * d4 -
          4 * a1 * b0 * b3 * c5 * d3 * d5 + 8 * a1 * b0 * b4 * c3 * d4 * d5 +
          8 * a1 * b0 * b4 * c4 * d3 * d5 + 8 * a1 * b0 * b4 * c5 * d3 * d4 +
          4 * a1 * b0 * b5 * c3 * d3 * d5 - 16 * a1 * b0 * b5 * c4 * d3 * d4 -
          4 * a1 * b3 * b5 * c0 * d3 * d5 - 4 * a1 * b3 * b5 * c3 * d0 * d5 -
          4 * a1 * b3 * b5 * c5 * d0 * d3 + 8 * a1 * b4 * b5 * c0 * d3 * d4 +
          8 * a1 * b4 * b5 * c3 * d0 * d4 + 8 * a1 * b4 * b5 * c4 * d0 * d3 -
          8 * a2 * a3 * b3 * d0 * d4 * d5 + 8 * a2 * a3 * b4 * d0 * d3 * d5 +
          8 * a2 * a4 * b3 * d0 * d3 * d5 - 8 * a2 * b0 * b4 * c3 * d3 * d5 +
          8 * a2 * b0 * b5 * c3 * d3 * d4 + 8 * a2 * b3 * b4 * c0 * d3 * d5 +
          8 * a2 * b3 * b4 * c3 * d0 * d5 + 8 * a2 * b3 * b4 * c5 * d0 * d3 -
          8 * a2 * b4 * b5 * c3 * d0 * d3 - 8 * a3 * a4 * b0 * d1 * d4 * d5 +
          8 * a3 * a4 * b2 * d0 * d3 * d5 - 8 * a3 * a4 * b3 * d0 * d2 * d5 +
          16 * a3 * a4 * b4 * d0 * d1 * d5 - 8 * a3 * a4 * b5 * d0 * d1 * d4 +
          4 * a3 * a5 * b0 * d1 * d3 * d5 - 8 * a3 * a5 * b0 * d2 * d3 * d4 -
          4 * a3 * a5 * b1 * d0 * d3 * d5 - 4 * a3 * a5 * b3 * d0 * d1 * d5 +
          8 * a3 * a5 * b3 * d0 * d2 * d4 - 8 * a3 * a5 * b4 * d0 * d1 * d4 +
          4 * a3 * a5 * b5 * d0 * d1 * d3 - 4 * a3 * b0 * b1 * c5 * d3 * d5 +
      ...
      a1 * pow(a5, 2) * pow(d0, 3) - 8 * a0 * pow(a5, 2) * pow(d1, 3) +
          8 * pow(a0, 2) * a4 * pow(d2, 3) + 32 * pow(a1, 2) * a4 * pow(d2, 3) +
          16 * pow(a2, 2) * a5 * pow(d1, 3) - 4 * a3 * pow(a5, 2) * pow(d1, 3) +
          8 * pow(a3, 2) * a4 * pow(d2, 3) - 8 * b0 * pow(b5, 2) * pow(c1, 3) +
          b1 * pow(b5, 2) * pow(c0, 3) + 8 * pow(b0, 2) * b4 * pow(c2, 3) +
          32 * pow(b1, 2) * b4 * pow(c2, 3) +
          16 * pow(b2, 2) * b5 * pow(c1, 3) - 4 * b3 * pow(b5, 2) * pow(c1, 3) +
          8 * pow(b3, 2) * b4 * pow(c2, 3) - pow(b0, 3) * c1 * pow(c5, 2) +
          8 * pow(b1, 3) * c0 * pow(c5, 2) - 8 * pow(b2, 3) * pow(c0, 2) * c4 -
          32 * pow(b2, 3) * pow(c1, 2) * c4 -
          16 * pow(b1, 3) * pow(c2, 2) * c5 + 4 * pow(b1, 3) * c3 * pow(c5, 2) -
          8 * pow(b2, 3) * pow(c3, 2) * c4 - pow(a0, 3) * d1 * pow(d5, 2) +
          8 * pow(a1, 3) * d0 * pow(d5, 2) - 8 * pow(a2, 3) * pow(d0, 2) * d4 -
          32 * pow(a2, 3) * pow(d1, 2) * d4 -
          16 * pow(a1, 3) * pow(d2, 2) * d5 + 4 * pow(a1, 3) * d3 * pow(d5, 2) -
          8 * pow(a2, 3) * pow(d3, 2) * d4 - 16 * a0 * a3 * a4 * pow(d2, 3) -
          4 * a2 * a4 * a5 * pow(d0, 3) - 16 * b0 * b3 * b4 * pow(c2, 3) -
          4 * b2 * b4 * b5 * pow(c0, 3) + 16 * pow(b2, 3) * c0 * c3 * c4 +
          4 * pow(b0, 3) * c2 * c4 * c5 + 16 * pow(a2, 3) * d0 * d3 * d4 +
          4 * pow(a0, 3) * d2 * d4 * d5 - a0 * pow(a5, 2) * pow(d0, 2) * d1 -
          ...
          8 * pow(a1, 2) * b5 * c5 * d1 * d3 + 8 * a0 * a1 * a2 * d0 * d2 * d5 -
          16 * a0 * a1 * b0 * c2 * d2 * d5 + 8 * a0 * a1 * b2 * c0 * d2 * d5 +
          8 * a0 * a1 * b2 * c2 * d0 * d5 + 8 * a0 * a1 * b2 * c5 * d0 * d2 -
          8 * a0 * a2 * a5 * d0 * d1 * d2 - 32 * a0 * a2 * b0 * c2 * d2 * d4 +
          8 * a0 * a2 * b1 * c0 * d2 * d5 + 8 * a0 * a2 * b1 * c2 * d0 * d5 +
          8 * a0 * a2 * b1 * c5 * d0 * d2 + 32 * a0 * a2 * b2 * c0 * d2 * d4 +
          32 * a0 * a2 * b2 * c2 * d0 * d4 + 32 * a0 * a2 * b2 * c4 * d0 * d2 -
          32 * a0 * a2 * b4 * c2 * d0 * d2 - 8 * a0 * a2 * b5 * c0 * d1 * d2 -
          8 * a0 * a2 * b5 * c1 * d0 * d2 - 8 * a0 * a2 * b5 * c2 * d0 * d1 -
          32 * a0 * a4 * b2 * c2 * d0 * d2 + 16 * a0 * a5 * b0 * c2 * d1 * d2 -
          8 * a0 * a5 * b2 * c0 * d1 * d2 - 8 * a0 * a5 * b2 * c1 * d0 * d2 -
          8 * a0 * a5 * b2 * c2 * d0 * d1 - 16 * a0 * b0 * b1 * c2 * c5 * d2 -
          32 * a0 * b0 * b2 * c2 * c4 * d2 + 16 * a0 * b0 * b5 * c1 * c2 * d2 +
          8 * a0 * b1 * b2 * c0 * c2 * d5 + 8 * a0 * b1 * b2 * c0 * c5 * d2 +
          8 * a0 * b1 * b2 * c2 * c5 * d0 - 32 * a0 * b2 * b4 * c0 * c2 * d2 -
          8 * a0 * b2 * b5 * c0 * c1 * d2 - 8 * a0 * b2 * b5 * c0 * c2 * d1 -
          8 * a0 * b2 * b5 * c1 * c2 * d0 + 8 * a1 * a2 * b0 * c0 * d2 * d5 +
          8 * a1 * a2 * b0 * c2 * d0 * d5 + 8 * a1 * a2 * b0 * c5 * d0 * d2 -
          16 * a1 * a2 * b2 * c0 * d0 * d5 + 8 * a1 * b0 * b2 * c0 * c2 * d5 +
          8 * a1 * b0 * b2 * c0 * c5 * d2 + 8 * a1 * b0 * b2 * c2 * c5 * d0 -
          ...
          16 * a2 * b1 * b2 * c0 * c5 * d0 + 32 * a2 * b2 * b4 * c0 * c2 * d0 +
          16 * a2 * b2 * b5 * c0 * c1 * d0 - 32 * a4 * b0 * b2 * c0 * c2 * d2 -
          8 * a5 * b0 * b2 * c0 * c1 * d2 - 8 * a5 * b0 * b2 * c0 * c2 * d1 -
          8 * a5 * b0 * b2 * c1 * c2 * d0 + 8 * b0 * b1 * b2 * c0 * c2 * c5 -
          8 * b0 * b2 * b5 * c0 * c1 * c2 + 4 * a0 * a1 * b0 * c5 * d0 * d5 -
          4 * a0 * a1 * b5 * c0 * d0 * d5 - 8 * a0 * a2 * b0 * c0 * d4 * d5 -
          8 * a0 * a2 * b0 * c4 * d0 * d5 - 8 * a0 * a2 * b0 * c5 * d0 * d4 +
          8 * a0 * a2 * b4 * c0 * d0 * d5 + 8 * a0 * a2 * b5 * c0 * d0 * d4 -
          8 * a0 * a4 * b0 * c0 * d2 * d5 - 8 * a0 * a4 * b0 * c2 * d0 * d5 -
          8 * a0 * a4 * b0 * c5 * d0 * d2 + 8 * a0 * a4 * b2 * c0 * d0 * d5 +
          ...
          8 * a0 * a5 * b2 * c0 * d0 * d4 + 8 * a0 * a5 * b4 * c0 * d0 * d2 -
          4 * a0 * a5 * b5 * c0 * d0 * d1 + 4 * a0 * b0 * b1 * c0 * c5 * d5 -
          8 * a0 * b0 * b2 * c0 * c4 * d5 - 8 * a0 * b0 * b2 * c0 * c5 * d4 -
          8 * a0 * b0 * b2 * c4 * c5 * d0 - 8 * a0 * b0 * b4 * c0 * c2 * d5 -
          8 * a0 * b0 * b4 * c0 * c5 * d2 - 8 * a0 * b0 * b4 * c2 * c5 * d0 +
          4 * a0 * b0 * b5 * c0 * c1 * d5 - 8 * a0 * b0 * b5 * c0 * c2 * d4 -
          8 * a0 * b0 * b5 * c0 * c4 * d2 + 4 * a0 * b0 * b5 * c0 * c5 * d1 +
          4 * a0 * b0 * b5 * c1 * c5 * d0 - 8 * a0 * b0 * b5 * c2 * c4 * d0 -
          4 * a0 * b1 * b5 * c0 * c5 * d0 + 8 * a0 * b2 * b4 * c0 * c5 * d0 +
          8 * a0 * b2 * b5 * c0 * c4 * d0 + 8 * a0 * b4 * b5 * c0 * c2 * d0 -
          4 * a1 * a5 * b0 * c0 * d0 * d5 - 4 * a1 * b0 * b5 * c0 * c5 * d0 +
          8 * a2 * a4 * b0 * c0 * d0 * d5 + 8 * a2 * a5 * b0 * c0 * d0 * d4 +
          8 * a2 * b0 * b4 * c0 * c5 * d0 + 8 * a2 * b0 * b5 * c0 * c4 * d0 +
          8 * a4 * a5 * b0 * c0 * d0 * d2 + 8 * a4 * b0 * b2 * c0 * c5 * d0 +
          8 * a4 * b0 * b5 * c0 * c2 * d0 - 4 * a5 * b0 * b1 * c0 * c5 * d0 +
          8 * a5 * b0 * b2 * c0 * c4 * d0 + 8 * a5 * b0 * b4 * c0 * c2 * d0 -
          4 * a5 * b0 * b5 * c0 * c1 * d0 + 64 * a1 * a2 * b1 * c1 * d2 * d5 +
          64 * a1 * a2 * b1 * c2 * d1 * d5 - 128 * a1 * a2 * b1 * c2 * d2 * d4 +
          64 * a1 * a2 * b1 * c5 * d1 * d2 - 64 * a1 * a2 * b2 * c1 * d1 * d5 +
          128 * a1 * a2 * b2 * c1 * d2 * d4 +
          128 * a1 * a2 * b2 * c2 * d1 * d4 +
          128 * a1 * a2 * b2 * c4 * d1 * d2 -
          128 * a1 * a2 * b4 * c2 * d1 * d2 - 64 * a1 * a2 * b5 * c1 * d1 * d2 -
          128 * a1 * a4 * b2 * c2 * d1 * d2 + 64 * a1 * a5 * b1 * c2 * d1 * d2 -
          64 * a1 * a5 * b2 * c1 * d1 * d2 + 64 * a1 * b1 * b2 * c1 * c2 * d5 +
          ...
          128 * a2 * a4 * b1 * c2 * d1 * d2 +
          128 * a2 * a4 * b2 * c1 * d1 * d2 - 64 * a2 * a5 * b1 * c1 * d1 * d2 +
          ...
          128 * a2 * b2 * b4 * c1 * c2 * d1 -
          128 * a4 * b1 * b2 * c1 * c2 * d2 - 64 * a5 * b1 * b2 * c1 * c2 * d1 -
          16 * a0 * a1 * a2 * d1 * d4 * d5 - 8 * a0 * a1 * a2 * d2 * d3 * d5 -
          16 * a0 * a1 * a5 * d1 * d2 * d4 + 32 * a0 * a1 * b1 * c2 * d4 * d5 +
          32 * a0 * a1 * b1 * c4 * d2 * d5 - 32 * a0 * a1 * b1 * c5 * d1 * d5 +
          32 * a0 * a1 * b1 * c5 * d2 * d4 - 16 * a0 * a1 * b2 * c1 * d4 * d5 -
          8 * a0 * a1 * b2 * c2 * d3 * d5 - 8 * a0 * a1 * b2 * c3 * d2 * d5 -
          16 * a0 * a1 * b2 * c4 * d1 * d5 - 16 * a0 * a1 * b2 * c5 * d1 * d4 -
          8 * a0 * a1 * b2 * c5 * d2 * d3 + 16 * a0 * a1 * b3 * c2 * d2 * d5 +
          32 * a0 * a1 * b5 * c1 * d1 * d5 - 16 * a0 * a1 * b5 * c1 * d2 * d4 -
          16 * a0 * a1 * b5 * c2 * d1 * d4 - 16 * a0 * a1 * b5 * c4 * d1 * d2 -
          8 * a0 * a2 * a3 * d1 * d2 * d5 - 32 * a0 * a2 * a4 * d1 * d2 * d4 -
          16 * a0 * a2 * b1 * c1 * d4 * d5 - 8 * a0 * a2 * b1 * c2 * d3 * d5 -
          8 * a0 * a2 * b1 * c3 * d2 * d5 - 16 * a0 * a2 * b1 * c4 * d1 * d5 -
          16 * a0 * a2 * b1 * c5 * d1 * d4 - 8 * a0 * a2 * b1 * c5 * d2 * d3 +
          16 * a0 * a2 * b2 * c1 * d3 * d5 - 32 * a0 * a2 * b2 * c2 * d3 * d4 +
          16 * a0 * a2 * b2 * c3 * d1 * d5 - 32 * a0 * a2 * b2 * c3 * d2 * d4 +
          64 * a0 * a2 * b2 * c4 * d1 * d4 - 32 * a0 * a2 * b2 * c4 * d2 * d3 +
          16 * a0 * a2 * b2 * c5 * d1 * d3 - 8 * a0 * a2 * b3 * c1 * d2 * d5 -
          8 * a0 * a2 * b3 * c2 * d1 * d5 + 32 * a0 * a2 * b3 * c2 * d2 * d4 -
          8 * a0 * a2 * b3 * c5 * d1 * d2 - 32 * a0 * a2 * b4 * c1 * d2 * d4 -
          32 * a0 * a2 * b4 * c2 * d1 * d4 + 32 * a0 * a2 * b4 * c2 * d2 * d3 -
          32 * a0 * a2 * b4 * c4 * d1 * d2 + 32 * a0 * a2 * b5 * c1 * d1 * d4 +
          16 * a0 * a3 * b1 * c2 * d2 * d5 - 8 * a0 * a3 * b2 * c1 * d2 * d5 -
          8 * a0 * a3 * b2 * c2 * d1 * d5 + 32 * a0 * a3 * b2 * c2 * d2 * d4 -
          8 * a0 * a3 * b2 * c5 * d1 * d2 - 32 * a0 * a4 * b2 * c1 * d2 * d4 -
          32 * a0 * a4 * b2 * c2 * d1 * d4 + 32 * a0 * a4 * b2 * c2 * d2 * d3 -
          32 * a0 * a4 * b2 * c4 * d1 * d2 + 64 * a0 * a4 * b4 * c2 * d1 * d2 +
          32 * a0 * a5 * b1 * c1 * d1 * d5 - 16 * a0 * a5 * b1 * c1 * d2 * d4 -
          16 * a0 * a5 * b1 * c2 * d1 * d4 - 16 * a0 * a5 * b1 * c4 * d1 * d2 +
          32 * a0 * a5 * b2 * c1 * d1 * d4 - 16 * a0 * b1 * b2 * c1 * c4 * d5 -
          16 * a0 * b1 * b2 * c1 * c5 * d4 - 8 * a0 * b1 * b2 * c2 * c3 * d5 -
          8 * a0 * b1 * b2 * c2 * c5 * d3 - 8 * a0 * b1 * b2 * c3 * c5 * d2 -
          16 * a0 * b1 * b2 * c4 * c5 * d1 + 16 * a0 * b1 * b3 * c2 * c5 * d2 -
          16 * a0 * b1 * b5 * c1 * c2 * d4 - 16 * a0 * b1 * b5 * c1 * c4 * d2 +
          32 * a0 * b1 * b5 * c1 * c5 * d1 - 16 * a0 * b1 * b5 * c2 * c4 * d1 -
          8 * a0 * b2 * b3 * c1 * c2 * d5 - 8 * a0 * b2 * b3 * c1 * c5 * d2 +
          32 * a0 * b2 * b3 * c2 * c4 * d2 - 8 * a0 * b2 * b3 * c2 * c5 * d1 -
          32 * a0 * b2 * b4 * c1 * c2 * d4 - 32 * a0 * b2 * b4 * c1 * c4 * d2 +
          32 * a0 * b2 * b4 * c2 * c3 * d2 - 32 * a0 * b2 * b4 * c2 * c4 * d1 +
          32 * a0 * b2 * b5 * c1 * c4 * d1 + 16 * a1 * a2 * a4 * d0 * d1 * d5 +
          ...
          16 * a1 * a4 * a5 * d0 * d1 * d2 - 32 * a1 * a4 * b1 * c0 * d2 * d5 -
          ...
          64 * a1 * a4 * b4 * c2 * d0 * d2 + 16 * a1 * a4 * b5 * c0 * d1 * d2 +
          16 * a1 * a4 * b5 * c1 * d0 * d2 + 16 * a1 * a4 * b5 * c2 * d0 * d1 +
          32 * a1 * a5 * b0 * c1 * d1 * d5 - 16 * a1 * a5 * b0 * c1 * d2 * d4 -
          16 * a1 * a5 * b0 * c2 * d1 * d4 - 16 * a1 * a5 * b0 * c4 * d1 * d2 -
          32 * a1 * a5 * b1 * c0 * d1 * d5 - 32 * a1 * a5 * b1 * c1 * d0 * d5 -
          32 * a1 * a5 * b1 * c5 * d0 * d1 + 8 * a1 * a5 * b2 * c0 * d2 * d3 +
          8 * a1 * a5 * b2 * c2 * d0 * d3 + 8 * a1 * a5 * b2 * c3 * d0 * d2 -
          16 * a1 * a5 * b3 * c2 * d0 * d2 + 16 * a1 * a5 * b4 * c0 * d1 * d2 +
          16 * a1 * a5 * b4 * c1 * d0 * d2 + 16 * a1 * a5 * b4 * c2 * d0 * d1 +
          32 * a1 * a5 * b5 * c1 * d0 * d1 - 32 * a1 * b0 * b1 * c1 * c5 * d5 +
          32 * a1 * b0 * b1 * c2 * c4 * d5 + 32 * a1 * b0 * b1 * c2 * c5 * d4 +
          32 * a1 * b0 * b1 * c4 * c5 * d2 - 16 * a1 * b0 * b2 * c1 * c4 * d5 -
          16 * a1 * b0 * b2 * c1 * c5 * d4 - 8 * a1 * b0 * b2 * c2 * c3 * d5 -
          8 * a1 * b0 * b2 * c2 * c5 * d3 - 8 * a1 * b0 * b2 * c3 * c5 * d2 -
          16 * a1 * b0 * b2 * c4 * c5 * d1 + 16 * a1 * b0 * b3 * c2 * c5 * d2 -
          16 * a1 * b0 * b5 * c1 * c2 * d4 - 16 * a1 * b0 * b5 * c1 * c4 * d2 +
          32 * a1 * b0 * b5 * c1 * c5 * d1 - 16 * a1 * b0 * b5 * c2 * c4 * d1 -
          32 * a1 * b1 * b4 * c0 * c2 * d5 - 32 * a1 * b1 * b4 * c0 * c5 * d2 -
          32 * a1 * b1 * b4 * c2 * c5 * d0 - 32 * a1 * b1 * b5 * c0 * c1 * d5 -
          32 * a1 * b1 * b5 * c0 * c5 * d1 - 32 * a1 * b1 * b5 * c1 * c5 * d0 +
          16 * a1 * b2 * b4 * c0 * c1 * d5 + 32 * a1 * b2 * b4 * c0 * c2 * d4 +
          32 * a1 * b2 * b4 * c0 * c4 * d2 + 16 * a1 * b2 * b4 * c0 * c5 * d1 +
          16 * a1 * b2 * b4 * c1 * c5 * d0 + 32 * a1 * b2 * b4 * c2 * c4 * d0 +
          8 * a1 * b2 * b5 * c0 * c2 * d3 + 8 * a1 * b2 * b5 * c0 * c3 * d2 +
          8 * a1 * b2 * b5 * c2 * c3 * d0 - 16 * a1 * b3 * b5 * c0 * c2 * d2 +
          16 * a1 * b4 * b5 * c0 * c1 * d2 + 16 * a1 * b4 * b5 * c0 * c2 * d1 +
          16 * a1 * b4 * b5 * c1 * c2 * d0 + 8 * a2 * a3 * a5 * d0 * d1 * d2 -
          ...
          32 * a2 * a5 * b4 * c1 * d0 * d1 - 16 * a2 * b0 * b1 * c1 * c4 * d5 -
          16 * a2 * b0 * b1 * c1 * c5 * d4 - 8 * a2 * b0 * b1 * c2 * c3 * d5 -
          8 * a2 * b0 * b1 * c2 * c5 * d3 - 8 * a2 * b0 * b1 * c3 * c5 * d2 -
          16 * a2 * b0 * b1 * c4 * c5 * d1 + 16 * a2 * b0 * b2 * c1 * c3 * d5 +
          64 * a2 * b0 * b2 * c1 * c4 * d4 + 16 * a2 * b0 * b2 * c1 * c5 * d3 -
          32 * a2 * b0 * b2 * c2 * c3 * d4 - 32 * a2 * b0 * b2 * c2 * c4 * d3 -
          32 * a2 * b0 * b2 * c3 * c4 * d2 + 16 * a2 * b0 * b2 * c3 * c5 * d1 -
          8 * a2 * b0 * b3 * c1 * c2 * d5 - 8 * a2 * b0 * b3 * c1 * c5 * d2 +
          32 * a2 * b0 * b3 * c2 * c4 * d2 - 8 * a2 * b0 * b3 * c2 * c5 * d1 -
          32 * a2 * b0 * b4 * c1 * c2 * d4 - 32 * a2 * b0 * b4 * c1 * c4 * d2 +
          32 * a2 * b0 * b4 * c2 * c3 * d2 - 32 * a2 * b0 * b4 * c2 * c4 * d1 +
          32 * a2 * b0 * b5 * c1 * c4 * d1 - 64 * a2 * b1 * b2 * c0 * c4 * d4 +
          ...
          8 * a2 * b1 * b5 * c0 * c2 * d3 + 8 * a2 * b1 * b5 * c0 * c3 * d2 +
          8 * a2 * b1 * b5 * c2 * c3 * d0 - 32 * a2 * b2 * b3 * c0 * c2 * d4 -
          32 * a2 * b2 * b3 * c0 * c4 * d2 - 32 * a2 * b2 * b3 * c2 * c4 * d0 -
          32 * a2 * b2 * b4 * c0 * c2 * d3 - 32 * a2 * b2 * b4 * c0 * c3 * d2 -
          32 * a2 * b2 * b4 * c2 * c3 * d0 - 16 * a2 * b2 * b5 * c0 * c1 * d3 -
          16 * a2 * b2 * b5 * c0 * c3 * d1 - 16 * a2 * b2 * b5 * c1 * c3 * d0 +
          32 * a2 * b3 * b4 * c0 * c2 * d2 + 8 * a2 * b3 * b5 * c0 * c1 * d2 +
          8 * a2 * b3 * b5 * c0 * c2 * d1 + 8 * a2 * b3 * b5 * c1 * c2 * d0 -
          32 * a2 * b4 * b5 * c0 * c1 * d1 + 32 * a3 * a4 * b2 * c2 * d0 * d2 -
          ...
          8 * a0 * a1 * a4 * d0 * d4 * d5 + 8 * a0 * a1 * b0 * c5 * d3 * d5 -
          8 * a0 * a1 * b3 * c5 * d0 * d5 - 8 * a0 * a1 * b4 * c0 * d4 * d5 -
          8 * a0 * a1 * b4 * c4 * d0 * d5 - 8 * a0 * a1 * b4 * c5 * d0 * d4 +
          16 * a0 * a1 * b5 * c4 * d0 * d4 + 8 * a0 * a2 * a3 * d0 * d4 * d5 -
          8 * a0 * a2 * a5 * d0 * d3 * d4 + 8 * a0 * a2 * b3 * c0 * d4 * d5 +
          8 * a0 * a2 * b3 * c4 * d0 * d5 + 8 * a0 * a2 * b3 * c5 * d0 * d4 -
          8 * a0 * a2 * b5 * c0 * d3 * d4 - 8 * a0 * a2 * b5 * c3 * d0 * d4 -
          8 * a0 * a2 * b5 * c4 * d0 * d3 + 8 * a0 * a3 * a4 * d0 * d2 * d5 -
          ...
          8 * a0 * a3 * b4 * c5 * d0 * d2 + 8 * a0 * a4 * a5 * d0 * d1 * d4 -
          8 * a0 * a4 * a5 * d0 * d2 * d3 + 16 * a0 * a4 * b0 * c1 * d4 * d5 +
          ...
          8 * a0 * a5 * b5 * c3 * d0 * d1 + 8 * a0 * b0 * b1 * c3 * c5 * d5 +
          8 * a0 * b0 * b3 * c1 * c5 * d5 - 16 * a0 * b0 * b3 * c2 * c4 * d5 -
          16 * a0 * b0 * b3 * c2 * c5 * d4 - 16 * a0 * b0 * b3 * c4 * c5 * d2 +
          16 * a0 * b0 * b4 * c1 * c4 * d5 + 16 * a0 * b0 * b4 * c1 * c5 * d4 +
          16 * a0 * b0 * b4 * c4 * c5 * d1 - 8 * a0 * b0 * b5 * c1 * c3 * d5 -
          32 * a0 * b0 * b5 * c1 * c4 * d4 - 8 * a0 * b0 * b5 * c1 * c5 * d3 +
          16 * a0 * b0 * b5 * c2 * c3 * d4 + 16 * a0 * b0 * b5 * c2 * c4 * d3 +
          16 * a0 * b0 * b5 * c3 * c4 * d2 - 8 * a0 * b0 * b5 * c3 * c5 * d1 -
          8 * a0 * b1 * b3 * c0 * c5 * d5 - 8 * a0 * b1 * b4 * c0 * c4 * d5 -
          8 * a0 * b1 * b4 * c0 * c5 * d4 - 8 * a0 * b1 * b4 * c4 * c5 * d0 +
          16 * a0 * b1 * b5 * c0 * c4 * d4 + 8 * a0 * b2 * b3 * c0 * c4 * d5 +
          8 * a0 * b2 * b3 * c0 * c5 * d4 + 8 * a0 * b2 * b3 * c4 * c5 * d0 -
          8 * a0 * b2 * b5 * c0 * c3 * d4 - 8 * a0 * b2 * b5 * c0 * c4 * d3 -
          8 * a0 * b2 * b5 * c3 * c4 * d0 + 8 * a0 * b3 * b4 * c0 * c2 * d5 +
          8 * a0 * b3 * b4 * c0 * c5 * d2 + 8 * a0 * b3 * b4 * c2 * c5 * d0 +
          8 * a0 * b4 * b5 * c0 * c1 * d4 - 8 * a0 * b4 * b5 * c0 * c2 * d3 -
          8 * a0 * b4 * b5 * c0 * c3 * d2 + 8 * a0 * b4 * b5 * c0 * c4 * d1 +
          8 * a0 * b4 * b5 * c1 * c4 * d0 - 8 * a0 * b4 * b5 * c2 * c3 * d0 -
          8 * a1 * a3 * b0 * c5 * d0 * d5 + 8 * a1 * a3 * b5 * c0 * d0 * d5 -
          8 * a1 * a4 * b0 * c0 * d4 * d5 - 8 * a1 * a4 * b0 * c4 * d0 * d5 -
          8 * a1 * a4 * b0 * c5 * d0 * d4 + 32 * a1 * a4 * b4 * c0 * d0 * d5 -
          16 * a1 * a4 * b5 * c0 * d0 * d4 + 16 * a1 * a5 * b0 * c4 * d0 * d4 +
          8 * a1 * a5 * b3 * c0 * d0 * d5 - 16 * a1 * a5 * b4 * c0 * d0 * d4 -
          8 * a1 * a5 * b5 * c0 * d0 * d3 - 8 * a1 * b0 * b3 * c0 * c5 * d5 -
          ...
          16 * a3 * b2 * b4 * c0 * c5 * d0 + 8 * a4 * a5 * b0 * c0 * d1 * d4 -
          8 * a4 * a5 * b0 * c0 * d2 * d3 + 8 * a4 * a5 * b0 * c1 * d0 * d4 -
          8 * a4 * a5 * b0 * c2 * d0 * d3 - 8 * a4 * a5 * b0 * c3 * d0 * d2 +
          8 * a4 * a5 * b0 * c4 * d0 * d1 - 16 * a4 * a5 * b1 * c0 * d0 * d4 +
          16 * a4 * a5 * b2 * c0 * d0 * d3 - 8 * a4 * b0 * b1 * c0 * c4 * d5 -
          ...
          32 * a1 * a2 * a4 * d2 * d3 * d4 - 32 * a1 * a2 * b1 * c3 * d4 * d5 -
          32 * a1 * a2 * b1 * c4 * d3 * d5 - 32 * a1 * a2 * b1 * c5 * d3 * d4 +
          16 * a1 * a2 * b2 * c3 * d3 * d5 + 64 * a1 * a2 * b2 * c4 * d3 * d4 +
          16 * a1 * a2 * b3 * c1 * d4 * d5 + 16 * a1 * a2 * b3 * c4 * d1 * d5 +
          16 * a1 * a2 * b3 * c5 * d1 * d4 + 16 * a1 * a2 * b4 * c1 * d3 * d5 -
          32 * a1 * a2 * b4 * c2 * d3 * d4 + 16 * a1 * a2 * b4 * c3 * d1 * d5 -
          32 * a1 * a2 * b4 * c3 * d2 * d4 - 32 * a1 * a2 * b4 * c4 * d2 * d3 +
          16 * a1 * a2 * b4 * c5 * d1 * d3 - 16 * a1 * a2 * b5 * c3 * d2 * d3 -
          16 * a1 * a3 * a5 * d1 * d2 * d4 - 16 * a1 * a3 * b1 * c5 * d1 * d5 +
          ...
          16 * a1 * a3 * b5 * c4 * d1 * d2 - 16 * a1 * a4 * a5 * d1 * d2 * d3 +
          16 * a1 * a4 * b2 * c1 * d3 * d5 - 32 * a1 * a4 * b2 * c2 * d3 * d4 +
          16 * a1 * a4 * b2 * c3 * d1 * d5 - 32 * a1 * a4 * b2 * c3 * d2 * d4 -
          32 * a1 * a4 * b2 * c4 * d2 * d3 + 16 * a1 * a4 * b2 * c5 * d1 * d3 +
          64 * a1 * a4 * b4 * c2 * d2 * d3 - 16 * a1 * a4 * b5 * c1 * d2 * d3 -
          16 * a1 * a4 * b5 * c2 * d1 * d3 - 16 * a1 * a4 * b5 * c3 * d1 * d2 -
          ...
          16 * a1 * a5 * b4 * c3 * d1 * d2 + 16 * a1 * a5 * b5 * c1 * d1 * d3 -
          32 * a1 * b1 * b2 * c3 * c4 * d5 - 32 * a1 * b1 * b2 * c3 * c5 * d4 -
          32 * a1 * b1 * b2 * c4 * c5 * d3 - 16 * a1 * b1 * b3 * c1 * c5 * d5 -
          16 * a1 * b1 * b5 * c1 * c3 * d5 - 16 * a1 * b1 * b5 * c1 * c5 * d3 +
          32 * a1 * b1 * b5 * c2 * c3 * d4 + 32 * a1 * b1 * b5 * c2 * c4 * d3 +
          32 * a1 * b1 * b5 * c3 * c4 * d2 - 16 * a1 * b1 * b5 * c3 * c5 * d1 +
          16 * a1 * b2 * b3 * c1 * c4 * d5 + 16 * a1 * b2 * b3 * c1 * c5 * d4 +
          16 * a1 * b2 * b3 * c4 * c5 * d1 + 16 * a1 * b2 * b4 * c1 * c3 * d5 +
          16 * a1 * b2 * b4 * c1 * c5 * d3 - 32 * a1 * b2 * b4 * c2 * c3 * d4 -
          32 * a1 * b2 * b4 * c2 * c4 * d3 - 32 * a1 * b2 * b4 * c3 * c4 * d2 +
          16 * a1 * b2 * b4 * c3 * c5 * d1 - 16 * a1 * b2 * b5 * c2 * c3 * d3 -
          16 * a1 * b3 * b5 * c1 * c2 * d4 - 16 * a1 * b3 * b5 * c1 * c4 * d2 +
          16 * a1 * b3 * b5 * c1 * c5 * d1 + 16 * a1 * b3 * b5 * c2 * c3 * d2 -
          16 * a1 * b3 * b5 * c2 * c4 * d1 - 16 * a1 * b4 * b5 * c1 * c2 * d3 -
          16 * a1 * b4 * b5 * c1 * c3 * d2 - 16 * a1 * b4 * b5 * c2 * c3 * d1 +
          32 * a2 * a3 * a4 * d1 * d2 * d4 + 16 * a2 * a3 * b1 * c1 * d4 * d5 +
          ...
          32 * a2 * a4 * b2 * c3 * d2 * d3 - 32 * a2 * a4 * b3 * c1 * d1 * d5 +
          32 * a2 * a4 * b3 * c1 * d2 * d4 + 32 * a2 * a4 * b3 * c2 * d1 * d4 -
          32 * a2 * a4 * b3 * c2 * d2 * d3 + 32 * a2 * a4 * b3 * c4 * d1 * d2 -
          ...
          16 * a3 * b1 * b2 * c1 * c4 * d5 + 16 * a3 * b1 * b2 * c1 * c5 * d4 +
          16 * a3 * b1 * b2 * c4 * c5 * d1 - 16 * a3 * b1 * b3 * c2 * c5 * d2 -
          16 * a3 * b1 * b5 * c1 * c2 * d4 - 16 * a3 * b1 * b5 * c1 * c4 * d2 +
          16 * a3 * b1 * b5 * c1 * c5 * d1 + 16 * a3 * b1 * b5 * c2 * c3 * d2 -
          16 * a3 * b1 * b5 * c2 * c4 * d1 + 16 * a3 * b2 * b3 * c1 * c2 * d5 +
          16 * a3 * b2 * b3 * c1 * c5 * d2 - 32 * a3 * b2 * b3 * c2 * c4 * d2 +
          16 * a3 * b2 * b3 * c2 * c5 * d1 + 32 * a3 * b2 * b4 * c1 * c2 * d4 +
          32 * a3 * b2 * b4 * c1 * c4 * d2 - 32 * a3 * b2 * b4 * c1 * c5 * d1 -
          32 * a3 * b2 * b4 * c2 * c3 * d2 + 32 * a3 * b2 * b4 * c2 * c4 * d1 -
          16 * a3 * b3 * b5 * c1 * c2 * d2 + 32 * a3 * b4 * b5 * c1 * c2 * d1 -
          16 * a4 * a5 * b1 * c1 * d2 * d3 - 16 * a4 * a5 * b1 * c2 * d1 * d3 -
          16 * a4 * a5 * b1 * c3 * d1 * d2 + 32 * a4 * a5 * b3 * c1 * d1 * d2 +
          ...
          32 * a4 * b2 * b3 * c2 * c4 * d1 - 64 * a4 * b3 * b4 * c1 * c2 * d2 +
          32 * a4 * b3 * b5 * c1 * c2 * d1 - 16 * a5 * b1 * b2 * c2 * c3 * d3 -
          ...
          16 * a5 * b1 * b5 * c1 * c3 * d1 + 32 * a5 * b3 * b4 * c1 * c2 * d1 +
          ...
          8 * a0 * a1 * a4 * d3 * d4 * d5 - 4 * a0 * a1 * b3 * c5 * d3 * d5 +
          8 * a0 * a1 * b4 * c3 * d4 * d5 + 8 * a0 * a1 * b4 * c4 * d3 * d5 +
          8 * a0 * a1 * b4 * c5 * d3 * d4 + 4 * a0 * a1 * b5 * c3 * d3 * d5 -
          16 * a0 * a1 * b5 * c4 * d3 * d4 - 8 * a0 * a2 * b4 * c3 * d3 * d5 +
          8 * a0 * a2 * b5 * c3 * d3 * d4 - 8 * a0 * a3 * a4 * d1 * d4 * d5 +
          ...
          12 * a0 * a5 * b5 * c3 * d1 * d3 - 4 * a0 * b1 * b3 * c3 * c5 * d5 +
          8 * a0 * b1 * b4 * c3 * c4 * d5 + 8 * a0 * b1 * b4 * c3 * c5 * d4 +
          8 * a0 * b1 * b4 * c4 * c5 * d3 - 16 * a0 * b1 * b5 * c3 * c4 * d4 +
          4 * a0 * b1 * b5 * c3 * c5 * d3 - 8 * a0 * b2 * b4 * c3 * c5 * d3 +
          8 * a0 * b2 * b5 * c3 * c4 * d3 - 8 * a0 * b3 * b4 * c1 * c4 * d5 -
          8 * a0 * b3 * b4 * c1 * c5 * d4 - 8 * a0 * b3 * b4 * c4 * c5 * d1 +
          4 * a0 * b3 * b5 * c1 * c3 * d5 + 16 * a0 * b3 * b5 * c1 * c4 * d4 +
          4 * a0 * b3 * b5 * c1 * c5 * d3 - 8 * a0 * b3 * b5 * c2 * c3 * d4 -
          8 * a0 * b3 * b5 * c2 * c4 * d3 - 8 * a0 * b3 * b5 * c3 * c4 * d2 +
          4 * a0 * b3 * b5 * c3 * c5 * d1 + 8 * a0 * b4 * b5 * c2 * c3 * d3 -
          4 * a1 * a3 * a5 * d0 * d3 * d5 - 4 * a1 * a3 * b0 * c5 * d3 * d5 +
          12 * a1 * a3 * b3 * c5 * d0 * d5 - 4 * a1 * a3 * b5 * c0 * d3 * d5 -
          4 * a1 * a3 * b5 * c3 * d0 * d5 - 4 * a1 * a3 * b5 * c5 * d0 * d3 +
          8 * a1 * a4 * a5 * d0 * d3 * d4 + 8 * a1 * a4 * b0 * c3 * d4 * d5 +
          8 * a1 * a4 * b0 * c4 * d3 * d5 + 8 * a1 * a4 * b0 * c5 * d3 * d4 -
          16 * a1 * a4 * b4 * c0 * d3 * d5 - 16 * a1 * a4 * b4 * c3 * d0 * d5 -
          16 * a1 * a4 * b4 * c5 * d0 * d3 + 8 * a1 * a4 * b5 * c0 * d3 * d4 +
          8 * a1 * a4 * b5 * c3 * d0 * d4 + 8 * a1 * a4 * b5 * c4 * d0 * d3 +
          4 * a1 * a5 * b0 * c3 * d3 * d5 - 16 * a1 * a5 * b0 * c4 * d3 * d4 -
          4 * a1 * a5 * b3 * c0 * d3 * d5 - 4 * a1 * a5 * b3 * c3 * d0 * d5 -
          4 * a1 * a5 * b3 * c5 * d0 * d3 + 8 * a1 * a5 * b4 * c0 * d3 * d4 +
          8 * a1 * a5 * b4 * c3 * d0 * d4 + 8 * a1 * a5 * b4 * c4 * d0 * d3 +
          4 * a1 * a5 * b5 * c3 * d0 * d3 - 4 * a1 * b0 * b3 * c3 * c5 * d5 +
          ...
          8 * a1 * b4 * b5 * c3 * c4 * d0 + 8 * a2 * a3 * a4 * d0 * d3 * d5 -
          ...
          8 * a2 * a5 * b4 * c3 * d0 * d3 - 8 * a2 * b0 * b4 * c3 * c5 * d3 +
          8 * a2 * b0 * b5 * c3 * c4 * d3 + 8 * a2 * b3 * b4 * c0 * c3 * d5 +
          8 * a2 * b3 * b4 * c0 * c5 * d3 + 8 * a2 * b3 * b4 * c3 * c5 * d0 -
          8 * a2 * b4 * b5 * c0 * c3 * d3 - 8 * a3 * a4 * a5 * d0 * d1 * d4 -
          8 * a3 * a4 * b0 * c1 * d4 * d5 - 8 * a3 * a4 * b0 * c4 * d1 * d5 -
          8 * a3 * a4 * b0 * c5 * d1 * d4 + 8 * a3 * a4 * b2 * c0 * d3 * d5 +
          8 * a3 * a4 * b2 * c3 * d0 * d5 + 8 * a3 * a4 * b2 * c5 * d0 * d3 -
          8 * a3 * a4 * b3 * c0 * d2 * d5 - 8 * a3 * a4 * b3 * c2 * d0 * d5 -
          8 * a3 * a4 * b3 * c5 * d0 * d2 + 16 * a3 * a4 * b4 * c0 * d1 * d5 +
          16 * a3 * a4 * b4 * c1 * d0 * d5 + 16 * a3 * a4 * b4 * c5 * d0 * d1 -
          8 * a3 * a4 * b5 * c0 * d1 * d4 - 8 * a3 * a4 * b5 * c1 * d0 * d4 -
          8 * a3 * a4 * b5 * c4 * d0 * d1 + 4 * a3 * a5 * b0 * c1 * d3 * d5 -
          8 * a3 * a5 * b0 * c2 * d3 * d4 + 4 * a3 * a5 * b0 * c3 * d1 * d5 -
          8 * a3 * a5 * b0 * c3 * d2 * d4 + 16 * a3 * a5 * b0 * c4 * d1 * d4 -
          8 * a3 * a5 * b0 * c4 * d2 * d3 + 4 * a3 * a5 * b0 * c5 * d1 * d3 -
          4 * a3 * a5 * b1 * c0 * d3 * d5 - 4 * a3 * a5 * b1 * c3 * d0 * d5 -
          4 * a3 * a5 * b1 * c5 * d0 * d3 - 4 * a3 * a5 * b3 * c0 * d1 * d5 +
          8 * a3 * a5 * b3 * c0 * d2 * d4 - 4 * a3 * a5 * b3 * c1 * d0 * d5 +
          8 * a3 * a5 * b3 * c2 * d0 * d4 + 8 * a3 * a5 * b3 * c4 * d0 * d2 -
          4 * a3 * a5 * b3 * c5 * d0 * d1 - 8 * a3 * a5 * b4 * c0 * d1 * d4 -
          8 * a3 * a5 * b4 * c1 * d0 * d4 - 8 * a3 * a5 * b4 * c4 * d0 * d1 +
          4 * a3 * a5 * b5 * c0 * d1 * d3 + 4 * a3 * a5 * b5 * c1 * d0 * d3 +
          4 * a3 * a5 * b5 * c3 * d0 * d1 - 4 * a3 * b0 * b1 * c3 * c5 * d5 -
      ...
      a1 * pow(b5, 2) * pow(c0, 3) - 8 * a0 * pow(b5, 2) * pow(c1, 3) +
          8 * a4 * pow(b0, 2) * pow(c2, 3) + 32 * a4 * pow(b1, 2) * pow(c2, 3) +
          16 * a5 * pow(b2, 2) * pow(c1, 3) - 4 * a3 * pow(b5, 2) * pow(c1, 3) +
          8 * a4 * pow(b3, 2) * pow(c2, 3) - pow(a0, 3) * c1 * pow(d5, 2) +
          8 * pow(a1, 3) * c0 * pow(d5, 2) - 8 * pow(a2, 3) * c4 * pow(d0, 2) -
          32 * pow(a2, 3) * c4 * pow(d1, 2) -
          16 * pow(a1, 3) * c5 * pow(d2, 2) + 4 * pow(a1, 3) * c3 * pow(d5, 2) -
          8 * pow(a2, 3) * c4 * pow(d3, 2) + 16 * a0 * b0 * b4 * pow(c2, 3) +
          64 * a1 * b1 * b4 * pow(c2, 3) - 16 * a0 * b3 * b4 * pow(c2, 3) -
          16 * a3 * b0 * b4 * pow(c2, 3) - 16 * a4 * b0 * b3 * pow(c2, 3) +
          32 * a2 * b2 * b5 * pow(c1, 3) - 4 * a2 * b4 * b5 * pow(c0, 3) -
          4 * a4 * b2 * b5 * pow(c0, 3) - 16 * a5 * b0 * b5 * pow(c1, 3) +
          2 * a5 * b1 * b5 * pow(c0, 3) - 4 * a5 * b2 * b4 * pow(c0, 3) +
          16 * a3 * b3 * b4 * pow(c2, 3) - 8 * a5 * b3 * b5 * pow(c1, 3) -
          16 * pow(a2, 3) * c0 * d0 * d4 - 64 * pow(a2, 3) * c1 * d1 * d4 +
          16 * pow(a2, 3) * c0 * d3 * d4 + 16 * pow(a2, 3) * c3 * d0 * d4 +
          16 * pow(a2, 3) * c4 * d0 * d3 - 32 * pow(a1, 3) * c2 * d2 * d5 +
          4 * pow(a0, 3) * c2 * d4 * d5 + 4 * pow(a0, 3) * c4 * d2 * d5 -
          2 * pow(a0, 3) * c5 * d1 * d5 + 4 * pow(a0, 3) * c5 * d2 * d4 +
          16 * pow(a1, 3) * c5 * d0 * d5 - 16 * pow(a2, 3) * c3 * d3 * d4 +
          8 * pow(a1, 3) * c5 * d3 * d5 - a0 * pow(a5, 2) * c1 * pow(d0, 2) -
          ...
          8 * pow(a1, 2) * b5 * c3 * c5 * d1 + 8 * a0 * a1 * a2 * c0 * d2 * d5 +
          8 * a0 * a1 * a2 * c2 * d0 * d5 + 8 * a0 * a1 * a2 * c5 * d0 * d2 -
          16 * a0 * a1 * b0 * c2 * c5 * d2 + 8 * a0 * a1 * b2 * c0 * c2 * d5 +
          8 * a0 * a1 * b2 * c0 * c5 * d2 + 8 * a0 * a1 * b2 * c2 * c5 * d0 -
          32 * a0 * a2 * a4 * c2 * d0 * d2 - 8 * a0 * a2 * a5 * c0 * d1 * d2 -
          8 * a0 * a2 * a5 * c1 * d0 * d2 - 8 * a0 * a2 * a5 * c2 * d0 * d1 -
          ...
          8 * a1 * a2 * b0 * c2 * c5 * d0 - 16 * a1 * a2 * b2 * c0 * c5 * d0 +
          8 * a1 * b0 * b2 * c0 * c2 * c5 - 32 * a2 * a4 * b0 * c0 * c2 * d2 +
          32 * a2 * a4 * b2 * c0 * c2 * d0 - 8 * a2 * a5 * b0 * c0 * c1 * d2 -
          8 * a2 * a5 * b0 * c0 * c2 * d1 - 8 * a2 * a5 * b0 * c1 * c2 * d0 +
          16 * a2 * a5 * b2 * c0 * c1 * d0 + 8 * a2 * b0 * b1 * c0 * c2 * c5 +
          32 * a2 * b0 * b2 * c0 * c2 * c4 - 8 * a2 * b0 * b5 * c0 * c1 * c2 -
          8 * a5 * b0 * b2 * c0 * c1 * c2 - 4 * a0 * a1 * a5 * c0 * d0 * d5 +
          4 * a0 * a1 * b0 * c0 * c5 * d5 - 4 * a0 * a1 * b5 * c0 * c5 * d0 +
          8 * a0 * a2 * a4 * c0 * d0 * d5 + 8 * a0 * a2 * a5 * c0 * d0 * d4 -
          8 * a0 * a2 * b0 * c0 * c4 * d5 - 8 * a0 * a2 * b0 * c0 * c5 * d4 -
          8 * a0 * a2 * b0 * c4 * c5 * d0 + 8 * a0 * a2 * b4 * c0 * c5 * d0 +
          8 * a0 * a2 * b5 * c0 * c4 * d0 + 8 * a0 * a4 * a5 * c0 * d0 * d2 -
          8 * a0 * a4 * b0 * c0 * c2 * d5 - 8 * a0 * a4 * b0 * c0 * c5 * d2 -
          8 * a0 * a4 * b0 * c2 * c5 * d0 + 8 * a0 * a4 * b2 * c0 * c5 * d0 +
          ...
          8 * a0 * a5 * b2 * c0 * c4 * d0 + 8 * a0 * a5 * b4 * c0 * c2 * d0 -
          4 * a0 * a5 * b5 * c0 * c1 * d0 - 8 * a0 * b0 * b2 * c0 * c4 * c5 -
          8 * a0 * b0 * b4 * c0 * c2 * c5 + 4 * a0 * b0 * b5 * c0 * c1 * c5 -
          8 * a0 * b0 * b5 * c0 * c2 * c4 - 4 * a1 * a5 * b0 * c0 * c5 * d0 +
          8 * a2 * a4 * b0 * c0 * c5 * d0 + 8 * a2 * a5 * b0 * c0 * c4 * d0 +
          8 * a4 * a5 * b0 * c0 * c2 * d0 - 128 * a1 * a2 * a4 * c2 * d1 * d2 -
          64 * a1 * a2 * a5 * c1 * d1 * d2 + 64 * a1 * a2 * b1 * c1 * c2 * d5 +
          64 * a1 * a2 * b1 * c1 * c5 * d2 - 128 * a1 * a2 * b1 * c2 * c4 * d2 +
          64 * a1 * a2 * b1 * c2 * c5 * d1 + 128 * a1 * a2 * b2 * c1 * c2 * d4 +
          128 * a1 * a2 * b2 * c1 * c4 * d2 - 64 * a1 * a2 * b2 * c1 * c5 * d1 +
          128 * a1 * a2 * b2 * c2 * c4 * d1 -
          128 * a1 * a2 * b4 * c1 * c2 * d2 - 64 * a1 * a2 * b5 * c1 * c2 * d1 -
          128 * a1 * a4 * b2 * c1 * c2 * d2 + 64 * a1 * a5 * b1 * c1 * c2 * d2 -
          64 * a1 * a5 * b2 * c1 * c2 * d1 + 64 * a1 * b1 * b2 * c1 * c2 * c5 -
          128 * a2 * a4 * b1 * c1 * c2 * d2 +
          128 * a2 * a4 * b2 * c1 * c2 * d1 - 64 * a2 * a5 * b1 * c1 * c2 * d1 +
          128 * a2 * b1 * b2 * c1 * c2 * c4 - 16 * a0 * a1 * a2 * c1 * d4 * d5 -
          ...
          8 * a0 * a2 * a3 * c2 * d1 * d5 + 32 * a0 * a2 * a3 * c2 * d2 * d4 -
          8 * a0 * a2 * a3 * c5 * d1 * d2 - 32 * a0 * a2 * a4 * c1 * d2 * d4 -
          32 * a0 * a2 * a4 * c2 * d1 * d4 + 32 * a0 * a2 * a4 * c2 * d2 * d3 -
          32 * a0 * a2 * a4 * c4 * d1 * d2 + 32 * a0 * a2 * a5 * c1 * d1 * d4 -
          16 * a0 * a2 * b1 * c1 * c4 * d5 - 16 * a0 * a2 * b1 * c1 * c5 * d4 -
          8 * a0 * a2 * b1 * c2 * c3 * d5 - 8 * a0 * a2 * b1 * c2 * c5 * d3 -
          8 * a0 * a2 * b1 * c3 * c5 * d2 - 16 * a0 * a2 * b1 * c4 * c5 * d1 +
          16 * a0 * a2 * b2 * c1 * c3 * d5 + 64 * a0 * a2 * b2 * c1 * c4 * d4 +
          16 * a0 * a2 * b2 * c1 * c5 * d3 - 32 * a0 * a2 * b2 * c2 * c3 * d4 -
          32 * a0 * a2 * b2 * c2 * c4 * d3 - 32 * a0 * a2 * b2 * c3 * c4 * d2 +
          16 * a0 * a2 * b2 * c3 * c5 * d1 - 8 * a0 * a2 * b3 * c1 * c2 * d5 -
          8 * a0 * a2 * b3 * c1 * c5 * d2 + 32 * a0 * a2 * b3 * c2 * c4 * d2 -
          8 * a0 * a2 * b3 * c2 * c5 * d1 - 32 * a0 * a2 * b4 * c1 * c2 * d4 -
          32 * a0 * a2 * b4 * c1 * c4 * d2 + 32 * a0 * a2 * b4 * c2 * c3 * d2 -
          32 * a0 * a2 * b4 * c2 * c4 * d1 + 32 * a0 * a2 * b5 * c1 * c4 * d1 +
          16 * a0 * a3 * b1 * c2 * c5 * d2 - 8 * a0 * a3 * b2 * c1 * c2 * d5 -
          8 * a0 * a3 * b2 * c1 * c5 * d2 + 32 * a0 * a3 * b2 * c2 * c4 * d2 -
          8 * a0 * a3 * b2 * c2 * c5 * d1 - 32 * a0 * a4 * b2 * c1 * c2 * d4 -
          32 * a0 * a4 * b2 * c1 * c4 * d2 + 32 * a0 * a4 * b2 * c2 * c3 * d2 -
          32 * a0 * a4 * b2 * c2 * c4 * d1 + 64 * a0 * a4 * b4 * c1 * c2 * d2 -
          16 * a0 * a5 * b1 * c1 * c2 * d4 - 16 * a0 * a5 * b1 * c1 * c4 * d2 +
          32 * a0 * a5 * b1 * c1 * c5 * d1 - 16 * a0 * a5 * b1 * c2 * c4 * d1 +
          32 * a0 * a5 * b2 * c1 * c4 * d1 - 16 * a0 * b1 * b2 * c1 * c4 * c5 -
          ...
          8 * a1 * a2 * a5 * c0 * d2 * d3 + 8 * a1 * a2 * a5 * c2 * d0 * d3 +
          8 * a1 * a2 * a5 * c3 * d0 * d2 - 16 * a1 * a2 * b0 * c1 * c4 * d5 -
          16 * a1 * a2 * b0 * c1 * c5 * d4 - 8 * a1 * a2 * b0 * c2 * c3 * d5 -
          8 * a1 * a2 * b0 * c2 * c5 * d3 - 8 * a1 * a2 * b0 * c3 * c5 * d2 -
          16 * a1 * a2 * b0 * c4 * c5 * d1 - 64 * a1 * a2 * b2 * c0 * c4 * d4 +
          ...
          8 * a1 * a2 * b5 * c2 * c3 * d0 - 16 * a1 * a3 * a5 * c2 * d0 * d2 +
          16 * a1 * a3 * b0 * c2 * c5 * d2 - 16 * a1 * a3 * b5 * c0 * c2 * d2 +
          16 * a1 * a4 * a5 * c0 * d1 * d2 + 16 * a1 * a4 * a5 * c1 * d0 * d2 +
          16 * a1 * a4 * a5 * c2 * d0 * d1 - 32 * a1 * a4 * b1 * c0 * c2 * d5 -
          32 * a1 * a4 * b1 * c0 * c5 * d2 - 32 * a1 * a4 * b1 * c2 * c5 * d0 +
          16 * a1 * a4 * b2 * c0 * c1 * d5 + 32 * a1 * a4 * b2 * c0 * c2 * d4 +
          32 * a1 * a4 * b2 * c0 * c4 * d2 + 16 * a1 * a4 * b2 * c0 * c5 * d1 +
          16 * a1 * a4 * b2 * c1 * c5 * d0 + 32 * a1 * a4 * b2 * c2 * c4 * d0 -
          64 * a1 * a4 * b4 * c0 * c2 * d2 + 16 * a1 * a4 * b5 * c0 * c1 * d2 +
          16 * a1 * a4 * b5 * c0 * c2 * d1 + 16 * a1 * a4 * b5 * c1 * c2 * d0 -
          16 * a1 * a5 * b0 * c1 * c2 * d4 - 16 * a1 * a5 * b0 * c1 * c4 * d2 +
          32 * a1 * a5 * b0 * c1 * c5 * d1 - 16 * a1 * a5 * b0 * c2 * c4 * d1 -
          32 * a1 * a5 * b1 * c0 * c1 * d5 - 32 * a1 * a5 * b1 * c0 * c5 * d1 -
          32 * a1 * a5 * b1 * c1 * c5 * d0 + 8 * a1 * a5 * b2 * c0 * c2 * d3 +
          8 * a1 * a5 * b2 * c0 * c3 * d2 + 8 * a1 * a5 * b2 * c2 * c3 * d0 -
          16 * a1 * a5 * b3 * c0 * c2 * d2 + 16 * a1 * a5 * b4 * c0 * c1 * d2 +
          16 * a1 * a5 * b4 * c0 * c2 * d1 + 16 * a1 * a5 * b4 * c1 * c2 * d0 +
          32 * a1 * a5 * b5 * c0 * c1 * d1 + 32 * a1 * b0 * b1 * c2 * c4 * c5 -
          16 * a1 * b0 * b2 * c1 * c4 * c5 - 8 * a1 * b0 * b2 * c2 * c3 * c5 -
          16 * a1 * b0 * b5 * c1 * c2 * c4 - 32 * a1 * b1 * b4 * c0 * c2 * c5 -
          32 * a1 * b1 * b5 * c0 * c1 * c5 + 16 * a1 * b2 * b4 * c0 * c1 * c5 +
          32 * a1 * b2 * b4 * c0 * c2 * c4 + 8 * a1 * b2 * b5 * c0 * c2 * c3 +
          16 * a1 * b4 * b5 * c0 * c1 * c2 + 32 * a2 * a3 * a4 * c2 * d0 * d2 +
          8 * a2 * a3 * a5 * c0 * d1 * d2 + 8 * a2 * a3 * a5 * c1 * d0 * d2 +
          8 * a2 * a3 * a5 * c2 * d0 * d1 - 8 * a2 * a3 * b0 * c1 * c2 * d5 -
          8 * a2 * a3 * b0 * c1 * c5 * d2 + 32 * a2 * a3 * b0 * c2 * c4 * d2 -
          8 * a2 * a3 * b0 * c2 * c5 * d1 - 32 * a2 * a3 * b2 * c0 * c2 * d4 -
          32 * a2 * a3 * b2 * c0 * c4 * d2 - 32 * a2 * a3 * b2 * c2 * c4 * d0 +
          32 * a2 * a3 * b4 * c0 * c2 * d2 + 8 * a2 * a3 * b5 * c0 * c1 * d2 +
          8 * a2 * a3 * b5 * c0 * c2 * d1 + 8 * a2 * a3 * b5 * c1 * c2 * d0 -
          32 * a2 * a4 * a5 * c1 * d0 * d1 - 32 * a2 * a4 * b0 * c1 * c2 * d4 -
          ...
          32 * a2 * a5 * b4 * c0 * c1 * d1 - 16 * a2 * b0 * b1 * c1 * c4 * c5 -
          8 * a2 * b0 * b1 * c2 * c3 * c5 + 16 * a2 * b0 * b2 * c1 * c3 * c5 -
          32 * a2 * b0 * b2 * c2 * c3 * c4 - 8 * a2 * b0 * b3 * c1 * c2 * c5 -
          32 * a2 * b0 * b4 * c1 * c2 * c4 + 16 * a2 * b1 * b4 * c0 * c1 * c5 +
          32 * a2 * b1 * b4 * c0 * c2 * c4 + 8 * a2 * b1 * b5 * c0 * c2 * c3 -
          32 * a2 * b2 * b3 * c0 * c2 * c4 - 32 * a2 * b2 * b4 * c0 * c2 * c3 -
          16 * a2 * b2 * b5 * c0 * c1 * c3 + 8 * a2 * b3 * b5 * c0 * c1 * c2 +
          32 * a3 * a4 * b2 * c0 * c2 * d2 - 16 * a3 * a5 * b1 * c0 * c2 * d2 +
          8 * a3 * a5 * b2 * c0 * c1 * d2 + 8 * a3 * a5 * b2 * c0 * c2 * d1 +
          8 * a3 * a5 * b2 * c1 * c2 * d0 - 8 * a3 * b0 * b2 * c1 * c2 * c5 +
          8 * a3 * b2 * b5 * c0 * c1 * c2 + 16 * a4 * a5 * b1 * c0 * c1 * d2 +
          16 * a4 * a5 * b1 * c0 * c2 * d1 + 16 * a4 * a5 * b1 * c1 * c2 * d0 -
          32 * a4 * a5 * b2 * c0 * c1 * d1 - 32 * a4 * b0 * b2 * c1 * c2 * c4 +
          ...
          8 * a5 * b2 * b3 * c0 * c1 * c2 - 8 * a0 * a1 * a3 * c5 * d0 * d5 -
          ...
          8 * a0 * a3 * a4 * c5 * d0 * d2 + 8 * a0 * a3 * b0 * c1 * c5 * d5 -
          16 * a0 * a3 * b0 * c2 * c4 * d5 - 16 * a0 * a3 * b0 * c2 * c5 * d4 -
          16 * a0 * a3 * b0 * c4 * c5 * d2 - 8 * a0 * a3 * b1 * c0 * c5 * d5 +
          8 * a0 * a3 * b2 * c0 * c4 * d5 + 8 * a0 * a3 * b2 * c0 * c5 * d4 +
          8 * a0 * a3 * b2 * c4 * c5 * d0 + 8 * a0 * a3 * b4 * c0 * c2 * d5 +
          8 * a0 * a3 * b4 * c0 * c5 * d2 + 8 * a0 * a3 * b4 * c2 * c5 * d0 +
          8 * a0 * a4 * a5 * c0 * d1 * d4 - 8 * a0 * a4 * a5 * c0 * d2 * d3 +
          8 * a0 * a4 * a5 * c1 * d0 * d4 - 8 * a0 * a4 * a5 * c2 * d0 * d3 -
          8 * a0 * a4 * a5 * c3 * d0 * d2 + 8 * a0 * a4 * a5 * c4 * d0 * d1 +
          16 * a0 * a4 * b0 * c1 * c4 * d5 + 16 * a0 * a4 * b0 * c1 * c5 * d4 +
          16 * a0 * a4 * b0 * c4 * c5 * d1 - 8 * a0 * a4 * b1 * c0 * c4 * d5 -
          8 * a0 * a4 * b1 * c0 * c5 * d4 - 8 * a0 * a4 * b1 * c4 * c5 * d0 +
          8 * a0 * a4 * b3 * c0 * c2 * d5 + 8 * a0 * a4 * b3 * c0 * c5 * d2 +
          8 * a0 * a4 * b3 * c2 * c5 * d0 - 16 * a0 * a4 * b4 * c0 * c1 * d5 -
          16 * a0 * a4 * b4 * c0 * c5 * d1 - 16 * a0 * a4 * b4 * c1 * c5 * d0 +
          8 * a0 * a4 * b5 * c0 * c1 * d4 - 8 * a0 * a4 * b5 * c0 * c2 * d3 -
          8 * a0 * a4 * b5 * c0 * c3 * d2 + 8 * a0 * a4 * b5 * c0 * c4 * d1 +
          8 * a0 * a4 * b5 * c1 * c4 * d0 - 8 * a0 * a4 * b5 * c2 * c3 * d0 -
          8 * a0 * a5 * b0 * c1 * c3 * d5 - 32 * a0 * a5 * b0 * c1 * c4 * d4 -
          8 * a0 * a5 * b0 * c1 * c5 * d3 + 16 * a0 * a5 * b0 * c2 * c3 * d4 +
          16 * a0 * a5 * b0 * c2 * c4 * d3 + 16 * a0 * a5 * b0 * c3 * c4 * d2 -
          8 * a0 * a5 * b0 * c3 * c5 * d1 + 16 * a0 * a5 * b1 * c0 * c4 * d4 -
          8 * a0 * a5 * b2 * c0 * c3 * d4 - 8 * a0 * a5 * b2 * c0 * c4 * d3 -
          8 * a0 * a5 * b2 * c3 * c4 * d0 + 8 * a0 * a5 * b4 * c0 * c1 * d4 -
          8 * a0 * a5 * b4 * c0 * c2 * d3 - 8 * a0 * a5 * b4 * c0 * c3 * d2 +
          8 * a0 * a5 * b4 * c0 * c4 * d1 + 8 * a0 * a5 * b4 * c1 * c4 * d0 -
          8 * a0 * a5 * b4 * c2 * c3 * d0 + 8 * a0 * a5 * b5 * c0 * c1 * d3 +
          8 * a0 * a5 * b5 * c0 * c3 * d1 + 8 * a0 * a5 * b5 * c1 * c3 * d0 -
          16 * a0 * b0 * b3 * c2 * c4 * c5 + 16 * a0 * b0 * b4 * c1 * c4 * c5 -
          8 * a0 * b0 * b5 * c1 * c3 * c5 + 16 * a0 * b0 * b5 * c2 * c3 * c4 -
          8 * a0 * b1 * b4 * c0 * c4 * c5 + 8 * a0 * b2 * b3 * c0 * c4 * c5 -
          8 * a0 * b2 * b5 * c0 * c3 * c4 + 8 * a0 * b3 * b4 * c0 * c2 * c5 +
          8 * a0 * b4 * b5 * c0 * c1 * c4 - 8 * a0 * b4 * b5 * c0 * c2 * c3 +
          8 * a1 * a3 * a5 * c0 * d0 * d5 - 8 * a1 * a3 * b0 * c0 * c5 * d5 +
          8 * a1 * a3 * b5 * c0 * c5 * d0 - 16 * a1 * a4 * a5 * c0 * d0 * d4 -
          8 * a1 * a4 * b0 * c0 * c4 * d5 - 8 * a1 * a4 * b0 * c0 * c5 * d4 -
          8 * a1 * a4 * b0 * c4 * c5 * d0 + 32 * a1 * a4 * b4 * c0 * c5 * d0 -
          16 * a1 * a4 * b5 * c0 * c4 * d0 + 16 * a1 * a5 * b0 * c0 * c4 * d4 +
          8 * a1 * a5 * b3 * c0 * c5 * d0 - 16 * a1 * a5 * b4 * c0 * c4 * d0 -
          8 * a1 * a5 * b5 * c0 * c3 * d0 - 8 * a1 * b0 * b4 * c0 * c4 * c5 -
          16 * a2 * a3 * a4 * c0 * d0 * d5 + 8 * a2 * a3 * b0 * c0 * c4 * d5 +
          8 * a2 * a3 * b0 * c0 * c5 * d4 + 8 * a2 * a3 * b0 * c4 * c5 * d0 -
          16 * a2 * a3 * b4 * c0 * c5 * d0 + 16 * a2 * a4 * a5 * c0 * d0 * d3 -
          ...
          8 * a5 * b0 * b5 * c0 * c1 * c3 + 16 * a1 * a2 * a3 * c1 * d4 * d5 +
          ...
          16 * a1 * a2 * a5 * c3 * d2 * d3 - 32 * a1 * a2 * b1 * c3 * c4 * d5 -
          32 * a1 * a2 * b1 * c3 * c5 * d4 - 32 * a1 * a2 * b1 * c4 * c5 * d3 +
          64 * a1 * a2 * b2 * c3 * c4 * d4 + 16 * a1 * a2 * b2 * c3 * c5 * d3 +
          16 * a1 * a2 * b3 * c1 * c4 * d5 + 16 * a1 * a2 * b3 * c1 * c5 * d4 +
          16 * a1 * a2 * b3 * c4 * c5 * d1 + 16 * a1 * a2 * b4 * c1 * c3 * d5 +
          16 * a1 * a2 * b4 * c1 * c5 * d3 - 32 * a1 * a2 * b4 * c2 * c3 * d4 -
          32 * a1 * a2 * b4 * c2 * c4 * d3 - 32 * a1 * a2 * b4 * c3 * c4 * d2 +
          16 * a1 * a2 * b4 * c3 * c5 * d1 - 16 * a1 * a2 * b5 * c2 * c3 * d3 +
          16 * a1 * a3 * a5 * c1 * d1 * d5 - 16 * a1 * a3 * a5 * c1 * d2 * d4 -
          16 * a1 * a3 * a5 * c2 * d1 * d4 + 16 * a1 * a3 * a5 * c2 * d2 * d3 -
          16 * a1 * a3 * a5 * c4 * d1 * d2 - 16 * a1 * a3 * b1 * c1 * c5 * d5 +
          ...
          16 * a1 * a3 * b5 * c2 * c4 * d1 - 16 * a1 * a4 * a5 * c1 * d2 * d3 -
          16 * a1 * a4 * a5 * c2 * d1 * d3 - 16 * a1 * a4 * a5 * c3 * d1 * d2 +
          16 * a1 * a4 * b2 * c1 * c3 * d5 + 16 * a1 * a4 * b2 * c1 * c5 * d3 -
          32 * a1 * a4 * b2 * c2 * c3 * d4 - 32 * a1 * a4 * b2 * c2 * c4 * d3 -
          32 * a1 * a4 * b2 * c3 * c4 * d2 + 16 * a1 * a4 * b2 * c3 * c5 * d1 +
          64 * a1 * a4 * b4 * c2 * c3 * d2 - 16 * a1 * a4 * b5 * c1 * c2 * d3 -
          16 * a1 * a4 * b5 * c1 * c3 * d2 - 16 * a1 * a4 * b5 * c2 * c3 * d1 -
          ...
          16 * a1 * a5 * b4 * c2 * c3 * d1 + 16 * a1 * a5 * b5 * c1 * c3 * d1 -
          ...
          32 * a2 * a3 * a4 * c1 * d1 * d5 + 32 * a2 * a3 * a4 * c1 * d2 * d4 +
          32 * a2 * a3 * a4 * c2 * d1 * d4 - 32 * a2 * a3 * a4 * c2 * d2 * d3 +
          32 * a2 * a3 * a4 * c4 * d1 * d2 + 16 * a2 * a3 * b1 * c1 * c4 * d5 +
          ...
          16 * a2 * a4 * b1 * c1 * c3 * d5 + 16 * a2 * a4 * b1 * c1 * c5 * d3 -
          32 * a2 * a4 * b1 * c2 * c3 * d4 - 32 * a2 * a4 * b1 * c2 * c4 * d3 -
          32 * a2 * a4 * b1 * c3 * c4 * d2 + 16 * a2 * a4 * b1 * c3 * c5 * d1 +
          32 * a2 * a4 * b2 * c2 * c3 * d3 + 32 * a2 * a4 * b3 * c1 * c2 * d4 +
          32 * a2 * a4 * b3 * c1 * c4 * d2 - 32 * a2 * a4 * b3 * c1 * c5 * d1 -
          32 * a2 * a4 * b3 * c2 * c3 * d2 + 32 * a2 * a4 * b3 * c2 * c4 * d1 -
          ...
          32 * a3 * a4 * a5 * c1 * d1 * d2 + 32 * a3 * a4 * b2 * c1 * c2 * d4 +
          32 * a3 * a4 * b2 * c1 * c4 * d2 - 32 * a3 * a4 * b2 * c1 * c5 * d1 -
          32 * a3 * a4 * b2 * c2 * c3 * d2 + 32 * a3 * a4 * b2 * c2 * c4 * d1 -
          64 * a3 * a4 * b4 * c1 * c2 * d2 + 32 * a3 * a4 * b5 * c1 * c2 * d1 -
          16 * a3 * a5 * b1 * c1 * c2 * d4 - 16 * a3 * a5 * b1 * c1 * c4 * d2 +
          16 * a3 * a5 * b1 * c1 * c5 * d1 + 16 * a3 * a5 * b1 * c2 * c3 * d2 -
          16 * a3 * a5 * b1 * c2 * c4 * d1 - 16 * a3 * a5 * b3 * c1 * c2 * d2 +
          32 * a3 * a5 * b4 * c1 * c2 * d1 + 16 * a3 * b1 * b2 * c1 * c4 * c5 -
          16 * a3 * b1 * b5 * c1 * c2 * c4 + 16 * a3 * b2 * b3 * c1 * c2 * c5 +
          32 * a3 * b2 * b4 * c1 * c2 * c4 - 16 * a4 * a5 * b1 * c1 * c2 * d3 -
          16 * a4 * a5 * b1 * c1 * c3 * d2 - 16 * a4 * a5 * b1 * c2 * c3 * d1 +
          32 * a4 * a5 * b3 * c1 * c2 * d1 + 16 * a4 * b1 * b2 * c1 * c3 * c5 -
          32 * a4 * b1 * b2 * c2 * c3 * c4 - 16 * a4 * b1 * b5 * c1 * c2 * c3 +
          32 * a4 * b2 * b3 * c1 * c2 * c4 - 16 * a5 * b1 * b3 * c1 * c2 * c4 -
          16 * a5 * b1 * b4 * c1 * c2 * c3 - 4 * a0 * a1 * a3 * c5 * d3 * d5 +
          8 * a0 * a1 * a4 * c3 * d4 * d5 + 8 * a0 * a1 * a4 * c4 * d3 * d5 +
          8 * a0 * a1 * a4 * c5 * d3 * d4 + 4 * a0 * a1 * a5 * c3 * d3 * d5 -
          16 * a0 * a1 * a5 * c4 * d3 * d4 - 4 * a0 * a1 * b3 * c3 * c5 * d5 +
          8 * a0 * a1 * b4 * c3 * c4 * d5 + 8 * a0 * a1 * b4 * c3 * c5 * d4 +
          8 * a0 * a1 * b4 * c4 * c5 * d3 - 16 * a0 * a1 * b5 * c3 * c4 * d4 +
          4 * a0 * a1 * b5 * c3 * c5 * d3 - 8 * a0 * a2 * a4 * c3 * d3 * d5 +
          8 * a0 * a2 * a5 * c3 * d3 * d4 - 8 * a0 * a2 * b4 * c3 * c5 * d3 +
          8 * a0 * a2 * b5 * c3 * c4 * d3 - 8 * a0 * a3 * a4 * c1 * d4 * d5 -
          8 * a0 * a3 * a4 * c4 * d1 * d5 - 8 * a0 * a3 * a4 * c5 * d1 * d4 +
          4 * a0 * a3 * a5 * c1 * d3 * d5 - 8 * a0 * a3 * a5 * c2 * d3 * d4 +
          4 * a0 * a3 * a5 * c3 * d1 * d5 - 8 * a0 * a3 * a5 * c3 * d2 * d4 +
          16 * a0 * a3 * a5 * c4 * d1 * d4 - 8 * a0 * a3 * a5 * c4 * d2 * d3 +
          4 * a0 * a3 * a5 * c5 * d1 * d3 - 4 * a0 * a3 * b1 * c3 * c5 * d5 -
          4 * a0 * a3 * b3 * c1 * c5 * d5 + 8 * a0 * a3 * b3 * c2 * c4 * d5 +
          8 * a0 * a3 * b3 * c2 * c5 * d4 + 8 * a0 * a3 * b3 * c4 * c5 * d2 -
          8 * a0 * a3 * b4 * c1 * c4 * d5 - 8 * a0 * a3 * b4 * c1 * c5 * d4 -
          8 * a0 * a3 * b4 * c4 * c5 * d1 + 4 * a0 * a3 * b5 * c1 * c3 * d5 +
          16 * a0 * a3 * b5 * c1 * c4 * d4 + 4 * a0 * a3 * b5 * c1 * c5 * d3 -
          8 * a0 * a3 * b5 * c2 * c3 * d4 - 8 * a0 * a3 * b5 * c2 * c4 * d3 -
          8 * a0 * a3 * b5 * c3 * c4 * d2 + 4 * a0 * a3 * b5 * c3 * c5 * d1 +
          8 * a0 * a4 * a5 * c3 * d2 * d3 + 8 * a0 * a4 * b1 * c3 * c4 * d5 +
          ...
          12 * a0 * a5 * b5 * c1 * c3 * d3 + 8 * a0 * b1 * b4 * c3 * c4 * c5 -
          8 * a0 * b3 * b4 * c1 * c4 * c5 + 4 * a0 * b3 * b5 * c1 * c3 * c5 -
          8 * a0 * b3 * b5 * c2 * c3 * c4 - 4 * a1 * a3 * a5 * c0 * d3 * d5 -
          4 * a1 * a3 * a5 * c3 * d0 * d5 - 4 * a1 * a3 * a5 * c5 * d0 * d3 -
          4 * a1 * a3 * b0 * c3 * c5 * d5 + 12 * a1 * a3 * b3 * c0 * c5 * d5 -
          4 * a1 * a3 * b5 * c0 * c3 * d5 - 4 * a1 * a3 * b5 * c0 * c5 * d3 -
          4 * a1 * a3 * b5 * c3 * c5 * d0 + 8 * a1 * a4 * a5 * c0 * d3 * d4 +
          8 * a1 * a4 * a5 * c3 * d0 * d4 + 8 * a1 * a4 * a5 * c4 * d0 * d3 +
          ...
          8 * a1 * b4 * b5 * c0 * c3 * c4 + 8 * a2 * a3 * a4 * c0 * d3 * d5 +
          ...
          8 * a2 * a4 * a5 * c3 * d0 * d3 - 8 * a2 * a4 * b0 * c3 * c5 * d3 +
          8 * a2 * a4 * b3 * c0 * c3 * d5 + 8 * a2 * a4 * b3 * c0 * c5 * d3 +
          8 * a2 * a4 * b3 * c3 * c5 * d0 - 8 * a2 * a4 * b5 * c0 * c3 * d3 +
          8 * a2 * a5 * b0 * c3 * c4 * d3 - 8 * a2 * a5 * b4 * c0 * c3 * d3 +
          8 * a2 * b3 * b4 * c0 * c3 * c5 - 8 * a3 * a4 * a5 * c0 * d1 * d4 -
          8 * a3 * a4 * a5 * c1 * d0 * d4 - 8 * a3 * a4 * a5 * c4 * d0 * d1 -
          8 * a3 * a4 * b0 * c1 * c4 * d5 - 8 * a3 * a4 * b0 * c1 * c5 * d4 -
          8 * a3 * a4 * b0 * c4 * c5 * d1 + 8 * a3 * a4 * b2 * c0 * c3 * d5 +
          8 * a3 * a4 * b2 * c0 * c5 * d3 + 8 * a3 * a4 * b2 * c3 * c5 * d0 -
          8 * a3 * a4 * b3 * c0 * c2 * d5 - 8 * a3 * a4 * b3 * c0 * c5 * d2 -
          8 * a3 * a4 * b3 * c2 * c5 * d0 + 16 * a3 * a4 * b4 * c0 * c1 * d5 +
          16 * a3 * a4 * b4 * c0 * c5 * d1 + 16 * a3 * a4 * b4 * c1 * c5 * d0 -
          8 * a3 * a4 * b5 * c0 * c1 * d4 - 8 * a3 * a4 * b5 * c0 * c4 * d1 -
          8 * a3 * a4 * b5 * c1 * c4 * d0 + 4 * a3 * a5 * b0 * c1 * c3 * d5 +
          16 * a3 * a5 * b0 * c1 * c4 * d4 + 4 * a3 * a5 * b0 * c1 * c5 * d3 -
          8 * a3 * a5 * b0 * c2 * c3 * d4 - 8 * a3 * a5 * b0 * c2 * c4 * d3 -
          8 * a3 * a5 * b0 * c3 * c4 * d2 + 4 * a3 * a5 * b0 * c3 * c5 * d1 -
          4 * a3 * a5 * b1 * c0 * c3 * d5 - 4 * a3 * a5 * b1 * c0 * c5 * d3 -
          4 * a3 * a5 * b1 * c3 * c5 * d0 - 4 * a3 * a5 * b3 * c0 * c1 * d5 +
          8 * a3 * a5 * b3 * c0 * c2 * d4 + 8 * a3 * a5 * b3 * c0 * c4 * d2 -
          4 * a3 * a5 * b3 * c0 * c5 * d1 - 4 * a3 * a5 * b3 * c1 * c5 * d0 +
          8 * a3 * a5 * b3 * c2 * c4 * d0 - 8 * a3 * a5 * b4 * c0 * c1 * d4 -
          8 * a3 * a5 * b4 * c0 * c4 * d1 - 8 * a3 * a5 * b4 * c1 * c4 * d0 +
          4 * a3 * a5 * b5 * c0 * c1 * d3 + 4 * a3 * a5 * b5 * c0 * c3 * d1 +
          4 * a3 * a5 * b5 * c1 * c3 * d0 + 8 * a3 * b0 * b3 * c2 * c4 * c5 -
          8 * a3 * b0 * b4 * c1 * c4 * c5 + 4 * a3 * b0 * b5 * c1 * c3 * c5 -
          8 * a3 * b0 * b5 * c2 * c3 * c4 - 4 * a3 * b1 * b5 * c0 * c3 * c5 -
          8 * a3 * b2 * b3 * c0 * c4 * c5 + 8 * a3 * b2 * b4 * c0 * c3 * c5 -
          8 * a3 * b3 * b4 * c0 * c2 * c5 - 4 * a3 * b3 * b5 * c0 * c1 * c5 +
          8 * a3 * b3 * b5 * c0 * c2 * c4 - 8 * a3 * b4 * b5 * c0 * c1 * c4 +
          ...
          8 * a4 * b0 * b1 * c3 * c4 * c5 - 8 * a4 * b0 * b3 * c1 * c4 * c5 -
          16 * a4 * b1 * b4 * c0 * c3 * c5 + 8 * a4 * b1 * b5 * c0 * c3 * c4 +
          8 * a4 * b2 * b3 * c0 * c3 * c5 + 16 * a4 * b3 * b4 * c0 * c1 * c5 -
          8 * a4 * b3 * b5 * c0 * c1 * c4 + 4 * a5 * b0 * b3 * c1 * c3 * c5 -
          8 * a5 * b0 * b3 * c2 * c3 * c4 - 4 * a5 * b1 * b3 * c0 * c3 * c5 +
          8 * a5 * b1 * b4 * c0 * c3 * c4 - 8 * a5 * b3 * b4 * c0 * c1 * c4 +
          4 * a5 * b3 * b5 * c0 * c1 * c3,
      8 * pow(a0, 2) * b4 * pow(c2, 3) - 8 * pow(a5, 2) * b0 * pow(c1, 3) +
          pow(a5, 2) * b1 * pow(c0, 3) + 32 * pow(a1, 2) * b4 * pow(c2, 3) +
          16 * pow(a2, 2) * b5 * pow(c1, 3) + 8 * pow(a3, 2) * b4 * pow(c2, 3) -
          4 * pow(a5, 2) * b3 * pow(c1, 3) - pow(a0, 3) * pow(c5, 2) * d1 +
          8 * pow(a1, 3) * pow(c5, 2) * d0 - 8 * pow(a2, 3) * pow(c0, 2) * d4 -
          32 * pow(a2, 3) * pow(c1, 2) * d4 -
          16 * pow(a1, 3) * pow(c2, 2) * d5 + 4 * pow(a1, 3) * pow(c5, 2) * d3 -
          8 * pow(a2, 3) * pow(c3, 2) * d4 + 16 * a0 * a4 * b0 * pow(c2, 3) +
          64 * a1 * a4 * b1 * pow(c2, 3) - 16 * a0 * a3 * b4 * pow(c2, 3) -
          16 * a0 * a4 * b3 * pow(c2, 3) - 16 * a3 * a4 * b0 * pow(c2, 3) +
          32 * a2 * a5 * b2 * pow(c1, 3) - 16 * a0 * a5 * b5 * pow(c1, 3) +
          2 * a1 * a5 * b5 * pow(c0, 3) - 4 * a2 * a4 * b5 * pow(c0, 3) -
          4 * a2 * a5 * b4 * pow(c0, 3) - 4 * a4 * a5 * b2 * pow(c0, 3) +
          16 * a3 * a4 * b3 * pow(c2, 3) - 8 * a3 * a5 * b5 * pow(c1, 3) -
          16 * pow(a2, 3) * c0 * c4 * d0 - 64 * pow(a2, 3) * c1 * c4 * d1 +
          16 * pow(a2, 3) * c0 * c3 * d4 + 16 * pow(a2, 3) * c0 * c4 * d3 +
          16 * pow(a2, 3) * c3 * c4 * d0 - 32 * pow(a1, 3) * c2 * c5 * d2 -
          2 * pow(a0, 3) * c1 * c5 * d5 + 4 * pow(a0, 3) * c2 * c4 * d5 +
          4 * pow(a0, 3) * c2 * c5 * d4 + 4 * pow(a0, 3) * c4 * c5 * d2 +
          16 * pow(a1, 3) * c0 * c5 * d5 - 16 * pow(a2, 3) * c3 * c4 * d3 +
          8 * pow(a1, 3) * c3 * c5 * d5 - a0 * pow(a5, 2) * pow(c0, 2) * d1 +
          ...
          8 * a0 * a1 * a2 * c2 * c5 * d0 + 8 * a0 * a1 * b2 * c0 * c2 * c5 -
          32 * a0 * a2 * a4 * c0 * c2 * d2 - 8 * a0 * a2 * a5 * c0 * c1 * d2 -
          8 * a0 * a2 * a5 * c0 * c2 * d1 - 8 * a0 * a2 * a5 * c1 * c2 * d0 +
          8 * a0 * a2 * b1 * c0 * c2 * c5 + 32 * a0 * a2 * b2 * c0 * c2 * c4 -
          8 * a0 * a2 * b5 * c0 * c1 * c2 - 8 * a0 * a5 * b2 * c0 * c1 * c2 +
          8 * a1 * a2 * b0 * c0 * c2 * c5 - 8 * a2 * a5 * b0 * c0 * c1 * c2 -
          4 * a0 * a1 * a5 * c0 * c5 * d0 + 8 * a0 * a2 * a4 * c0 * c5 * d0 +
          8 * a0 * a2 * a5 * c0 * c4 * d0 - 8 * a0 * a2 * b0 * c0 * c4 * c5 +
          8 * a0 * a4 * a5 * c0 * c2 * d0 - 8 * a0 * a4 * b0 * c0 * c2 * c5 +
          4 * a0 * a5 * b0 * c0 * c1 * c5 - 8 * a0 * a5 * b0 * c0 * c2 * c4 -
          128 * a1 * a2 * a4 * c1 * c2 * d2 - 64 * a1 * a2 * a5 * c1 * c2 * d1 +
          64 * a1 * a2 * b1 * c1 * c2 * c5 + 128 * a1 * a2 * b2 * c1 * c2 * c4 -
          16 * a0 * a1 * a2 * c1 * c4 * d5 - 16 * a0 * a1 * a2 * c1 * c5 * d4 -
          8 * a0 * a1 * a2 * c2 * c3 * d5 - 8 * a0 * a1 * a2 * c2 * c5 * d3 -
          8 * a0 * a1 * a2 * c3 * c5 * d2 - 16 * a0 * a1 * a2 * c4 * c5 * d1 +
          16 * a0 * a1 * a3 * c2 * c5 * d2 - 16 * a0 * a1 * a5 * c1 * c2 * d4 -
          16 * a0 * a1 * a5 * c1 * c4 * d2 + 32 * a0 * a1 * a5 * c1 * c5 * d1 -
          16 * a0 * a1 * a5 * c2 * c4 * d1 + 32 * a0 * a1 * b1 * c2 * c4 * c5 -
          16 * a0 * a1 * b2 * c1 * c4 * c5 - 8 * a0 * a1 * b2 * c2 * c3 * c5 -
          16 * a0 * a1 * b5 * c1 * c2 * c4 - 8 * a0 * a2 * a3 * c1 * c2 * d5 -
          8 * a0 * a2 * a3 * c1 * c5 * d2 + 32 * a0 * a2 * a3 * c2 * c4 * d2 -
          8 * a0 * a2 * a3 * c2 * c5 * d1 - 32 * a0 * a2 * a4 * c1 * c2 * d4 -
          32 * a0 * a2 * a4 * c1 * c4 * d2 + 32 * a0 * a2 * a4 * c2 * c3 * d2 -
          32 * a0 * a2 * a4 * c2 * c4 * d1 + 32 * a0 * a2 * a5 * c1 * c4 * d1 -
          16 * a0 * a2 * b1 * c1 * c4 * c5 - 8 * a0 * a2 * b1 * c2 * c3 * c5 +
          16 * a0 * a2 * b2 * c1 * c3 * c5 - 32 * a0 * a2 * b2 * c2 * c3 * c4 -
          8 * a0 * a2 * b3 * c1 * c2 * c5 - 32 * a0 * a2 * b4 * c1 * c2 * c4 -
          8 * a0 * a3 * b2 * c1 * c2 * c5 - 32 * a0 * a4 * b2 * c1 * c2 * c4 -
          16 * a0 * a5 * b1 * c1 * c2 * c4 + 16 * a1 * a2 * a4 * c0 * c1 * d5 +
          ...
          16 * a1 * a4 * a5 * c0 * c1 * d2 + 16 * a1 * a4 * a5 * c0 * c2 * d1 +
          16 * a1 * a4 * a5 * c1 * c2 * d0 - 32 * a1 * a4 * b1 * c0 * c2 * c5 +
          ...
          16 * a1 * a5 * b4 * c0 * c1 * c2 + 32 * a2 * a3 * a4 * c0 * c2 * d2 +
          8 * a2 * a3 * a5 * c0 * c1 * d2 + 8 * a2 * a3 * a5 * c0 * c2 * d1 +
          8 * a2 * a3 * a5 * c1 * c2 * d0 - 8 * a2 * a3 * b0 * c1 * c2 * c5 -
          32 * a2 * a3 * b2 * c0 * c2 * c4 + 8 * a2 * a3 * b5 * c0 * c1 * c2 -
          32 * a2 * a4 * a5 * c0 * c1 * d1 - 32 * a2 * a4 * b0 * c1 * c2 * c4 +
          16 * a2 * a4 * b1 * c0 * c1 * c5 + 32 * a2 * a4 * b1 * c0 * c2 * c4 -
          32 * a2 * a4 * b2 * c0 * c2 * c3 + 8 * a2 * a5 * b1 * c0 * c2 * c3 -
          16 * a2 * a5 * b2 * c0 * c1 * c3 + 8 * a2 * a5 * b3 * c0 * c1 * c2 +
          8 * a3 * a5 * b2 * c0 * c1 * c2 + 16 * a4 * a5 * b1 * c0 * c1 * c2 -
          8 * a0 * a1 * a3 * c0 * c5 * d5 - 8 * a0 * a1 * a4 * c0 * c4 * d5 -
          8 * a0 * a1 * a4 * c0 * c5 * d4 - 8 * a0 * a1 * a4 * c4 * c5 * d0 +
          16 * a0 * a1 * a5 * c0 * c4 * d4 - 8 * a0 * a1 * b4 * c0 * c4 * c5 +
          ...
          8 * a0 * a3 * a4 * c2 * c5 * d0 - 16 * a0 * a3 * b0 * c2 * c4 * c5 +
          8 * a0 * a3 * b2 * c0 * c4 * c5 + 8 * a0 * a3 * b4 * c0 * c2 * c5 +
          8 * a0 * a4 * a5 * c0 * c1 * d4 - 8 * a0 * a4 * a5 * c0 * c2 * d3 -
          8 * a0 * a4 * a5 * c0 * c3 * d2 + 8 * a0 * a4 * a5 * c0 * c4 * d1 +
          8 * a0 * a4 * a5 * c1 * c4 * d0 - 8 * a0 * a4 * a5 * c2 * c3 * d0 +
          16 * a0 * a4 * b0 * c1 * c4 * c5 - 8 * a0 * a4 * b1 * c0 * c4 * c5 +
          8 * a0 * a4 * b3 * c0 * c2 * c5 - 16 * a0 * a4 * b4 * c0 * c1 * c5 +
          8 * a0 * a4 * b5 * c0 * c1 * c4 - 8 * a0 * a4 * b5 * c0 * c2 * c3 -
          8 * a0 * a5 * b0 * c1 * c3 * c5 + 16 * a0 * a5 * b0 * c2 * c3 * c4 -
          8 * a0 * a5 * b2 * c0 * c3 * c4 + 8 * a0 * a5 * b4 * c0 * c1 * c4 -
          8 * a0 * a5 * b4 * c0 * c2 * c3 + 8 * a0 * a5 * b5 * c0 * c1 * c3 +
          8 * a1 * a3 * a5 * c0 * c5 * d0 - 16 * a1 * a4 * a5 * c0 * c4 * d0 -
          8 * a1 * a4 * b0 * c0 * c4 * c5 - 16 * a2 * a3 * a4 * c0 * c5 * d0 +
          8 * a2 * a3 * b0 * c0 * c4 * c5 + 16 * a2 * a4 * a5 * c0 * c3 * d0 -
          8 * a2 * a5 * b0 * c0 * c3 * c4 + 8 * a3 * a4 * b0 * c0 * c2 * c5 +
          8 * a4 * a5 * b0 * c0 * c1 * c4 - 8 * a4 * a5 * b0 * c0 * c2 * c3 +
          16 * a1 * a2 * a3 * c1 * c4 * d5 + 16 * a1 * a2 * a3 * c1 * c5 * d4 +
          16 * a1 * a2 * a3 * c4 * c5 * d1 + 16 * a1 * a2 * a4 * c1 * c3 * d5 +
          16 * a1 * a2 * a4 * c1 * c5 * d3 - 32 * a1 * a2 * a4 * c2 * c3 * d4 -
          32 * a1 * a2 * a4 * c2 * c4 * d3 - 32 * a1 * a2 * a4 * c3 * c4 * d2 +
          16 * a1 * a2 * a4 * c3 * c5 * d1 - 16 * a1 * a2 * a5 * c2 * c3 * d3 -
          ...
          16 * a1 * a3 * a5 * c1 * c5 * d1 + 16 * a1 * a3 * a5 * c2 * c3 * d2 -
          16 * a1 * a3 * a5 * c2 * c4 * d1 + 16 * a1 * a3 * b2 * c1 * c4 * c5 -
          16 * a1 * a3 * b5 * c1 * c2 * c4 - 16 * a1 * a4 * a5 * c1 * c2 * d3 -
          16 * a1 * a4 * a5 * c1 * c3 * d2 - 16 * a1 * a4 * a5 * c2 * c3 * d1 +
          ...
          16 * a1 * a5 * b4 * c1 * c2 * c3 + 32 * a2 * a3 * a4 * c1 * c2 * d4 +
          32 * a2 * a3 * a4 * c1 * c4 * d2 - 32 * a2 * a3 * a4 * c1 * c5 * d1 -
          32 * a2 * a3 * a4 * c2 * c3 * d2 + 32 * a2 * a3 * a4 * c2 * c4 * d1 +
          16 * a2 * a3 * b1 * c1 * c4 * c5 - 16 * a2 * a3 * b2 * c1 * c3 * c5 +
          32 * a2 * a3 * b2 * c2 * c3 * c4 + 16 * a2 * a3 * b3 * c1 * c2 * c5 +
          32 * a2 * a3 * b4 * c1 * c2 * c4 + 16 * a2 * a4 * b1 * c1 * c3 * c5 -
          32 * a2 * a4 * b1 * c2 * c3 * c4 + 32 * a2 * a4 * b3 * c1 * c2 * c4 +
          32 * a3 * a4 * a5 * c1 * c2 * d1 + 32 * a3 * a4 * b2 * c1 * c2 * c4 -
          ...
          8 * a0 * a1 * b4 * c3 * c4 * c5 - 8 * a0 * a2 * a4 * c3 * c5 * d3 +
          8 * a0 * a2 * a5 * c3 * c4 * d3 - 8 * a0 * a3 * a4 * c1 * c4 * d5 -
          8 * a0 * a3 * a4 * c1 * c5 * d4 - 8 * a0 * a3 * a4 * c4 * c5 * d1 +
          4 * a0 * a3 * a5 * c1 * c3 * d5 + 16 * a0 * a3 * a5 * c1 * c4 * d4 +
          4 * a0 * a3 * a5 * c1 * c5 * d3 - 8 * a0 * a3 * a5 * c2 * c3 * d4 -
          8 * a0 * a3 * a5 * c2 * c4 * d3 - 8 * a0 * a3 * a5 * c3 * c4 * d2 +
          4 * a0 * a3 * a5 * c3 * c5 * d1 + 8 * a0 * a3 * b3 * c2 * c4 * c5 -
          8 * a0 * a3 * b4 * c1 * c4 * c5 + 4 * a0 * a3 * b5 * c1 * c3 * c5 -
          8 * a0 * a3 * b5 * c2 * c3 * c4 + 8 * a0 * a4 * a5 * c2 * c3 * d3 +
          8 * a0 * a4 * b1 * c3 * c4 * c5 - 8 * a0 * a4 * b3 * c1 * c4 * c5 +
          4 * a0 * a5 * b3 * c1 * c3 * c5 - 8 * a0 * a5 * b3 * c2 * c3 * c4 -
          4 * a1 * a3 * a5 * c0 * c3 * d5 - 4 * a1 * a3 * a5 * c0 * c5 * d3 -
          4 * a1 * a3 * a5 * c3 * c5 * d0 - 4 * a1 * a3 * b5 * c0 * c3 * c5 +
          8 * a1 * a4 * a5 * c0 * c3 * d4 + 8 * a1 * a4 * a5 * c0 * c4 * d3 +
          8 * a1 * a4 * a5 * c3 * c4 * d0 + 8 * a1 * a4 * b0 * c3 * c4 * c5 -
          16 * a1 * a4 * b4 * c0 * c3 * c5 + 8 * a1 * a4 * b5 * c0 * c3 * c4 -
          4 * a1 * a5 * b3 * c0 * c3 * c5 + 8 * a1 * a5 * b4 * c0 * c3 * c4 +
          8 * a2 * a3 * a4 * c0 * c3 * d5 + 8 * a2 * a3 * a4 * c0 * c5 * d3 +
          8 * a2 * a3 * a4 * c3 * c5 * d0 - 8 * a2 * a3 * b3 * c0 * c4 * c5 +
          8 * a2 * a3 * b4 * c0 * c3 * c5 - 8 * a2 * a4 * a5 * c0 * c3 * d3 +
          8 * a2 * a4 * b3 * c0 * c3 * c5 - 8 * a3 * a4 * a5 * c0 * c1 * d4 -
      ...
      a1 * pow(a5, 2) * pow(c0, 3) - 8 * a0 * pow(a5, 2) * pow(c1, 3) +
          8 * pow(a0, 2) * a4 * pow(c2, 3) + 32 * pow(a1, 2) * a4 * pow(c2, 3) +
          16 * pow(a2, 2) * a5 * pow(c1, 3) - 4 * a3 * pow(a5, 2) * pow(c1, 3) +
          8 * pow(a3, 2) * a4 * pow(c2, 3) - pow(a0, 3) * c1 * pow(c5, 2) +
          8 * pow(a1, 3) * c0 * pow(c5, 2) - 8 * pow(a2, 3) * pow(c0, 2) * c4 -
          32 * pow(a2, 3) * pow(c1, 2) * c4 -
          16 * pow(a1, 3) * pow(c2, 2) * c5 + 4 * pow(a1, 3) * c3 * pow(c5, 2) -
          8 * pow(a2, 3) * pow(c3, 2) * c4 - 16 * a0 * a3 * a4 * pow(c2, 3) -
          4 * a2 * a4 * a5 * pow(c0, 3) + 16 * pow(a2, 3) * c0 * c3 * c4 +
          4 * pow(a0, 3) * c2 * c4 * c5 - a0 * pow(a5, 2) * pow(c0, 2) * c1 +
      ...
      4 * pow(b5, 3) * pow(d1, 3) - 4 * pow(b1, 3) * pow(d5, 3) -
          ...
          8 * b3 * b4 * b5 * d1 * d4 * d5,
      12 * a5 * pow(b5, 2) * pow(d1, 3) - 12 * a1 * pow(b1, 2) * pow(d5, 3) -
          a1 * pow(b3, 2) * pow(d5, 3) - a1 * pow(b0, 2) * pow(d5, 3) +
          ...
          8 * b3 * b4 * b5 * c5 * d1 * d4,
      12 * pow(a5, 2) * b5 * pow(d1, 3) - 12 * pow(a1, 2) * b1 * pow(d5, 3) -
          pow(a3, 2) * b1 * pow(d5, 3) - pow(a0, 2) * b1 * pow(d5, 3) +
      ...
      4 * pow(a5, 3) * pow(d1, 3) - 4 * pow(a1, 3) * pow(d5, 3) -
          ...
          8 * b3 * b4 * b5 * c1 * c4 * c5,
      12 * a5 * pow(b5, 2) * pow(c1, 3) - 12 * a1 * pow(b1, 2) * pow(c5, 3) -
          a1 * pow(b3, 2) * pow(c5, 3) - a1 * pow(b0, 2) * pow(c5, 3) +
          ...
          8 * a5 * b3 * b5 * c2 * c3 * c4,
      12 * pow(a5, 2) * b5 * pow(c1, 3) - 12 * pow(a1, 2) * b1 * pow(c5, 3) -
          pow(a3, 2) * b1 * pow(c5, 3) - pow(a0, 2) * b1 * pow(c5, 3) +
